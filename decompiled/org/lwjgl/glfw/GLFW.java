...
public class GLFW {
    ...
    public static boolean glfwInit() {
        long l2 = Functions.Init;
        EventLoop.check();
        return JNI.invokeI(l2) != 0;
    }

    public static void glfwTerminate() {
        long l2 = Functions.Terminate;
        JNI.invokeV(l2);
    }

    public static void glfwInitHint(int n2, int n3) {
        long l2 = Functions.InitHint;
        JNI.invokeV(n2, n3, l2);
    }

    public static void nglfwInitAllocator(long l2) {
        long l3 = Functions.InitAllocator;
        if (Checks.CHECKS && l2 != 0L) {
            GLFWAllocator.validate(l2);
        }
        JNI.invokePV(l2, l3);
    }

    public static void glfwInitAllocator(@Nullable @NativeType(value="GLFWallocator const *") GLFWAllocator gLFWAllocator) {
        org.lwjgl.glfw.GLFW.nglfwInitAllocator(MemoryUtil.memAddressSafe(gLFWAllocator));
    }

    public static void nglfwGetVersion(long l2, long l3, long l4) {
        long l5 = Functions.GetVersion;
    ...
    public static long nglfwGetVersionString() {
        long l2 = Functions.GetVersionString;
        return JNI.invokeP(l2);
    }

    @NativeType(value="char const *")
    public static String glfwGetVersionString() {
        long l2 = org.lwjgl.glfw.GLFW.nglfwGetVersionString();
        return MemoryUtil.memASCII(l2);
    }

    public static int nglfwGetError(long l2) {
        long l3 = Functions.GetError;
    ...
    public static long nglfwSetErrorCallback(long l2) {
        long l3 = Functions.SetErrorCallback;
    ...
    public static int glfwGetPlatform() {
        long l2 = Functions.GetPlatform;
        return JNI.invokeI(l2);
    }

    @NativeType(value="int")
    public static boolean glfwPlatformSupported(int n2) {
        long l2 = Functions.PlatformSupported;
        return JNI.invokeI(n2, l2) != 0;
    }

    public static long nglfwGetMonitors(long l2) {
        long l3 = Functions.GetMonitors;
        return JNI.invokePP(l2, l3);
    }
    ...
    public static PointerBuffer glfwGetMonitors() {
        ...
        try {
            long l2 = org.lwjgl.glfw.GLFW.nglfwGetMonitors(MemoryUtil.memAddress(intBuffer));
    ...
    public static long glfwGetPrimaryMonitor() {
        long l2 = Functions.GetPrimaryMonitor;
        return JNI.invokeP(l2);
    }

    public static void nglfwGetMonitorPos(long l2, long l3, long l4) {
        long l5 = Functions.GetMonitorPos;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        JNI.invokePPPV(l2, l3, l4, l5);
    ...
    public static void glfwGetMonitorPos(@NativeType(value="GLFWmonitor *") long l2, @Nullable @NativeType(value="int *") IntBuffer intBuffer, @Nullable @NativeType(value="int *") IntBuffer intBuffer2) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)intBuffer, 1);
            Checks.checkSafe((Buffer)intBuffer2, 1);
        }
        org.lwjgl.glfw.GLFW.nglfwGetMonitorPos(l2, MemoryUtil.memAddressSafe(intBuffer), MemoryUtil.memAddressSafe(intBuffer2));
    }

    public static void nglfwGetMonitorWorkarea(long l2, long l3, long l4, long l5, long l6) {
        long l7 = Functions.GetMonitorWorkarea;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        JNI.invokePPPPPV(l2, l3, l4, l5, l6, l7);
    }

    public static void glfwGetMonitorWorkarea(@NativeType(value="GLFWmonitor *") long l2, @Nullable @NativeType(value="int *") IntBuffer intBuffer, @Nullable @NativeType(value="int *") IntBuffer intBuffer2, @Nullable @NativeType(value="int *") IntBuffer intBuffer3, @Nullable @NativeType(value="int *") IntBuffer intBuffer4) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)intBuffer, 1);
            Checks.checkSafe((Buffer)intBuffer2, 1);
            Checks.checkSafe((Buffer)intBuffer3, 1);
        ...
        org.lwjgl.glfw.GLFW.nglfwGetMonitorWorkarea(l2, MemoryUtil.memAddressSafe(intBuffer), MemoryUtil.memAddressSafe(intBuffer2), MemoryUtil.memAddressSafe(intBuffer3), MemoryUtil.memAddressSafe(intBuffer4));
    }

    public static void nglfwGetMonitorPhysicalSize(long l2, long l3, long l4) {
        long l5 = Functions.GetMonitorPhysicalSize;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        JNI.invokePPPV(l2, l3, l4, l5);
    ...
    public static void glfwGetMonitorPhysicalSize(@NativeType(value="GLFWmonitor *") long l2, @Nullable @NativeType(value="int *") IntBuffer intBuffer, @Nullable @NativeType(value="int *") IntBuffer intBuffer2) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)intBuffer, 1);
            Checks.checkSafe((Buffer)intBuffer2, 1);
        }
        org.lwjgl.glfw.GLFW.nglfwGetMonitorPhysicalSize(l2, MemoryUtil.memAddressSafe(intBuffer), MemoryUtil.memAddressSafe(intBuffer2));
    }

    public static void nglfwGetMonitorContentScale(long l2, long l3, long l4) {
        long l5 = Functions.GetMonitorContentScale;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        JNI.invokePPPV(l2, l3, l4, l5);
    ...
    public static void glfwGetMonitorContentScale(@NativeType(value="GLFWmonitor *") long l2, @Nullable @NativeType(value="float *") FloatBuffer floatBuffer, @Nullable @NativeType(value="float *") FloatBuffer floatBuffer2) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)floatBuffer, 1);
            Checks.checkSafe((Buffer)floatBuffer2, 1);
        }
        org.lwjgl.glfw.GLFW.nglfwGetMonitorContentScale(l2, MemoryUtil.memAddressSafe(floatBuffer), MemoryUtil.memAddressSafe(floatBuffer2));
    }

    public static long nglfwGetMonitorName(long l2) {
        long l3 = Functions.GetMonitorName;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        return JNI.invokePP(l2, l3);
    ...
    @Nullable
    @NativeType(value="char const *")
    public static String glfwGetMonitorName(@NativeType(value="GLFWmonitor *") long l2) {
        long l3 = org.lwjgl.glfw.GLFW.nglfwGetMonitorName(l2);
        return MemoryUtil.memUTF8Safe(l3);
    }

    public static void glfwSetMonitorUserPointer(@NativeType(value="GLFWmonitor *") long l2, @NativeType(value="void *") long l3) {
        long l4 = Functions.SetMonitorUserPointer;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(l3);
        }
    ...
    public static long glfwGetMonitorUserPointer(@NativeType(value="GLFWmonitor *") long l2) {
        long l3 = Functions.GetMonitorUserPointer;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        return JNI.invokePP(l2, l3);
    ...
    public static long nglfwSetMonitorCallback(long l2) {
        long l3 = Functions.SetMonitorCallback;
        return JNI.invokePP(l2, l3);
    }
    ...
    public static long nglfwGetVideoModes(long l2, long l3) {
        long l4 = Functions.GetVideoModes;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
    ...
    public static GLFWVidMode.Buffer glfwGetVideoModes(@NativeType(value="GLFWmonitor *") long l2) {
        MemoryStack memoryStack = MemoryStack.stackGet();
        int n2 = memoryStack.getPointer();
        IntBuffer intBuffer = memoryStack.callocInt(1);
        try {
            long l3 = org.lwjgl.glfw.GLFW.nglfwGetVideoModes(l2, MemoryUtil.memAddress(intBuffer));
            GLFWVidMode.Buffer buffer = GLFWVidMode.createSafe(l3, intBuffer.get(0));
            return buffer;
        }
        finally {
            memoryStack.setPointer(n2);
    ...
    public static long nglfwGetVideoMode(long l2) {
        long l3 = Functions.GetVideoMode;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        return JNI.invokePP(l2, l3);
    ...
    @Nullable
    @NativeType(value="GLFWvidmode const *")
    public static GLFWVidMode glfwGetVideoMode(@NativeType(value="GLFWmonitor *") long l2) {
        long l3 = org.lwjgl.glfw.GLFW.nglfwGetVideoMode(l2);
        return GLFWVidMode.createSafe(l3);
    }

    public static void glfwSetGamma(@NativeType(value="GLFWmonitor *") long l2, float f2) {
        long l3 = Functions.SetGamma;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        JNI.invokePV(l2, f2, l3);
    }

    public static long nglfwGetGammaRamp(long l2) {
        long l3 = Functions.GetGammaRamp;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        return JNI.invokePP(l2, l3);
    ...
    public static GLFWGammaRamp glfwGetGammaRamp(@NativeType(value="GLFWmonitor *") long l2) {
        long l3 = org.lwjgl.glfw.GLFW.nglfwGetGammaRamp(l2);
        return GLFWGammaRamp.createSafe(l3);
    }

    public static void nglfwSetGammaRamp(long l2, long l3) {
        long l4 = Functions.SetGammaRamp;
        if (Checks.CHECKS) {
            Checks.check(l2);
            GLFWGammaRamp.validate(l3);
        }
        JNI.invokePPV(l2, l3, l4);
    }

    public static void glfwSetGammaRamp(@NativeType(value="GLFWmonitor *") long l2, @NativeType(value="GLFWgammaramp const *") GLFWGammaRamp gLFWGammaRamp) {
        org.lwjgl.glfw.GLFW.nglfwSetGammaRamp(l2, gLFWGammaRamp.address());
    }

    public static void glfwDefaultWindowHints() {
        long l2 = Functions.DefaultWindowHints;
        JNI.invokeV(l2);
    }

    public static void glfwWindowHint(int n2, int n3) {
        long l2 = Functions.WindowHint;
        JNI.invokeV(n2, n3, l2);
    }

    public static void nglfwWindowHintString(int n2, long l2) {
        long l3 = Functions.WindowHintString;
        JNI.invokePV(n2, l2, l3);
    }

    public static void glfwWindowHintString(int n2, @NativeType(value="char const *") ByteBuffer byteBuffer) {
        if (Checks.CHECKS) {
            Checks.checkNT1(byteBuffer);
        }
        org.lwjgl.glfw.GLFW.nglfwWindowHintString(n2, MemoryUtil.memAddress(byteBuffer));
    }

    /*
     * WARNING - Removed try catching itself - possible behaviour change.
     */
    public static void glfwWindowHintString(int n2, @NativeType(value="char const *") CharSequence charSequence) {
        MemoryStack memoryStack = MemoryStack.stackGet();
        int n3 = memoryStack.getPointer();
        try {
            memoryStack.nUTF8(charSequence, true);
            long l2 = memoryStack.getPointerAddress();
            org.lwjgl.glfw.GLFW.nglfwWindowHintString(n2, l2);
        }
        finally {
    ...
    public static long nglfwCreateWindow(int n2, int n3, long l2, long l3, long l4) {
        long l5 = Functions.CreateWindow;
        return JNI.invokePPPP(n2, n3, l2, l3, l4, l5);
    }

    @NativeType(value="GLFWwindow *")
    public static long glfwCreateWindow(int n2, int n3, @NativeType(value="char const *") ByteBuffer byteBuffer, @NativeType(value="GLFWmonitor *") long l2, @NativeType(value="GLFWwindow *") long l3) {
        if (Checks.CHECKS) {
            Checks.checkNT1(byteBuffer);
        }
        return org.lwjgl.glfw.GLFW.nglfwCreateWindow(n2, n3, MemoryUtil.memAddress(byteBuffer), l2, l3);
    }
     ...
     */
    @NativeType(value="GLFWwindow *")
    public static long glfwCreateWindow(int n2, int n3, @NativeType(value="char const *") CharSequence charSequence, @NativeType(value="GLFWmonitor *") long l2, @NativeType(value="GLFWwindow *") long l3) {
        MemoryStack memoryStack = MemoryStack.stackGet();
        int n4 = memoryStack.getPointer();
        try {
            memoryStack.nUTF8(charSequence, true);
            long l4 = memoryStack.getPointerAddress();
            long l5 = org.lwjgl.glfw.GLFW.nglfwCreateWindow(n2, n3, l4, l2, l3);
            return l5;
        }
        finally {
    ...
    public static void glfwDestroyWindow(@NativeType(value="GLFWwindow *") long l2) {
        long l3 = Functions.DestroyWindow;
        JNI.invokePV(l2, l3);
    }

    @NativeType(value="int")
    public static boolean glfwWindowShouldClose(@NativeType(value="GLFWwindow *") long l2) {
        long l3 = Functions.WindowShouldClose;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        return JNI.invokePI(l2, l3) != 0;
    }

    public static void glfwSetWindowShouldClose(@NativeType(value="GLFWwindow *") long l2, @NativeType(value="int") boolean bl2) {
        long l3 = Functions.SetWindowShouldClose;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        JNI.invokePV(l2, bl2 ? 1 : 0, l3);
    }

    public static void nglfwSetWindowTitle(long l2, long l3) {
        long l4 = Functions.SetWindowTitle;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        JNI.invokePPV(l2, l3, l4);
    ...
    public static void glfwSetWindowTitle(@NativeType(value="GLFWwindow *") long l2, @NativeType(value="char const *") ByteBuffer byteBuffer) {
        if (Checks.CHECKS) {
            Checks.checkNT1(byteBuffer);
        }
        org.lwjgl.glfw.GLFW.nglfwSetWindowTitle(l2, MemoryUtil.memAddress(byteBuffer));
    }

    /*
     * WARNING - Removed try catching itself - possible behaviour change.
     */
    public static void glfwSetWindowTitle(@NativeType(value="GLFWwindow *") long l2, @NativeType(value="char const *") CharSequence charSequence) {
        MemoryStack memoryStack = MemoryStack.stackGet();
        int n2 = memoryStack.getPointer();
        try {
            memoryStack.nUTF8(charSequence, true);
            long l3 = memoryStack.getPointerAddress();
            org.lwjgl.glfw.GLFW.nglfwSetWindowTitle(l2, l3);
        }
        finally {
            memoryStack.setPointer(n2);
        }
    ...
    public static void nglfwSetWindowIcon(long l2, int n2, long l3) {
        long l4 = Functions.SetWindowIcon;
        if (Checks.CHECKS) {
            Checks.check(l2);
            if (l3 != 0L) {
                Struct.validate(l3, n2, GLFWImage.SIZEOF, GLFWImage::validate);
            }
        }
        JNI.invokePPV(l2, n2, l3, l4);
    }

    public static void glfwSetWindowIcon(@NativeType(value="GLFWwindow *") long l2, @Nullable @NativeType(value="GLFWimage const *") GLFWImage.Buffer buffer) {
        org.lwjgl.glfw.GLFW.nglfwSetWindowIcon(l2, Checks.remainingSafe(buffer), MemoryUtil.memAddressSafe(buffer));
    }

    public static void nglfwGetWindowPos(long l2, long l3, long l4) {
        long l5 = Functions.GetWindowPos;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        JNI.invokePPPV(l2, l3, l4, l5);
    ...
    public static void glfwGetWindowPos(@NativeType(value="GLFWwindow *") long l2, @Nullable @NativeType(value="int *") IntBuffer intBuffer, @Nullable @NativeType(value="int *") IntBuffer intBuffer2) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)intBuffer, 1);
            Checks.checkSafe((Buffer)intBuffer2, 1);
        }
        org.lwjgl.glfw.GLFW.nglfwGetWindowPos(l2, MemoryUtil.memAddressSafe(intBuffer), MemoryUtil.memAddressSafe(intBuffer2));
    }

    public static void glfwSetWindowPos(@NativeType(value="GLFWwindow *") long l2, int n2, int n3) {
        long l3 = Functions.SetWindowPos;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        JNI.invokePV(l2, n2, n3, l3);
    }

    public static void nglfwGetWindowSize(long l2, long l3, long l4) {
        long l5 = Functions.GetWindowSize;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        JNI.invokePPPV(l2, l3, l4, l5);
    ...
    public static void glfwGetWindowSize(@NativeType(value="GLFWwindow *") long l2, @Nullable @NativeType(value="int *") IntBuffer intBuffer, @Nullable @NativeType(value="int *") IntBuffer intBuffer2) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)intBuffer, 1);
            Checks.checkSafe((Buffer)intBuffer2, 1);
        }
        org.lwjgl.glfw.GLFW.nglfwGetWindowSize(l2, MemoryUtil.memAddressSafe(intBuffer), MemoryUtil.memAddressSafe(intBuffer2));
    }

    public static void glfwSetWindowSizeLimits(@NativeType(value="GLFWwindow *") long l2, int n2, int n3, int n4, int n5) {
        long l3 = Functions.SetWindowSizeLimits;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        JNI.invokePV(l2, n2, n3, n4, n5, l3);
    }

    public static void glfwSetWindowAspectRatio(@NativeType(value="GLFWwindow *") long l2, int n2, int n3) {
        long l3 = Functions.SetWindowAspectRatio;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        JNI.invokePV(l2, n2, n3, l3);
    ...
    public static void glfwSetWindowSize(@NativeType(value="GLFWwindow *") long l2, int n2, int n3) {
        long l3 = Functions.SetWindowSize;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        JNI.invokePV(l2, n2, n3, l3);
    ...
    public static void nglfwGetFramebufferSize(long l2, long l3, long l4) {
        long l5 = Functions.GetFramebufferSize;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        JNI.invokePPPV(l2, l3, l4, l5);
    ...
    public static void glfwGetFramebufferSize(@NativeType(value="GLFWwindow *") long l2, @Nullable @NativeType(value="int *") IntBuffer intBuffer, @Nullable @NativeType(value="int *") IntBuffer intBuffer2) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)intBuffer, 1);
            Checks.checkSafe((Buffer)intBuffer2, 1);
        }
        org.lwjgl.glfw.GLFW.nglfwGetFramebufferSize(l2, MemoryUtil.memAddressSafe(intBuffer), MemoryUtil.memAddressSafe(intBuffer2));
    }

    public static void nglfwGetWindowFrameSize(long l2, long l3, long l4, long l5, long l6) {
        long l7 = Functions.GetWindowFrameSize;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        JNI.invokePPPPPV(l2, l3, l4, l5, l6, l7);
    ...
    public static void glfwGetWindowFrameSize(@NativeType(value="GLFWwindow *") long l2, @Nullable @NativeType(value="int *") IntBuffer intBuffer, @Nullable @NativeType(value="int *") IntBuffer intBuffer2, @Nullable @NativeType(value="int *") IntBuffer intBuffer3, @Nullable @NativeType(value="int *") IntBuffer intBuffer4) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)intBuffer, 1);
            Checks.checkSafe((Buffer)intBuffer2, 1);
            Checks.checkSafe((Buffer)intBuffer3, 1);
        ...
        org.lwjgl.glfw.GLFW.nglfwGetWindowFrameSize(l2, MemoryUtil.memAddressSafe(intBuffer), MemoryUtil.memAddressSafe(intBuffer2), MemoryUtil.memAddressSafe(intBuffer3), MemoryUtil.memAddressSafe(intBuffer4));
    }

    public static void nglfwGetWindowContentScale(long l2, long l3, long l4) {
        long l5 = Functions.GetWindowContentScale;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        JNI.invokePPPV(l2, l3, l4, l5);
    ...
    public static void glfwGetWindowContentScale(@NativeType(value="GLFWwindow *") long l2, @Nullable @NativeType(value="float *") FloatBuffer floatBuffer, @Nullable @NativeType(value="float *") FloatBuffer floatBuffer2) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)floatBuffer, 1);
            Checks.checkSafe((Buffer)floatBuffer2, 1);
        }
        org.lwjgl.glfw.GLFW.nglfwGetWindowContentScale(l2, MemoryUtil.memAddressSafe(floatBuffer), MemoryUtil.memAddressSafe(floatBuffer2));
    }

    public static float glfwGetWindowOpacity(@NativeType(value="GLFWwindow *") long l2) {
        long l3 = Functions.GetWindowOpacity;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        return JNI.invokePF(l2, l3);
    }

    public static void glfwSetWindowOpacity(@NativeType(value="GLFWwindow *") long l2, float f2) {
        long l3 = Functions.SetWindowOpacity;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        JNI.invokePV(l2, f2, l3);
    ...
    public static void glfwIconifyWindow(@NativeType(value="GLFWwindow *") long l2) {
        long l3 = Functions.IconifyWindow;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        JNI.invokePV(l2, l3);
    ...
    public static void glfwRestoreWindow(@NativeType(value="GLFWwindow *") long l2) {
        long l3 = Functions.RestoreWindow;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        JNI.invokePV(l2, l3);
    ...
    public static void glfwMaximizeWindow(@NativeType(value="GLFWwindow *") long l2) {
        long l3 = Functions.MaximizeWindow;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        JNI.invokePV(l2, l3);
    ...
    public static void glfwShowWindow(@NativeType(value="GLFWwindow *") long l2) {
        long l3 = Functions.ShowWindow;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        JNI.invokePV(l2, l3);
    ...
    public static void glfwHideWindow(@NativeType(value="GLFWwindow *") long l2) {
        long l3 = Functions.HideWindow;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        JNI.invokePV(l2, l3);
    ...
    public static void glfwFocusWindow(@NativeType(value="GLFWwindow *") long l2) {
        long l3 = Functions.FocusWindow;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        JNI.invokePV(l2, l3);
    ...
    public static void glfwRequestWindowAttention(@NativeType(value="GLFWwindow *") long l2) {
        long l3 = Functions.RequestWindowAttention;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        JNI.invokePV(l2, l3);
    ...
    @NativeType(value="GLFWmonitor *")
    public static long glfwGetWindowMonitor(@NativeType(value="GLFWwindow *") long l2) {
        long l3 = Functions.GetWindowMonitor;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        return JNI.invokePP(l2, l3);
    ...
    public static void glfwSetWindowMonitor(@NativeType(value="GLFWwindow *") long l2, @NativeType(value="GLFWmonitor *") long l3, int n2, int n3, int n4, int n5, int n6) {
        long l4 = Functions.SetWindowMonitor;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        JNI.invokePPV(l2, l3, n2, n3, n4, n5, n6, l4);
    }

    public static int glfwGetWindowAttrib(@NativeType(value="GLFWwindow *") long l2, int n2) {
        long l3 = Functions.GetWindowAttrib;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
    ...
    public static void glfwSetWindowAttrib(@NativeType(value="GLFWwindow *") long l2, int n2, int n3) {
        long l3 = Functions.SetWindowAttrib;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        JNI.invokePV(l2, n2, n3, l3);
    ...
    public static void glfwSetWindowUserPointer(@NativeType(value="GLFWwindow *") long l2, @NativeType(value="void *") long l3) {
        long l4 = Functions.SetWindowUserPointer;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        JNI.invokePPV(l2, l3, l4);
    ...
    @NativeType(value="void *")
    public static long glfwGetWindowUserPointer(@NativeType(value="GLFWwindow *") long l2) {
        long l3 = Functions.GetWindowUserPointer;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        return JNI.invokePP(l2, l3);
    ...
    public static long nglfwSetWindowPosCallback(long l2, long l3) {
        long l4 = Functions.SetWindowPosCallback;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        return JNI.invokePPP(l2, l3, l4);
    ...
    public static GLFWWindowPosCallback glfwSetWindowPosCallback(@NativeType(value="GLFWwindow *") long l2, @Nullable @NativeType(value="GLFWwindowposfun") GLFWWindowPosCallbackI gLFWWindowPosCallbackI) {
        return GLFWWindowPosCallback.createSafe(org.lwjgl.glfw.GLFW.nglfwSetWindowPosCallback(l2, MemoryUtil.memAddressSafe(gLFWWindowPosCallbackI)));
    }

    public static long nglfwSetWindowSizeCallback(long l2, long l3) {
        long l4 = Functions.SetWindowSizeCallback;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        return JNI.invokePPP(l2, l3, l4);
    ...
    public static GLFWWindowSizeCallback glfwSetWindowSizeCallback(@NativeType(value="GLFWwindow *") long l2, @Nullable @NativeType(value="GLFWwindowsizefun") GLFWWindowSizeCallbackI gLFWWindowSizeCallbackI) {
        return GLFWWindowSizeCallback.createSafe(org.lwjgl.glfw.GLFW.nglfwSetWindowSizeCallback(l2, MemoryUtil.memAddressSafe(gLFWWindowSizeCallbackI)));
    }

    public static long nglfwSetWindowCloseCallback(long l2, long l3) {
        long l4 = Functions.SetWindowCloseCallback;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        return JNI.invokePPP(l2, l3, l4);
    ...
    public static GLFWWindowCloseCallback glfwSetWindowCloseCallback(@NativeType(value="GLFWwindow *") long l2, @Nullable @NativeType(value="GLFWwindowclosefun") GLFWWindowCloseCallbackI gLFWWindowCloseCallbackI) {
        return GLFWWindowCloseCallback.createSafe(org.lwjgl.glfw.GLFW.nglfwSetWindowCloseCallback(l2, MemoryUtil.memAddressSafe(gLFWWindowCloseCallbackI)));
    }

    public static long nglfwSetWindowRefreshCallback(long l2, long l3) {
        long l4 = Functions.SetWindowRefreshCallback;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        return JNI.invokePPP(l2, l3, l4);
    ...
    public static GLFWWindowRefreshCallback glfwSetWindowRefreshCallback(@NativeType(value="GLFWwindow *") long l2, @Nullable @NativeType(value="GLFWwindowrefreshfun") GLFWWindowRefreshCallbackI gLFWWindowRefreshCallbackI) {
        return GLFWWindowRefreshCallback.createSafe(org.lwjgl.glfw.GLFW.nglfwSetWindowRefreshCallback(l2, MemoryUtil.memAddressSafe(gLFWWindowRefreshCallbackI)));
    }

    public static long nglfwSetWindowFocusCallback(long l2, long l3) {
        long l4 = Functions.SetWindowFocusCallback;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        return JNI.invokePPP(l2, l3, l4);
    ...
    public static GLFWWindowFocusCallback glfwSetWindowFocusCallback(@NativeType(value="GLFWwindow *") long l2, @Nullable @NativeType(value="GLFWwindowfocusfun") GLFWWindowFocusCallbackI gLFWWindowFocusCallbackI) {
        return GLFWWindowFocusCallback.createSafe(org.lwjgl.glfw.GLFW.nglfwSetWindowFocusCallback(l2, MemoryUtil.memAddressSafe(gLFWWindowFocusCallbackI)));
    }

    public static long nglfwSetWindowIconifyCallback(long l2, long l3) {
        long l4 = Functions.SetWindowIconifyCallback;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        return JNI.invokePPP(l2, l3, l4);
    ...
    public static GLFWWindowIconifyCallback glfwSetWindowIconifyCallback(@NativeType(value="GLFWwindow *") long l2, @Nullable @NativeType(value="GLFWwindowiconifyfun") GLFWWindowIconifyCallbackI gLFWWindowIconifyCallbackI) {
        return GLFWWindowIconifyCallback.createSafe(org.lwjgl.glfw.GLFW.nglfwSetWindowIconifyCallback(l2, MemoryUtil.memAddressSafe(gLFWWindowIconifyCallbackI)));
    }

    public static long nglfwSetWindowMaximizeCallback(long l2, long l3) {
        long l4 = Functions.SetWindowMaximizeCallback;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        return JNI.invokePPP(l2, l3, l4);
    ...
    public static GLFWWindowMaximizeCallback glfwSetWindowMaximizeCallback(@NativeType(value="GLFWwindow *") long l2, @Nullable @NativeType(value="GLFWwindowmaximizefun") GLFWWindowMaximizeCallbackI gLFWWindowMaximizeCallbackI) {
        return GLFWWindowMaximizeCallback.createSafe(org.lwjgl.glfw.GLFW.nglfwSetWindowMaximizeCallback(l2, MemoryUtil.memAddressSafe(gLFWWindowMaximizeCallbackI)));
    }

    public static long nglfwSetFramebufferSizeCallback(long l2, long l3) {
        long l4 = Functions.SetFramebufferSizeCallback;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        return JNI.invokePPP(l2, l3, l4);
    ...
    public static GLFWFramebufferSizeCallback glfwSetFramebufferSizeCallback(@NativeType(value="GLFWwindow *") long l2, @Nullable @NativeType(value="GLFWframebuffersizefun") GLFWFramebufferSizeCallbackI gLFWFramebufferSizeCallbackI) {
        return GLFWFramebufferSizeCallback.createSafe(org.lwjgl.glfw.GLFW.nglfwSetFramebufferSizeCallback(l2, MemoryUtil.memAddressSafe(gLFWFramebufferSizeCallbackI)));
    }

    public static long nglfwSetWindowContentScaleCallback(long l2, long l3) {
        long l4 = Functions.SetWindowContentScaleCallback;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        return JNI.invokePPP(l2, l3, l4);
    ...
    public static GLFWWindowContentScaleCallback glfwSetWindowContentScaleCallback(@NativeType(value="GLFWwindow *") long l2, @Nullable @NativeType(value="GLFWwindowcontentscalefun") GLFWWindowContentScaleCallbackI gLFWWindowContentScaleCallbackI) {
        return GLFWWindowContentScaleCallback.createSafe(org.lwjgl.glfw.GLFW.nglfwSetWindowContentScaleCallback(l2, MemoryUtil.memAddressSafe(gLFWWindowContentScaleCallbackI)));
    }

    public static void glfwPollEvents() {
        long l2 = Functions.PollEvents;
        JNI.invokeV(l2);
    }

    public static void glfwWaitEvents() {
        long l2 = Functions.WaitEvents;
        JNI.invokeV(l2);
    }

    public static void glfwWaitEventsTimeout(double d2) {
        long l2 = Functions.WaitEventsTimeout;
        JNI.invokeV(d2, l2);
    }

    public static void glfwPostEmptyEvent() {
        long l2 = Functions.PostEmptyEvent;
        JNI.invokeV(l2);
    }

    public static int glfwGetInputMode(@NativeType(value="GLFWwindow *") long l2, int n2) {
        long l3 = Functions.GetInputMode;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        return JNI.invokePI(l2, n2, l3);
    ...
    public static void glfwSetInputMode(@NativeType(value="GLFWwindow *") long l2, int n2, int n3) {
        long l3 = Functions.SetInputMode;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        JNI.invokePV(l2, n2, n3, l3);
    ...
    public static boolean glfwRawMouseMotionSupported() {
        long l2 = Functions.RawMouseMotionSupported;
        return JNI.invokeI(l2) != 0;
    }

    public static long nglfwGetKeyName(int n2, int n3) {
        long l2 = Functions.GetKeyName;
        return JNI.invokeP(n2, n3, l2);
    }

    @Nullable
    @NativeType(value="char const *")
    public static String glfwGetKeyName(int n2, int n3) {
        long l2 = org.lwjgl.glfw.GLFW.nglfwGetKeyName(n2, n3);
        return MemoryUtil.memUTF8Safe(l2);
    }

    public static int glfwGetKeyScancode(int n2) {
        long l2 = Functions.GetKeyScancode;
        return JNI.invokeI(n2, l2);
    }

    public static int glfwGetKey(@NativeType(value="GLFWwindow *") long l2, int n2) {
        long l3 = Functions.GetKey;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        return JNI.invokePI(l2, n2, l3);
    ...
    public static int glfwGetMouseButton(@NativeType(value="GLFWwindow *") long l2, int n2) {
        long l3 = Functions.GetMouseButton;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        return JNI.invokePI(l2, n2, l3);
    ...
    public static void nglfwGetCursorPos(long l2, long l3, long l4) {
        long l5 = Functions.GetCursorPos;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        JNI.invokePPPV(l2, l3, l4, l5);
    ...
    public static void glfwGetCursorPos(@NativeType(value="GLFWwindow *") long l2, @Nullable @NativeType(value="double *") DoubleBuffer doubleBuffer, @Nullable @NativeType(value="double *") DoubleBuffer doubleBuffer2) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)doubleBuffer, 1);
            Checks.checkSafe((Buffer)doubleBuffer2, 1);
        }
        org.lwjgl.glfw.GLFW.nglfwGetCursorPos(l2, MemoryUtil.memAddressSafe(doubleBuffer), MemoryUtil.memAddressSafe(doubleBuffer2));
    }

    public static void glfwSetCursorPos(@NativeType(value="GLFWwindow *") long l2, double d2, double d3) {
        long l3 = Functions.SetCursorPos;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        JNI.invokePV(l2, d2, d3, l3);
    }

    public static long nglfwCreateCursor(long l2, int n2, int n3) {
        long l3 = Functions.CreateCursor;
        if (Checks.CHECKS) {
            GLFWImage.validate(l2);
        }
        return JNI.invokePP(l2, n2, n3, l3);
    }

    @NativeType(value="GLFWcursor *")
    public static long glfwCreateCursor(@NativeType(value="GLFWimage const *") GLFWImage gLFWImage, int n2, int n3) {
        return org.lwjgl.glfw.GLFW.nglfwCreateCursor(gLFWImage.address(), n2, n3);
    }

    @NativeType(value="GLFWcursor *")
    public static long glfwCreateStandardCursor(int n2) {
        long l2 = Functions.CreateStandardCursor;
        return JNI.invokeP(n2, l2);
    }

    public static void glfwDestroyCursor(@NativeType(value="GLFWcursor *") long l2) {
        long l3 = Functions.DestroyCursor;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        JNI.invokePV(l2, l3);
    ...
    public static void glfwSetCursor(@NativeType(value="GLFWwindow *") long l2, @NativeType(value="GLFWcursor *") long l3) {
        long l4 = Functions.SetCursor;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        JNI.invokePPV(l2, l3, l4);
    ...
    public static long nglfwSetKeyCallback(long l2, long l3) {
        long l4 = Functions.SetKeyCallback;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        return JNI.invokePPP(l2, l3, l4);
    ...
    public static GLFWKeyCallback glfwSetKeyCallback(@NativeType(value="GLFWwindow *") long l2, @Nullable @NativeType(value="GLFWkeyfun") GLFWKeyCallbackI gLFWKeyCallbackI) {
        return GLFWKeyCallback.createSafe(org.lwjgl.glfw.GLFW.nglfwSetKeyCallback(l2, MemoryUtil.memAddressSafe(gLFWKeyCallbackI)));
    }

    public static long nglfwSetCharCallback(long l2, long l3) {
        long l4 = Functions.SetCharCallback;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        return JNI.invokePPP(l2, l3, l4);
    ...
    public static GLFWCharCallback glfwSetCharCallback(@NativeType(value="GLFWwindow *") long l2, @Nullable @NativeType(value="GLFWcharfun") GLFWCharCallbackI gLFWCharCallbackI) {
        return GLFWCharCallback.createSafe(org.lwjgl.glfw.GLFW.nglfwSetCharCallback(l2, MemoryUtil.memAddressSafe(gLFWCharCallbackI)));
    }

    public static long nglfwSetCharModsCallback(long l2, long l3) {
        long l4 = Functions.SetCharModsCallback;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        return JNI.invokePPP(l2, l3, l4);
    ...
    public static GLFWCharModsCallback glfwSetCharModsCallback(@NativeType(value="GLFWwindow *") long l2, @Nullable @NativeType(value="GLFWcharmodsfun") GLFWCharModsCallbackI gLFWCharModsCallbackI) {
        return GLFWCharModsCallback.createSafe(org.lwjgl.glfw.GLFW.nglfwSetCharModsCallback(l2, MemoryUtil.memAddressSafe(gLFWCharModsCallbackI)));
    }

    public static long nglfwSetMouseButtonCallback(long l2, long l3) {
        long l4 = Functions.SetMouseButtonCallback;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        return JNI.invokePPP(l2, l3, l4);
    ...
    public static GLFWMouseButtonCallback glfwSetMouseButtonCallback(@NativeType(value="GLFWwindow *") long l2, @Nullable @NativeType(value="GLFWmousebuttonfun") GLFWMouseButtonCallbackI gLFWMouseButtonCallbackI) {
        return GLFWMouseButtonCallback.createSafe(org.lwjgl.glfw.GLFW.nglfwSetMouseButtonCallback(l2, MemoryUtil.memAddressSafe(gLFWMouseButtonCallbackI)));
    }

    public static long nglfwSetCursorPosCallback(long l2, long l3) {
        long l4 = Functions.SetCursorPosCallback;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        return JNI.invokePPP(l2, l3, l4);
    ...
    public static GLFWCursorPosCallback glfwSetCursorPosCallback(@NativeType(value="GLFWwindow *") long l2, @Nullable @NativeType(value="GLFWcursorposfun") GLFWCursorPosCallbackI gLFWCursorPosCallbackI) {
        return GLFWCursorPosCallback.createSafe(org.lwjgl.glfw.GLFW.nglfwSetCursorPosCallback(l2, MemoryUtil.memAddressSafe(gLFWCursorPosCallbackI)));
    }

    public static long nglfwSetCursorEnterCallback(long l2, long l3) {
        long l4 = Functions.SetCursorEnterCallback;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        return JNI.invokePPP(l2, l3, l4);
    ...
    public static GLFWCursorEnterCallback glfwSetCursorEnterCallback(@NativeType(value="GLFWwindow *") long l2, @Nullable @NativeType(value="GLFWcursorenterfun") GLFWCursorEnterCallbackI gLFWCursorEnterCallbackI) {
        return GLFWCursorEnterCallback.createSafe(org.lwjgl.glfw.GLFW.nglfwSetCursorEnterCallback(l2, MemoryUtil.memAddressSafe(gLFWCursorEnterCallbackI)));
    }

    public static long nglfwSetScrollCallback(long l2, long l3) {
        long l4 = Functions.SetScrollCallback;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        return JNI.invokePPP(l2, l3, l4);
    ...
    public static GLFWScrollCallback glfwSetScrollCallback(@NativeType(value="GLFWwindow *") long l2, @Nullable @NativeType(value="GLFWscrollfun") GLFWScrollCallbackI gLFWScrollCallbackI) {
        return GLFWScrollCallback.createSafe(org.lwjgl.glfw.GLFW.nglfwSetScrollCallback(l2, MemoryUtil.memAddressSafe(gLFWScrollCallbackI)));
    }

    public static long nglfwSetDropCallback(long l2, long l3) {
        long l4 = Functions.SetDropCallback;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        return JNI.invokePPP(l2, l3, l4);
    ...
    public static GLFWDropCallback glfwSetDropCallback(@NativeType(value="GLFWwindow *") long l2, @Nullable @NativeType(value="GLFWdropfun") GLFWDropCallbackI gLFWDropCallbackI) {
        return GLFWDropCallback.createSafe(org.lwjgl.glfw.GLFW.nglfwSetDropCallback(l2, MemoryUtil.memAddressSafe(gLFWDropCallbackI)));
    }

    @NativeType(value="int")
    public static boolean glfwJoystickPresent(int n2) {
        long l2 = Functions.JoystickPresent;
        return JNI.invokeI(n2, l2) != 0;
    }

    public static long nglfwGetJoystickAxes(int n2, long l2) {
        long l3 = Functions.GetJoystickAxes;
        return JNI.invokePP(n2, l2, l3);
    }
    ...
    public static FloatBuffer glfwGetJoystickAxes(int n2) {
        MemoryStack memoryStack = MemoryStack.stackGet();
        int n3 = memoryStack.getPointer();
        IntBuffer intBuffer = memoryStack.callocInt(1);
        try {
            long l2 = org.lwjgl.glfw.GLFW.nglfwGetJoystickAxes(n2, MemoryUtil.memAddress(intBuffer));
            FloatBuffer floatBuffer = MemoryUtil.memFloatBufferSafe(l2, intBuffer.get(0));
            return floatBuffer;
        }
        finally {
            memoryStack.setPointer(n3);
    ...
    public static long nglfwGetJoystickButtons(int n2, long l2) {
        long l3 = Functions.GetJoystickButtons;
        return JNI.invokePP(n2, l2, l3);
    }
    ...
    public static ByteBuffer glfwGetJoystickButtons(int n2) {
        MemoryStack memoryStack = MemoryStack.stackGet();
        int n3 = memoryStack.getPointer();
        IntBuffer intBuffer = memoryStack.callocInt(1);
        try {
            long l2 = org.lwjgl.glfw.GLFW.nglfwGetJoystickButtons(n2, MemoryUtil.memAddress(intBuffer));
            ByteBuffer byteBuffer = MemoryUtil.memByteBufferSafe(l2, intBuffer.get(0));
            return byteBuffer;
        }
        finally {
            memoryStack.setPointer(n3);
    ...
    public static long nglfwGetJoystickHats(int n2, long l2) {
        long l3 = Functions.GetJoystickHats;
        return JNI.invokePP(n2, l2, l3);
    }
    ...
    @Nullable
    @NativeType(value="unsigned char const *")
    public static ByteBuffer glfwGetJoystickHats(int n2) {
        MemoryStack memoryStack = MemoryStack.stackGet();
        int n3 = memoryStack.getPointer();
        IntBuffer intBuffer = memoryStack.callocInt(1);
        try {
            long l2 = org.lwjgl.glfw.GLFW.nglfwGetJoystickHats(n2, MemoryUtil.memAddress(intBuffer));
            ByteBuffer byteBuffer = MemoryUtil.memByteBufferSafe(l2, intBuffer.get(0));
            return byteBuffer;
        }
        finally {
    ...
    public static long nglfwGetJoystickName(int n2) {
        long l2 = Functions.GetJoystickName;
        return JNI.invokeP(n2, l2);
    }

    @Nullable
    @NativeType(value="char const *")
    public static String glfwGetJoystickName(int n2) {
        long l2 = org.lwjgl.glfw.GLFW.nglfwGetJoystickName(n2);
        return MemoryUtil.memUTF8Safe(l2);
    }

    public static long nglfwGetJoystickGUID(int n2) {
        long l2 = Functions.GetJoystickGUID;
        return JNI.invokeP(n2, l2);
    }

    @Nullable
    @NativeType(value="char const *")
    public static String glfwGetJoystickGUID(int n2) {
        long l2 = org.lwjgl.glfw.GLFW.nglfwGetJoystickGUID(n2);
        return MemoryUtil.memUTF8Safe(l2);
    }

    public static void glfwSetJoystickUserPointer(int n2, @NativeType(value="void *") long l2) {
        long l3 = Functions.SetJoystickUserPointer;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        JNI.invokePV(n2, l2, l3);
    ...
    @NativeType(value="void *")
    public static long glfwGetJoystickUserPointer(int n2) {
        long l2 = Functions.GetJoystickUserPointer;
        return JNI.invokeP(n2, l2);
    }

    @NativeType(value="int")
    public static boolean glfwJoystickIsGamepad(int n2) {
        long l2 = Functions.JoystickIsGamepad;
        return JNI.invokeI(n2, l2) != 0;
    }

    public static long nglfwSetJoystickCallback(long l2) {
        long l3 = Functions.SetJoystickCallback;
        return JNI.invokePP(l2, l3);
    }
    ...
    public static int nglfwUpdateGamepadMappings(long l2) {
        long l3 = Functions.UpdateGamepadMappings;
        return JNI.invokePI(l2, l3);
    }
    ...
    public static long nglfwGetGamepadName(int n2) {
        long l2 = Functions.GetGamepadName;
        return JNI.invokeP(n2, l2);
    }

    @Nullable
    @NativeType(value="char const *")
    public static String glfwGetGamepadName(int n2) {
        long l2 = org.lwjgl.glfw.GLFW.nglfwGetGamepadName(n2);
        return MemoryUtil.memUTF8Safe(l2);
    }

    public static int nglfwGetGamepadState(int n2, long l2) {
        long l3 = Functions.GetGamepadState;
        return JNI.invokePI(n2, l2, l3);
    }

    @NativeType(value="int")
    public static boolean glfwGetGamepadState(int n2, @NativeType(value="GLFWgamepadstate *") GLFWGamepadState gLFWGamepadState) {
        return org.lwjgl.glfw.GLFW.nglfwGetGamepadState(n2, gLFWGamepadState.address()) != 0;
    }

    public static void nglfwSetClipboardString(long l2, long l3) {
        long l4 = Functions.SetClipboardString;
        JNI.invokePPV(l2, l3, l4);
    }

    public static void glfwSetClipboardString(@NativeType(value="GLFWwindow *") long l2, @NativeType(value="char const *") ByteBuffer byteBuffer) {
        if (Checks.CHECKS) {
            Checks.checkNT1(byteBuffer);
        }
        org.lwjgl.glfw.GLFW.nglfwSetClipboardString(l2, MemoryUtil.memAddress(byteBuffer));
    }

    /*
     * WARNING - Removed try catching itself - possible behaviour change.
     */
    public static void glfwSetClipboardString(@NativeType(value="GLFWwindow *") long l2, @NativeType(value="char const *") CharSequence charSequence) {
        MemoryStack memoryStack = MemoryStack.stackGet();
        int n2 = memoryStack.getPointer();
        try {
            memoryStack.nUTF8(charSequence, true);
            long l3 = memoryStack.getPointerAddress();
            org.lwjgl.glfw.GLFW.nglfwSetClipboardString(l2, l3);
        }
        finally {
            memoryStack.setPointer(n2);
        }
    ...
    public static long nglfwGetClipboardString(long l2) {
        long l3 = Functions.GetClipboardString;
        return JNI.invokePP(l2, l3);
    }

    @Nullable
    @NativeType(value="char const *")
    public static String glfwGetClipboardString(@NativeType(value="GLFWwindow *") long l2) {
        long l3 = org.lwjgl.glfw.GLFW.nglfwGetClipboardString(l2);
        return MemoryUtil.memUTF8Safe(l3);
    }

    public static double glfwGetTime() {
        long l2 = Functions.GetTime;
        return JNI.invokeD(l2);
    }

    public static void glfwSetTime(double d2) {
        long l2 = Functions.SetTime;
        JNI.invokeV(d2, l2);
    }

    @NativeType(value="uint64_t")
    public static long glfwGetTimerValue() {
        long l2 = Functions.GetTimerValue;
        return JNI.invokeJ(l2);
    }

    @NativeType(value="uint64_t")
    public static long glfwGetTimerFrequency() {
        long l2 = Functions.GetTimerFrequency;
        return JNI.invokeJ(l2);
    }

    public static void glfwMakeContextCurrent(@NativeType(value="GLFWwindow *") long l2) {
        long l3 = Functions.MakeContextCurrent;
        JNI.invokePV(l2, l3);
    }
    ...
    public static void glfwSwapBuffers(@NativeType(value="GLFWwindow *") long l2) {
    ...
    public static void glfwSwapInterval(int n2) {
        long l2 = Functions.SwapInterval;
        JNI.invokeV(n2, l2);
    }

    public static int nglfwExtensionSupported(long l2) {
        long l3 = Functions.ExtensionSupported;
        return JNI.invokePI(l2, l3);
    }
    ...
    public static boolean glfwExtensionSupported(@NativeType(value="char const *") CharSequence charSequence) {
        ...
        try {
            ...
            long l2 = memoryStack.getPointerAddress();
            boolean bl2 = org.lwjgl.glfw.GLFW.nglfwExtensionSupported(l2) != 0;
            return bl2;
        }
        finally {
            memoryStack.setPointer(n2);
    ...
    public static long nglfwGetProcAddress(long l2) {
    ...
    public static long glfwGetProcAddress(@NativeType(value="char const *") CharSequence charSequence) {
        ...
        try {
            memoryStack.nASCII(charSequence, true);
            long l2 = memoryStack.getPointerAddress();
            long l3 = org.lwjgl.glfw.GLFW.nglfwGetProcAddress(l2);
            return l3;
        }
        finally {
            memoryStack.setPointer(n2);
    ...
    public static void glfwGetVersion(@Nullable @NativeType(value="int *") int[] nArray, @Nullable @NativeType(value="int *") int[] nArray2, @Nullable @NativeType(value="int *") int[] nArray3) {
        ...
        JNI.invokePPPV(nArray, nArray2, nArray3, l2);
    }

    public static void glfwGetMonitorPos(@NativeType(value="GLFWmonitor *") long l2, @Nullable @NativeType(value="int *") int[] nArray, @Nullable @NativeType(value="int *") int[] nArray2) {
        long l3 = Functions.GetMonitorPos;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.checkSafe(nArray, 1);
            Checks.checkSafe(nArray2, 1);
        }
        JNI.invokePPPV(l2, nArray, nArray2, l3);
    }

    public static void glfwGetMonitorWorkarea(@NativeType(value="GLFWmonitor *") long l2, @Nullable @NativeType(value="int *") int[] nArray, @Nullable @NativeType(value="int *") int[] nArray2, @Nullable @NativeType(value="int *") int[] nArray3, @Nullable @NativeType(value="int *") int[] nArray4) {
        long l3 = Functions.GetMonitorWorkarea;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.checkSafe(nArray, 1);
            Checks.checkSafe(nArray2, 1);
        ...
        JNI.invokePPPPPV(l2, nArray, nArray2, nArray3, nArray4, l3);
    }

    public static void glfwGetMonitorPhysicalSize(@NativeType(value="GLFWmonitor *") long l2, @Nullable @NativeType(value="int *") int[] nArray, @Nullable @NativeType(value="int *") int[] nArray2) {
        long l3 = Functions.GetMonitorPhysicalSize;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.checkSafe(nArray, 1);
            Checks.checkSafe(nArray2, 1);
    ...
    public static void glfwGetMonitorContentScale(@NativeType(value="GLFWmonitor *") long l2, @Nullable @NativeType(value="float *") float[] fArray, @Nullable @NativeType(value="float *") float[] fArray2) {
        long l3 = Functions.GetMonitorContentScale;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.checkSafe(fArray, 1);
            Checks.checkSafe(fArray2, 1);
        }
        JNI.invokePPPV(l2, fArray, fArray2, l3);
    }

    public static void glfwGetWindowPos(@NativeType(value="GLFWwindow *") long l2, @Nullable @NativeType(value="int *") int[] nArray, @Nullable @NativeType(value="int *") int[] nArray2) {
        long l3 = Functions.GetWindowPos;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.checkSafe(nArray, 1);
            Checks.checkSafe(nArray2, 1);
    ...
    public static void glfwGetWindowSize(@NativeType(value="GLFWwindow *") long l2, @Nullable @NativeType(value="int *") int[] nArray, @Nullable @NativeType(value="int *") int[] nArray2) {
        long l3 = Functions.GetWindowSize;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.checkSafe(nArray, 1);
            Checks.checkSafe(nArray2, 1);
    ...
    public static void glfwGetFramebufferSize(@NativeType(value="GLFWwindow *") long l2, @Nullable @NativeType(value="int *") int[] nArray, @Nullable @NativeType(value="int *") int[] nArray2) {
        long l3 = Functions.GetFramebufferSize;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.checkSafe(nArray, 1);
            Checks.checkSafe(nArray2, 1);
    ...
    public static void glfwGetWindowFrameSize(@NativeType(value="GLFWwindow *") long l2, @Nullable @NativeType(value="int *") int[] nArray, @Nullable @NativeType(value="int *") int[] nArray2, @Nullable @NativeType(value="int *") int[] nArray3, @Nullable @NativeType(value="int *") int[] nArray4) {
        long l3 = Functions.GetWindowFrameSize;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.checkSafe(nArray, 1);
            Checks.checkSafe(nArray2, 1);
    ...
    public static void glfwGetWindowContentScale(@NativeType(value="GLFWwindow *") long l2, @Nullable @NativeType(value="float *") float[] fArray, @Nullable @NativeType(value="float *") float[] fArray2) {
        long l3 = Functions.GetWindowContentScale;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.checkSafe(fArray, 1);
            Checks.checkSafe(fArray2, 1);
    ...
    public static void glfwGetCursorPos(@NativeType(value="GLFWwindow *") long l2, @Nullable @NativeType(value="double *") double[] dArray, @Nullable @NativeType(value="double *") double[] dArray2) {
        long l3 = Functions.GetCursorPos;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.checkSafe(dArray, 1);
            Checks.checkSafe(dArray2, 1);
        }
        JNI.invokePPPV(l2, dArray, dArray2, l3);
    }
