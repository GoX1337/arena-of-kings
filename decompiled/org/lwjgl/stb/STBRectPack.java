...
public class STBRectPack {
    ...
    public static void stbrp_init_target(@NativeType(value="stbrp_context *") STBRPContext sTBRPContext, int n2, int n3, @NativeType(value="stbrp_node *") STBRPNode.Buffer buffer) {
        STBRectPack.nstbrp_init_target(sTBRPContext.address(), n2, n3, buffer.address(), buffer.remaining());
    }

    public static native void nstbrp_setup_allow_out_of_mem(long var0, int var2);

    public static void stbrp_setup_allow_out_of_mem(@NativeType(value="stbrp_context *") STBRPContext sTBRPContext, @NativeType(value="int") boolean bl2) {
        STBRectPack.nstbrp_setup_allow_out_of_mem(sTBRPContext.address(), bl2 ? 1 : 0);
    }

    public static native void nstbrp_setup_heuristic(long var0, int var2);

    public static void stbrp_setup_heuristic(@NativeType(value="stbrp_context *") STBRPContext sTBRPContext, int n2) {
        STBRectPack.nstbrp_setup_heuristic(sTBRPContext.address(), n2);
    }
