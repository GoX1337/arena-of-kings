...
extends CallbackI {
    ...
    default public void callback(long l2, long l3) {
        int n2 = this.invoke(MemoryUtil.memGetAddress(MemoryUtil.memGetAddress(l3)), MemoryUtil.memGetAddress(MemoryUtil.memGetAddress(l3 + (long)POINTER_SIZE)), MemoryUtil.memGetInt(MemoryUtil.memGetAddress(l3 + (long)(2 * POINTER_SIZE))));
        APIUtil.apiClosureRet(l2, n2);
    }
