...
implements NativeResource {
    ...
    public XReparentEvent serial(@NativeType(value="unsigned long") long l2) {
        XReparentEvent.nserial(this.address(), l2);
        return this;
    }

    public XReparentEvent send_event(@NativeType(value="Bool") boolean bl2) {
        XReparentEvent.nsend_event(this.address(), bl2 ? 1 : 0);
        return this;
    }

    public XReparentEvent display(@NativeType(value="Display *") long l2) {
        XReparentEvent.ndisplay(this.address(), l2);
        return this;
    }

    public XReparentEvent event(@NativeType(value="Window") long l2) {
        XReparentEvent.nevent(this.address(), l2);
        return this;
    }

    public XReparentEvent window(@NativeType(value="Window") long l2) {
        XReparentEvent.nwindow(this.address(), l2);
        return this;
    }

    public XReparentEvent parent(@NativeType(value="Window") long l2) {
    ...
    public static XReparentEvent create() {
        ...
        return XReparentEvent.wrap(XReparentEvent.class, MemoryUtil.memAddress(byteBuffer), byteBuffer);
    }

    public static XReparentEvent create(long l2) {
        return XReparentEvent.wrap(XReparentEvent.class, l2);
    }

    @Nullable
    public static XReparentEvent createSafe(long l2) {
        return l2 == 0L ? null : XReparentEvent.wrap(XReparentEvent.class, l2);
    }

    public static Buffer malloc(int n2) {
        return XReparentEvent.wrap(Buffer.class, MemoryUtil.nmemAllocChecked(XReparentEvent.__checkMalloc(n2, SIZEOF)), n2);
    }

    public static Buffer calloc(int n2) {
        return XReparentEvent.wrap(Buffer.class, MemoryUtil.nmemCallocChecked(n2, SIZEOF), n2);
    }

    public static Buffer create(int n2) {
        ByteBuffer byteBuffer = XReparentEvent.__create(n2, SIZEOF);
        return XReparentEvent.wrap(Buffer.class, MemoryUtil.memAddress(byteBuffer), n2, byteBuffer);
    }

    public static Buffer create(long l2, int n2) {
        return XReparentEvent.wrap(Buffer.class, l2, n2);
    }

    @Nullable
    public static Buffer createSafe(long l2, int n2) {
        return l2 == 0L ? null : XReparentEvent.wrap(Buffer.class, l2, n2);
    }
    ...
    public static XReparentEvent malloc(MemoryStack memoryStack) {
        return XReparentEvent.wrap(XReparentEvent.class, memoryStack.nmalloc(ALIGNOF, SIZEOF));
    }

    public static XReparentEvent calloc(MemoryStack memoryStack) {
        return XReparentEvent.wrap(XReparentEvent.class, memoryStack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    public static Buffer malloc(int n2, MemoryStack memoryStack) {
        return XReparentEvent.wrap(Buffer.class, memoryStack.nmalloc(ALIGNOF, n2 * SIZEOF), n2);
    }

    public static Buffer calloc(int n2, MemoryStack memoryStack) {
        return XReparentEvent.wrap(Buffer.class, memoryStack.ncalloc(ALIGNOF, n2, SIZEOF), n2);
    }
