...
implements NativeResource {
    ...
    public XUnmapEvent serial(@NativeType(value="unsigned long") long l2) {
        XUnmapEvent.nserial(this.address(), l2);
        return this;
    }

    public XUnmapEvent send_event(@NativeType(value="Bool") boolean bl2) {
        XUnmapEvent.nsend_event(this.address(), bl2 ? 1 : 0);
        return this;
    }

    public XUnmapEvent display(@NativeType(value="Display *") long l2) {
        XUnmapEvent.ndisplay(this.address(), l2);
        return this;
    }

    public XUnmapEvent event(@NativeType(value="Window") long l2) {
        XUnmapEvent.nevent(this.address(), l2);
        return this;
    }

    public XUnmapEvent window(@NativeType(value="Window") long l2) {
    ...
    public static XUnmapEvent create() {
        ...
        return XUnmapEvent.wrap(XUnmapEvent.class, MemoryUtil.memAddress(byteBuffer), byteBuffer);
    }

    public static XUnmapEvent create(long l2) {
        return XUnmapEvent.wrap(XUnmapEvent.class, l2);
    }

    @Nullable
    public static XUnmapEvent createSafe(long l2) {
        return l2 == 0L ? null : XUnmapEvent.wrap(XUnmapEvent.class, l2);
    }

    public static Buffer malloc(int n2) {
        return XUnmapEvent.wrap(Buffer.class, MemoryUtil.nmemAllocChecked(XUnmapEvent.__checkMalloc(n2, SIZEOF)), n2);
    }

    public static Buffer calloc(int n2) {
        return XUnmapEvent.wrap(Buffer.class, MemoryUtil.nmemCallocChecked(n2, SIZEOF), n2);
    }

    public static Buffer create(int n2) {
        ByteBuffer byteBuffer = XUnmapEvent.__create(n2, SIZEOF);
        return XUnmapEvent.wrap(Buffer.class, MemoryUtil.memAddress(byteBuffer), n2, byteBuffer);
    }

    public static Buffer create(long l2, int n2) {
        return XUnmapEvent.wrap(Buffer.class, l2, n2);
    }

    @Nullable
    public static Buffer createSafe(long l2, int n2) {
        return l2 == 0L ? null : XUnmapEvent.wrap(Buffer.class, l2, n2);
    }
    ...
    public static XUnmapEvent malloc(MemoryStack memoryStack) {
        return XUnmapEvent.wrap(XUnmapEvent.class, memoryStack.nmalloc(ALIGNOF, SIZEOF));
    }

    public static XUnmapEvent calloc(MemoryStack memoryStack) {
        return XUnmapEvent.wrap(XUnmapEvent.class, memoryStack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    public static Buffer malloc(int n2, MemoryStack memoryStack) {
        return XUnmapEvent.wrap(Buffer.class, memoryStack.nmalloc(ALIGNOF, n2 * SIZEOF), n2);
    }

    public static Buffer calloc(int n2, MemoryStack memoryStack) {
        return XUnmapEvent.wrap(Buffer.class, memoryStack.ncalloc(ALIGNOF, n2, SIZEOF), n2);
    }
    ...
    implements NativeResource {
        ...
        public Buffer from_configure(int n2) {
            XUnmapEvent.nfrom_configure(this.address(), n2);
            return this;
        }
    }
