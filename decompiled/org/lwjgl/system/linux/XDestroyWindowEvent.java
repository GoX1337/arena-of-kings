...
implements NativeResource {
    ...
    public XDestroyWindowEvent send_event(@NativeType(value="Bool") boolean bl2) {
        XDestroyWindowEvent.nsend_event(this.address(), bl2 ? 1 : 0);
        return this;
    }
    ...
    public XDestroyWindowEvent set(int n2, long l2, boolean bl2, long l3, long l4, long l5) {
        this.type(n2);
        this.serial(l2);
        this.send_event(bl2);
        this.display(l3);
    ...
    public static XDestroyWindowEvent create() {
        ...
        return XDestroyWindowEvent.wrap(XDestroyWindowEvent.class, MemoryUtil.memAddress(byteBuffer), byteBuffer);
    }

    public static XDestroyWindowEvent create(long l2) {
        return XDestroyWindowEvent.wrap(XDestroyWindowEvent.class, l2);
    }

    @Nullable
    public static XDestroyWindowEvent createSafe(long l2) {
        return l2 == 0L ? null : XDestroyWindowEvent.wrap(XDestroyWindowEvent.class, l2);
    }

    public static Buffer malloc(int n2) {
        return XDestroyWindowEvent.wrap(Buffer.class, MemoryUtil.nmemAllocChecked(XDestroyWindowEvent.__checkMalloc(n2, SIZEOF)), n2);
    }

    public static Buffer calloc(int n2) {
        return XDestroyWindowEvent.wrap(Buffer.class, MemoryUtil.nmemCallocChecked(n2, SIZEOF), n2);
    }

    public static Buffer create(int n2) {
        ByteBuffer byteBuffer = XDestroyWindowEvent.__create(n2, SIZEOF);
        return XDestroyWindowEvent.wrap(Buffer.class, MemoryUtil.memAddress(byteBuffer), n2, byteBuffer);
    }

    public static Buffer create(long l2, int n2) {
        return XDestroyWindowEvent.wrap(Buffer.class, l2, n2);
    }

    @Nullable
    public static Buffer createSafe(long l2, int n2) {
        return l2 == 0L ? null : XDestroyWindowEvent.wrap(Buffer.class, l2, n2);
    }
    ...
    public static XDestroyWindowEvent malloc(MemoryStack memoryStack) {
        return XDestroyWindowEvent.wrap(XDestroyWindowEvent.class, memoryStack.nmalloc(ALIGNOF, SIZEOF));
    }

    public static XDestroyWindowEvent calloc(MemoryStack memoryStack) {
        return XDestroyWindowEvent.wrap(XDestroyWindowEvent.class, memoryStack.ncalloc(ALIGNOF, 1, SIZEOF));
    }

    public static Buffer malloc(int n2, MemoryStack memoryStack) {
        return XDestroyWindowEvent.wrap(Buffer.class, memoryStack.nmalloc(ALIGNOF, n2 * SIZEOF), n2);
    }

    public static Buffer calloc(int n2, MemoryStack memoryStack) {
        return XDestroyWindowEvent.wrap(Buffer.class, memoryStack.ncalloc(ALIGNOF, n2, SIZEOF), n2);
    }
