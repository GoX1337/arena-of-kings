...
public class ObjCRuntime {
    ...
    public static boolean nclass_addIvar(long l2, long l3, long l4, byte by2, long l5) {
        ...
        return JNI.invokePPPPZ(l2, l3, l4, by2, l5, l6);
    }

    @NativeType(value="BOOL")
    public static boolean class_addIvar(@NativeType(value="Class") long l2, @NativeType(value="char const *") ByteBuffer byteBuffer, @NativeType(value="size_t") long l3, @NativeType(value="uint8_t") byte by2, @NativeType(value="char const *") ByteBuffer byteBuffer2) {
        if (Checks.CHECKS) {
            Checks.checkNT1(byteBuffer);
     ...
     */
    @NativeType(value="BOOL")
    public static boolean class_addIvar(@NativeType(value="Class") long l2, @NativeType(value="char const *") CharSequence charSequence, @NativeType(value="size_t") long l3, @NativeType(value="uint8_t") byte by2, @NativeType(value="char const *") CharSequence charSequence2) {
        MemoryStack memoryStack = MemoryStack.stackGet();
        int n2 = memoryStack.getPointer();
        try {
            memoryStack.nUTF8(charSequence, true);
    ...
    public static boolean class_addProperty(@NativeType(value="Class") long l2, @NativeType(value="char const *") ByteBuffer byteBuffer, @NativeType(value="objc_property_attribute_t const *") ObjCPropertyAttribute.Buffer buffer) {
        ...
        return ObjCRuntime.nclass_addProperty(l2, MemoryUtil.memAddress(byteBuffer), buffer.address(), buffer.remaining());
    }
    ...
    public static boolean class_addProperty(@NativeType(value="Class") long l2, @NativeType(value="char const *") CharSequence charSequence, @NativeType(value="objc_property_attribute_t const *") ObjCPropertyAttribute.Buffer buffer) {
        ...
        try {
            memoryStack.nUTF8(charSequence, true);
            long l3 = memoryStack.getPointerAddress();
            boolean bl2 = ObjCRuntime.nclass_addProperty(l2, l3, buffer.address(), buffer.remaining());
            return bl2;
        }
        finally {
            memoryStack.setPointer(n2);
    ...
    public static void class_replaceProperty(@NativeType(value="Class") long l2, @NativeType(value="char const *") ByteBuffer byteBuffer, @NativeType(value="objc_property_attribute_t const *") ObjCPropertyAttribute.Buffer buffer) {
        ...
        ObjCRuntime.nclass_replaceProperty(l2, MemoryUtil.memAddress(byteBuffer), buffer.address(), buffer.remaining());
    }
    ...
    public static void class_replaceProperty(@NativeType(value="Class") long l2, @NativeType(value="char const *") CharSequence charSequence, @NativeType(value="objc_property_attribute_t const *") ObjCPropertyAttribute.Buffer buffer) {
        ...
        try {
            memoryStack.nUTF8(charSequence, true);
            long l3 = memoryStack.getPointerAddress();
            ObjCRuntime.nclass_replaceProperty(l2, l3, buffer.address(), buffer.remaining());
        }
        finally {
            memoryStack.setPointer(n2);
        }
    ...
    public static ObjCPropertyAttribute.Buffer property_copyAttributeList(@NativeType(value="objc_property_t") long l2) {
        ...
        try {
            ...
            ObjCPropertyAttribute.Buffer buffer = ObjCPropertyAttribute.createSafe(l3, intBuffer.get(0));
            return buffer;
        }
        finally {
            memoryStack.setPointer(n2);
    ...
    public static ObjCMethodDescription protocol_getMethodDescription(@NativeType(value="Protocol *") long l2, @NativeType(value="SEL") long l3, @NativeType(value="BOOL") boolean bl2, @NativeType(value="BOOL") boolean bl3, @NativeType(value="struct objc_method_description") ObjCMethodDescription objCMethodDescription) {
    ...
    @Nullable
    @NativeType(value="struct objc_method_description *")
    public static ObjCMethodDescription.Buffer protocol_copyMethodDescriptionList(@NativeType(value="Protocol *") long l2, @NativeType(value="BOOL") boolean bl2, @NativeType(value="BOOL") boolean bl3) {
        MemoryStack memoryStack = MemoryStack.stackGet();
        int n2 = memoryStack.getPointer();
        IntBuffer intBuffer = memoryStack.callocInt(1);
        try {
            long l3 = ObjCRuntime.nprotocol_copyMethodDescriptionList(l2, bl2, bl3, MemoryUtil.memAddress(intBuffer));
            ObjCMethodDescription.Buffer buffer = ObjCMethodDescription.createSafe(l3, intBuffer.get(0));
            return buffer;
        }
        finally {
            memoryStack.setPointer(n2);
    ...
    @NativeType(value="objc_property_t")
    public static long protocol_getProperty(@NativeType(value="Protocol *") long l2, @NativeType(value="char const *") ByteBuffer byteBuffer, @NativeType(value="BOOL") boolean bl2, @NativeType(value="BOOL") boolean bl3) {
        if (Checks.CHECKS) {
            Checks.checkNT1(byteBuffer);
        }
     ...
     */
    @NativeType(value="objc_property_t")
    public static long protocol_getProperty(@NativeType(value="Protocol *") long l2, @NativeType(value="char const *") CharSequence charSequence, @NativeType(value="BOOL") boolean bl2, @NativeType(value="BOOL") boolean bl3) {
        MemoryStack memoryStack = MemoryStack.stackGet();
        int n2 = memoryStack.getPointer();
        try {
            memoryStack.nUTF8(charSequence, true);
    ...
    public static void protocol_addMethodDescription(@NativeType(value="Protocol *") long l2, @NativeType(value="SEL") long l3, @NativeType(value="char const *") ByteBuffer byteBuffer, @NativeType(value="BOOL") boolean bl2, @NativeType(value="BOOL") boolean bl3) {
        if (Checks.CHECKS) {
            Checks.checkNT1(byteBuffer);
        }
     ...
     * WARNING - Removed try catching itself - possible behaviour change.
     */
    public static void protocol_addMethodDescription(@NativeType(value="Protocol *") long l2, @NativeType(value="SEL") long l3, @NativeType(value="char const *") CharSequence charSequence, @NativeType(value="BOOL") boolean bl2, @NativeType(value="BOOL") boolean bl3) {
        MemoryStack memoryStack = MemoryStack.stackGet();
        int n2 = memoryStack.getPointer();
        try {
            memoryStack.nUTF8(charSequence, true);
    ...
    public static void protocol_addProperty(@NativeType(value="Protocol *") long l2, @NativeType(value="char const *") ByteBuffer byteBuffer, @NativeType(value="objc_property_attribute_t const *") ObjCPropertyAttribute.Buffer buffer, @NativeType(value="BOOL") boolean bl2, @NativeType(value="BOOL") boolean bl3) {
        if (Checks.CHECKS) {
            Checks.checkNT1(byteBuffer);
        }
        ObjCRuntime.nprotocol_addProperty(l2, MemoryUtil.memAddress(byteBuffer), buffer.address(), buffer.remaining(), bl2, bl3);
    }

    /*
     * WARNING - Removed try catching itself - possible behaviour change.
     */
    public static void protocol_addProperty(@NativeType(value="Protocol *") long l2, @NativeType(value="char const *") CharSequence charSequence, @NativeType(value="objc_property_attribute_t const *") ObjCPropertyAttribute.Buffer buffer, @NativeType(value="BOOL") boolean bl2, @NativeType(value="BOOL") boolean bl3) {
        MemoryStack memoryStack = MemoryStack.stackGet();
        int n2 = memoryStack.getPointer();
        try {
            memoryStack.nUTF8(charSequence, true);
            long l3 = memoryStack.getPointerAddress();
            ObjCRuntime.nprotocol_addProperty(l2, l3, buffer.address(), buffer.remaining(), bl2, bl3);
        }
        finally {
            memoryStack.setPointer(n2);
        }
