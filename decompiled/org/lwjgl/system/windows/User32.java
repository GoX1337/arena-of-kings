...
public class User32 {
    ...
    public static short nRegisterClassEx(long l2) {
        long l3 = Functions.RegisterClassEx;
        if (Checks.CHECKS) {
            WNDCLASSEX.validate(l2);
        }
        return User32.nRegisterClassEx(l2, l3);
    }
    ...
    public static int nUnregisterClass(long l2, long l3) {
        long l4 = Functions.UnregisterClass;
        return User32.nUnregisterClass(l2, l3, l4);
    }

    @NativeType(value="BOOL")
    public static boolean UnregisterClass(@NativeType(value="LPCTSTR") ByteBuffer byteBuffer, @NativeType(value="HINSTANCE") long l2) {
        if (Checks.CHECKS) {
            Checks.checkNT2(byteBuffer);
        }
        return User32.nUnregisterClass(MemoryUtil.memAddress(byteBuffer), l2) != 0;
    }
     ...
     */
    @NativeType(value="BOOL")
    public static boolean UnregisterClass(@NativeType(value="LPCTSTR") CharSequence charSequence, @NativeType(value="HINSTANCE") long l2) {
        MemoryStack memoryStack = MemoryStack.stackGet();
        int n2 = memoryStack.getPointer();
        try {
            memoryStack.nUTF16(charSequence, true);
            long l3 = memoryStack.getPointerAddress();
            boolean bl2 = User32.nUnregisterClass(l3, l2) != 0;
            return bl2;
        }
        finally {
    ...
    public static long nCreateWindowEx(int n2, long l2, long l3, int n3, int n4, int n5, int n6, int n7, long l4, long l5, long l6, long l7) {
        long l8 = Functions.CreateWindowEx;
        return User32.nCreateWindowEx(n2, l2, l3, n3, n4, n5, n6, n7, l4, l5, l6, l7, l8);
    }

    @NativeType(value="HWND")
    public static long CreateWindowEx(@NativeType(value="DWORD") int n2, @Nullable @NativeType(value="LPCTSTR") ByteBuffer byteBuffer, @Nullable @NativeType(value="LPCTSTR") ByteBuffer byteBuffer2, @NativeType(value="DWORD") int n3, int n4, int n5, int n6, int n7, @NativeType(value="HWND") long l2, @NativeType(value="HMENU") long l3, @NativeType(value="HINSTANCE") long l4, @NativeType(value="LPVOID") long l5) {
        if (Checks.CHECKS) {
            Checks.checkNT2Safe(byteBuffer);
            Checks.checkNT2Safe(byteBuffer2);
        }
        return User32.nCreateWindowEx(n2, MemoryUtil.memAddressSafe(byteBuffer), MemoryUtil.memAddressSafe(byteBuffer2), n3, n4, n5, n6, n7, l2, l3, l4, l5);
    }
     ...
     */
    @NativeType(value="HWND")
    public static long CreateWindowEx(@NativeType(value="DWORD") int n2, @Nullable @NativeType(value="LPCTSTR") CharSequence charSequence, @Nullable @NativeType(value="LPCTSTR") CharSequence charSequence2, @NativeType(value="DWORD") int n3, int n4, int n5, int n6, int n7, @NativeType(value="HWND") long l2, @NativeType(value="HMENU") long l3, @NativeType(value="HINSTANCE") long l4, @NativeType(value="LPVOID") long l5) {
        MemoryStack memoryStack = MemoryStack.stackGet();
        int n8 = memoryStack.getPointer();
        try {
            memoryStack.nUTF16Safe(charSequence, true);
            long l6 = charSequence == null ? 0L : memoryStack.getPointerAddress();
            memoryStack.nUTF16Safe(charSequence2, true);
            long l7 = charSequence2 == null ? 0L : memoryStack.getPointerAddress();
            long l8 = User32.nCreateWindowEx(n2, l6, l7, n3, n4, n5, n6, n7, l2, l3, l4, l5);
            return l8;
        }
        finally {
    ...
    @NativeType(value="BOOL")
    public static boolean DestroyWindow(@NativeType(value="HWND") long l2) {
        long l3 = Functions.DestroyWindow;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        return User32.nDestroyWindow(l2, l3) != 0;
    }

    @NativeType(value="LRESULT")
    public static long DefWindowProc(@NativeType(value="HWND") long l2, @NativeType(value="UINT") int n2, @NativeType(value="WPARAM") long l3, @NativeType(value="LPARAM") long l4) {
        long l5 = Functions.DefWindowProc;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
    ...
    public static long nCallWindowProc(long l2, long l3, int n2, long l4, long l5) {
        long l6 = Functions.CallWindowProc;
        if (Checks.CHECKS) {
            Checks.check(l3);
        }
    ...
    @NativeType(value="LRESULT")
    public static long CallWindowProc(@NativeType(value="WNDPROC") WindowProcI windowProcI, @NativeType(value="HWND") long l2, @NativeType(value="UINT") int n2, @NativeType(value="WPARAM") long l3, @NativeType(value="LPARAM") long l4) {
        return User32.nCallWindowProc(windowProcI.address(), l2, n2, l3, l4);
    }

    @NativeType(value="BOOL")
    public static boolean ShowWindow(@NativeType(value="HWND") long l2, int n2) {
    ...
    @NativeType(value="BOOL")
    public static boolean UpdateWindow(@NativeType(value="HWND") long l2) {
        long l3 = Functions.UpdateWindow;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
    ...
    @NativeType(value="BOOL")
    public static boolean SetWindowPos(@NativeType(value="HWND") long l2, @NativeType(value="HWND") long l3, int n2, int n3, int n4, int n5, @NativeType(value="UINT") int n6) {
        long l4 = Functions.SetWindowPos;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        return User32.nSetWindowPos(l2, l3, n2, n3, n4, n5, n6, l4) != 0;
    }

    public static native int nSetWindowText(long var0, long var2, long var4);

    public static int nSetWindowText(long l2, long l3) {
        long l4 = Functions.SetWindowText;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        return User32.nSetWindowText(l2, l3, l4);
    }

    @NativeType(value="BOOL")
    public static boolean SetWindowText(@NativeType(value="HWND") long l2, @NativeType(value="LPCTSTR") ByteBuffer byteBuffer) {
        if (Checks.CHECKS) {
            Checks.checkNT2(byteBuffer);
        }
        return User32.nSetWindowText(l2, MemoryUtil.memAddress(byteBuffer)) != 0;
    }
     ...
     */
    @NativeType(value="BOOL")
    public static boolean SetWindowText(@NativeType(value="HWND") long l2, @NativeType(value="LPCTSTR") CharSequence charSequence) {
        MemoryStack memoryStack = MemoryStack.stackGet();
        int n2 = memoryStack.getPointer();
        try {
            memoryStack.nUTF16(charSequence, true);
            long l3 = memoryStack.getPointerAddress();
            boolean bl2 = User32.nSetWindowText(l2, l3) != 0;
            return bl2;
        }
        finally {
            memoryStack.setPointer(n2);
    ...
    public static int nGetMessage(long l2, long l3, int n2, int n3) {
        long l4 = Functions.GetMessage;
        return User32.nGetMessage(l2, l3, n2, n3, l4);
    }

    @NativeType(value="BOOL")
    public static boolean GetMessage(@NativeType(value="LPMSG") MSG mSG, @NativeType(value="HWND") long l2, @NativeType(value="UINT") int n2, @NativeType(value="UINT") int n3) {
        return User32.nGetMessage(mSG.address(), l2, n2, n3) != 0;
    }

    public static int nPeekMessage(long l2, long l3, int n2, int n3, int n4) {
        long l4 = Functions.PeekMessage;
        return JNI.callPPI(l2, l3, n2, n3, n4, l4);
    }

    @NativeType(value="BOOL")
    public static boolean PeekMessage(@NativeType(value="LPMSG") MSG mSG, @NativeType(value="HWND") long l2, @NativeType(value="UINT") int n2, @NativeType(value="UINT") int n3, @NativeType(value="UINT") int n4) {
        return User32.nPeekMessage(mSG.address(), l2, n2, n3, n4) != 0;
    }

    public static int nTranslateMessage(long l2) {
        long l3 = Functions.TranslateMessage;
    ...
    public static boolean WaitMessage() {
        long l2 = Functions.WaitMessage;
        return User32.nWaitMessage(l2) != 0;
    }

    public static long nDispatchMessage(long l2) {
        long l3 = Functions.DispatchMessage;
    ...
    @NativeType(value="BOOL")
    public static boolean PostMessage(@NativeType(value="HWND") long l2, @NativeType(value="UINT") int n2, @NativeType(value="WPARAM") long l3, @NativeType(value="LPARAM") long l4) {
        long l5 = Functions.PostMessage;
        return User32.nPostMessage(l2, n2, l3, l4, l5) != 0;
    }

    public static native int nSendMessage(long var0, int var2, long var3, long var5, long var7);

    @NativeType(value="BOOL")
    public static boolean SendMessage(@NativeType(value="HWND") long l2, @NativeType(value="UINT") int n2, @NativeType(value="WPARAM") long l3, @NativeType(value="LPARAM") long l4) {
        long l5 = Functions.SendMessage;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        return User32.nSendMessage(l2, n2, l3, l4, l5) != 0;
    }

    public static native int nAdjustWindowRectEx(long var0, int var2, int var3, int var4, long var5);

    public static int nAdjustWindowRectEx(long l2, int n2, int n3, int n4) {
        long l3 = Functions.AdjustWindowRectEx;
        return User32.nAdjustWindowRectEx(l2, n2, n3, n4, l3);
    }

    @NativeType(value="BOOL")
    public static boolean AdjustWindowRectEx(@NativeType(value="LPRECT") RECT rECT, @NativeType(value="DWORD") int n2, @NativeType(value="BOOL") boolean bl2, @NativeType(value="DWORD") int n3) {
        return User32.nAdjustWindowRectEx(rECT.address(), n2, bl2 ? 1 : 0, n3) != 0;
    }

    public static native int nGetWindowRect(long var0, long var2, long var4);

    public static int nGetWindowRect(long l2, long l3) {
        long l4 = Functions.GetWindowRect;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        return User32.nGetWindowRect(l2, l3, l4);
    }

    @NativeType(value="BOOL")
    public static boolean GetWindowRect(@NativeType(value="HWND") long l2, @NativeType(value="LPRECT") RECT rECT) {
        return User32.nGetWindowRect(l2, rECT.address()) != 0;
    }

    public static native int nMoveWindow(long var0, int var2, int var3, int var4, int var5, int var6, long var7);

    @NativeType(value="BOOL")
    public static boolean MoveWindow(@NativeType(value="HWND") long l2, int n2, int n3, int n4, int n5, @NativeType(value="BOOL") boolean bl2) {
        long l3 = Functions.MoveWindow;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        return User32.nMoveWindow(l2, n2, n3, n4, n5, bl2 ? 1 : 0, l3) != 0;
    }

    public static native int nGetWindowPlacement(long var0, long var2, long var4);

    public static int nGetWindowPlacement(long l2, long l3) {
        long l4 = Functions.GetWindowPlacement;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        return User32.nGetWindowPlacement(l2, l3, l4);
    }

    @NativeType(value="BOOL")
    public static boolean GetWindowPlacement(@NativeType(value="HWND") long l2, @NativeType(value="WINDOWPLACEMENT *") WINDOWPLACEMENT wINDOWPLACEMENT) {
        return User32.nGetWindowPlacement(l2, wINDOWPLACEMENT.address()) != 0;
    }

    public static native int nSetWindowPlacement(long var0, long var2, long var4);

    public static int nSetWindowPlacement(long l2, long l3) {
        long l4 = Functions.SetWindowPlacement;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        return User32.nSetWindowPlacement(l2, l3, l4);
    }

    @NativeType(value="BOOL")
    public static boolean SetWindowPlacement(@NativeType(value="HWND") long l2, @NativeType(value="WINDOWPLACEMENT const *") WINDOWPLACEMENT wINDOWPLACEMENT) {
        return User32.nSetWindowPlacement(l2, wINDOWPLACEMENT.address()) != 0;
    }

    @NativeType(value="BOOL")
    public static boolean IsWindowVisible(@NativeType(value="HWND") long l2) {
        long l3 = Functions.IsWindowVisible;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        return JNI.callPI(l2, l3) != 0;
    ...
    @NativeType(value="BOOL")
    public static boolean IsIconic(@NativeType(value="HWND") long l2) {
        long l3 = Functions.IsIconic;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        return JNI.callPI(l2, l3) != 0;
    ...
    @NativeType(value="BOOL")
    public static boolean IsZoomed(@NativeType(value="HWND") long l2) {
        long l3 = Functions.IsZoomed;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        return JNI.callPI(l2, l3) != 0;
    ...
    @NativeType(value="BOOL")
    public static boolean BringWindowToTop(@NativeType(value="HWND") long l2) {
        long l3 = Functions.BringWindowToTop;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        return JNI.callPI(l2, l3) != 0;
    ...
    public static long SetWindowLongPtr(@NativeType(value="HWND") long l2, int n2, @NativeType(value="LONG_PTR") long l3) {
        long l4 = Functions.SetWindowLongPtr;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        return User32.nSetWindowLongPtr(l2, n2, l3, l4);
    }

    public static native long nGetWindowLongPtr(long var0, int var2, long var3);

    @NativeType(value="LONG_PTR")
    public static long GetWindowLongPtr(@NativeType(value="HWND") long l2, int n2) {
        long l3 = Functions.GetWindowLongPtr;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        return User32.nGetWindowLongPtr(l2, n2, l3);
    }

    public static native long nSetClassLongPtr(long var0, int var2, long var3, long var5);

    @NativeType(value="LONG_PTR")
    public static long SetClassLongPtr(@NativeType(value="HWND") long l2, int n2, @NativeType(value="LONG_PTR") long l3) {
        long l4 = Functions.SetClassLongPtr;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        return User32.nSetClassLongPtr(l2, n2, l3, l4);
    }

    public static native long nGetClassLongPtr(long var0, int var2, long var3);

    @NativeType(value="LONG_PTR")
    public static long GetClassLongPtr(@NativeType(value="HWND") long l2, int n2) {
        long l3 = Functions.GetClassLongPtr;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        return User32.nGetClassLongPtr(l2, n2, l3);
    }

    public static native int nSetLayeredWindowAttributes(long var0, int var2, byte var3, int var4, long var5);

    @NativeType(value="BOOL")
    public static boolean SetLayeredWindowAttributes(@NativeType(value="HWND") long l2, @NativeType(value="COLORREF") int n2, @NativeType(value="BYTE") byte by2, @NativeType(value="DWORD") int n3) {
        long l3 = Functions.SetLayeredWindowAttributes;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        return User32.nSetLayeredWindowAttributes(l2, n2, by2, n3, l3) != 0;
    }

    public static native long nLoadIcon(long var0, long var2, long var4);

    public static long nLoadIcon(long l2, long l3) {
        long l4 = Functions.LoadIcon;
        return User32.nLoadIcon(l2, l3, l4);
    }

    @NativeType(value="HICON")
    public static long LoadIcon(@NativeType(value="HINSTANCE") long l2, @NativeType(value="LPCTSTR") ByteBuffer byteBuffer) {
        if (Checks.CHECKS) {
            Checks.checkNT2(byteBuffer);
        }
        return User32.nLoadIcon(l2, MemoryUtil.memAddress(byteBuffer));
    }
     ...
     */
    @NativeType(value="HICON")
    public static long LoadIcon(@NativeType(value="HINSTANCE") long l2, @NativeType(value="LPCTSTR") CharSequence charSequence) {
        MemoryStack memoryStack = MemoryStack.stackGet();
        int n2 = memoryStack.getPointer();
        try {
            memoryStack.nUTF16(charSequence, true);
            long l3 = memoryStack.getPointerAddress();
            long l4 = User32.nLoadIcon(l2, l3);
            return l4;
        }
        finally {
            memoryStack.setPointer(n2);
    ...
    public static long nLoadCursor(long l2, long l3) {
        long l4 = Functions.LoadCursor;
        return User32.nLoadCursor(l2, l3, l4);
    }

    @NativeType(value="HCURSOR")
    public static long LoadCursor(@NativeType(value="HINSTANCE") long l2, @NativeType(value="LPCTSTR") ByteBuffer byteBuffer) {
        if (Checks.CHECKS) {
            Checks.checkNT2(byteBuffer);
        }
        return User32.nLoadCursor(l2, MemoryUtil.memAddress(byteBuffer));
    }
     ...
     */
    @NativeType(value="HCURSOR")
    public static long LoadCursor(@NativeType(value="HINSTANCE") long l2, @NativeType(value="LPCTSTR") CharSequence charSequence) {
        MemoryStack memoryStack = MemoryStack.stackGet();
        int n2 = memoryStack.getPointer();
        try {
            memoryStack.nUTF16(charSequence, true);
            long l3 = memoryStack.getPointerAddress();
            long l4 = User32.nLoadCursor(l2, l3);
            return l4;
        }
        finally {
            memoryStack.setPointer(n2);
    ...
    public static long GetDC(@NativeType(value="HWND") long l2) {
        long l3 = Functions.GetDC;
        return JNI.callPP(l2, l3);
    }

    @NativeType(value="BOOL")
    public static boolean ReleaseDC(@NativeType(value="HWND") long l2, @NativeType(value="HDC") long l3) {
        long l4 = Functions.ReleaseDC;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(l3);
        }
    ...
    public static int GetSystemMetrics(int n2) {
        long l2 = Functions.GetSystemMetrics;
    ...
    @NativeType(value="BOOL")
    public static boolean RegisterTouchWindow(@NativeType(value="HWND") long l2, @NativeType(value="ULONG") int n2) {
        long l3 = Functions.RegisterTouchWindow;
        if (Checks.CHECKS) {
            Checks.check(l3);
            Checks.check(l2);
        }
        return User32.nRegisterTouchWindow(l2, n2, l3) != 0;
    }

    public static native int nUnregisterTouchWindow(long var0, long var2);

    @NativeType(value="BOOL")
    public static boolean UnregisterTouchWindow(@NativeType(value="HWND") long l2) {
        long l3 = Functions.UnregisterTouchWindow;
        if (Checks.CHECKS) {
            Checks.check(l3);
            Checks.check(l2);
        }
        return User32.nUnregisterTouchWindow(l2, l3) != 0;
    }

    public static int nIsTouchWindow(long l2, long l3) {
        long l4 = Functions.IsTouchWindow;
        if (Checks.CHECKS) {
            Checks.check(l4);
            Checks.check(l2);
        }
    ...
    @NativeType(value="BOOL")
    public static boolean IsTouchWindow(@NativeType(value="HWND") long l2, @Nullable @NativeType(value="PULONG") IntBuffer intBuffer) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)intBuffer, 1);
        }
        return User32.nIsTouchWindow(l2, MemoryUtil.memAddressSafe(intBuffer)) != 0;
    }

    public static native int nGetTouchInputInfo(long var0, int var2, long var3, int var5, long var6);

    public static int nGetTouchInputInfo(long l2, int n2, long l3, int n3) {
        long l4 = Functions.GetTouchInputInfo;
        if (Checks.CHECKS) {
            Checks.check(l4);
            Checks.check(l2);
        }
        return User32.nGetTouchInputInfo(l2, n2, l3, n3, l4);
    }

    @NativeType(value="BOOL")
    public static boolean GetTouchInputInfo(@NativeType(value="HTOUCHINPUT") long l2, @NativeType(value="PTOUCHINPUT") TOUCHINPUT.Buffer buffer, int n2) {
        return User32.nGetTouchInputInfo(l2, buffer.remaining(), buffer.address(), n2) != 0;
    }

    public static native int nCloseTouchInputHandle(long var0, long var2);

    @NativeType(value="BOOL")
    public static boolean CloseTouchInputHandle(@NativeType(value="HTOUCHINPUT") long l2) {
        long l3 = Functions.CloseTouchInputHandle;
        if (Checks.CHECKS) {
            Checks.check(l3);
            Checks.check(l2);
        }
        return User32.nCloseTouchInputHandle(l2, l3) != 0;
    }

    @NativeType(value="HMONITOR")
    public static long MonitorFromWindow(@NativeType(value="HWND") long l2, @NativeType(value="DWORD") int n2) {
        long l3 = Functions.MonitorFromWindow;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
    ...
    public static int nGetMonitorInfo(long l2, long l3) {
        long l4 = Functions.GetMonitorInfo;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        return JNI.callPPI(l2, l3, l4);
    ...
    @NativeType(value="BOOL")
    public static boolean GetMonitorInfo(@NativeType(value="HMONITOR") long l2, @NativeType(value="LPMONITORINFOEX") MONITORINFOEX mONITORINFOEX) {
        return User32.nGetMonitorInfo(l2, mONITORINFOEX.address()) != 0;
    }

    public static int nEnumDisplayDevices(long l2, int n2, long l3, int n3) {
        long l4 = Functions.EnumDisplayDevices;
        return JNI.callPPI(l2, n2, l3, n3, l4);
    }

    @NativeType(value="BOOL")
    public static boolean EnumDisplayDevices(@Nullable @NativeType(value="LPCTSTR") ByteBuffer byteBuffer, @NativeType(value="DWORD") int n2, @NativeType(value="PDISPLAY_DEVICE") DISPLAY_DEVICE dISPLAY_DEVICE, @NativeType(value="DWORD") int n3) {
        if (Checks.CHECKS) {
            Checks.checkNT2Safe(byteBuffer);
        }
        return User32.nEnumDisplayDevices(MemoryUtil.memAddressSafe(byteBuffer), n2, dISPLAY_DEVICE.address(), n3) != 0;
    }
     ...
     */
    @NativeType(value="BOOL")
    public static boolean EnumDisplayDevices(@Nullable @NativeType(value="LPCTSTR") CharSequence charSequence, @NativeType(value="DWORD") int n2, @NativeType(value="PDISPLAY_DEVICE") DISPLAY_DEVICE dISPLAY_DEVICE, @NativeType(value="DWORD") int n3) {
        MemoryStack memoryStack = MemoryStack.stackGet();
        int n4 = memoryStack.getPointer();
        try {
            memoryStack.nUTF16Safe(charSequence, true);
            long l2 = charSequence == null ? 0L : memoryStack.getPointerAddress();
            boolean bl2 = User32.nEnumDisplayDevices(l2, n2, dISPLAY_DEVICE.address(), n3) != 0;
            return bl2;
        }
        finally {
    ...
    public static int nEnumDisplaySettingsEx(long l2, int n2, long l3, int n3) {
        long l4 = Functions.EnumDisplaySettingsEx;
        return JNI.callPPI(l2, n2, l3, n3, l4);
    }

    @NativeType(value="BOOL")
    public static boolean EnumDisplaySettingsEx(@Nullable @NativeType(value="LPCTSTR") ByteBuffer byteBuffer, @NativeType(value="DWORD") int n2, @NativeType(value="DEVMODE *") DEVMODE dEVMODE, @NativeType(value="DWORD") int n3) {
        if (Checks.CHECKS) {
            Checks.checkNT2Safe(byteBuffer);
        }
        return User32.nEnumDisplaySettingsEx(MemoryUtil.memAddressSafe(byteBuffer), n2, dEVMODE.address(), n3) != 0;
    }
     ...
     */
    @NativeType(value="BOOL")
    public static boolean EnumDisplaySettingsEx(@Nullable @NativeType(value="LPCTSTR") CharSequence charSequence, @NativeType(value="DWORD") int n2, @NativeType(value="DEVMODE *") DEVMODE dEVMODE, @NativeType(value="DWORD") int n3) {
        MemoryStack memoryStack = MemoryStack.stackGet();
        int n4 = memoryStack.getPointer();
        try {
            memoryStack.nUTF16Safe(charSequence, true);
            long l2 = charSequence == null ? 0L : memoryStack.getPointerAddress();
            boolean bl2 = User32.nEnumDisplaySettingsEx(l2, n2, dEVMODE.address(), n3) != 0;
            return bl2;
        }
        finally {
            memoryStack.setPointer(n4);
    ...
    public static int nChangeDisplaySettingsEx(long l2, long l3, long l4, int n2, long l5) {
        long l6 = Functions.ChangeDisplaySettingsEx;
        return JNI.callPPPPI(l2, l3, l4, n2, l5, l6);
    }

    @NativeType(value="LONG")
    public static int ChangeDisplaySettingsEx(@Nullable @NativeType(value="LPCTSTR") ByteBuffer byteBuffer, @Nullable @NativeType(value="DEVMODE *") DEVMODE dEVMODE, @NativeType(value="HWND") long l2, @NativeType(value="DWORD") int n2, @NativeType(value="LPVOID") long l3) {
        if (Checks.CHECKS) {
            Checks.checkNT2Safe(byteBuffer);
        }
        return User32.nChangeDisplaySettingsEx(MemoryUtil.memAddressSafe(byteBuffer), MemoryUtil.memAddressSafe(dEVMODE), l2, n2, l3);
    }
     ...
     */
    @NativeType(value="LONG")
    public static int ChangeDisplaySettingsEx(@Nullable @NativeType(value="LPCTSTR") CharSequence charSequence, @Nullable @NativeType(value="DEVMODE *") DEVMODE dEVMODE, @NativeType(value="HWND") long l2, @NativeType(value="DWORD") int n2, @NativeType(value="LPVOID") long l3) {
        MemoryStack memoryStack = MemoryStack.stackGet();
        int n3 = memoryStack.getPointer();
        try {
            memoryStack.nUTF16Safe(charSequence, true);
            long l4 = charSequence == null ? 0L : memoryStack.getPointerAddress();
            int n4 = User32.nChangeDisplaySettingsEx(l4, MemoryUtil.memAddressSafe(dEVMODE), l2, n2, l3);
            return n4;
        }
        finally {
    ...
    public static int nGetCursorPos(long l2) {
    ...
    @NativeType(value="BOOL")
    public static boolean SetCursorPos(int n2, int n3) {
        long l2 = Functions.SetCursorPos;
        return JNI.callI(n2, n3, l2) != 0;
    }

    public static int nClipCursor(long l2) {
        long l3 = Functions.ClipCursor;
        return JNI.callPI(l2, l3);
    }
    ...
    public static int ShowCursor(@NativeType(value="BOOL") boolean bl2) {
        long l2 = Functions.ShowCursor;
        return JNI.callI(bl2 ? 1 : 0, l2);
    }

    @NativeType(value="HCURSOR")
    public static long SetCursor(@NativeType(value="HCURSOR") long l2) {
        long l3 = Functions.SetCursor;
        return JNI.callPP(l2, l3);
    }

    public static int nClientToScreen(long l2, long l3) {
        long l4 = Functions.ClientToScreen;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        return JNI.callPPI(l2, l3, l4);
    ...
    @NativeType(value="BOOL")
    public static boolean ClientToScreen(@NativeType(value="HWND") long l2, @NativeType(value="LPPOINT") POINT pOINT) {
        return User32.nClientToScreen(l2, pOINT.address()) != 0;
    }

    @NativeType(value="SHORT")
    public static short GetAsyncKeyState(int n2) {
        long l2 = Functions.GetAsyncKeyState;
        return JNI.callS(n2, l2);
    }

    @NativeType(value="LPARAM")
    public static long GetMessageExtraInfo() {
        long l2 = Functions.GetMessageExtraInfo;
        return JNI.callP(l2);
    }

    public static int nSendInput(int n2, long l2, int n3) {
        long l3 = Functions.SendInput;
        return JNI.callPI(n2, l2, n3, l3);
    }

    @NativeType(value="UINT")
    public static int SendInput(@NativeType(value="PINPUT") INPUT.Buffer buffer, int n2) {
        return User32.nSendInput(buffer.remaining(), buffer.address(), n2);
    }

    @NativeType(value="UINT")
    public static int GetDpiForSystem() {
        long l2 = Functions.GetDpiForSystem;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        return JNI.callI(l2);
    ...
    @NativeType(value="UINT")
    public static int GetDpiForWindow(@NativeType(value="HWND") long l2) {
        long l3 = Functions.GetDpiForWindow;
        if (Checks.CHECKS) {
            Checks.check(l3);
            Checks.check(l2);
        }
    ...
    public static int GetAwarenessFromDpiAwarenessContext(@NativeType(value="DPI_AWARENESS_CONTEXT") long l2) {
        long l3 = Functions.GetAwarenessFromDpiAwarenessContext;
        if (Checks.CHECKS) {
            Checks.check(l3);
            Checks.check(l2);
        }
    ...
    public static long GetThreadDpiAwarenessContext() {
        long l2 = Functions.GetThreadDpiAwarenessContext;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        return JNI.callP(l2);
    ...
    @NativeType(value="DPI_AWARENESS_CONTEXT")
    public static long GetWindowDpiAwarenessContext(@NativeType(value="HWND") long l2) {
        long l3 = Functions.GetWindowDpiAwarenessContext;
        if (Checks.CHECKS) {
            Checks.check(l3);
            Checks.check(l2);
        }
    ...
    @NativeType(value="BOOL")
    public static boolean IsValidDpiAwarenessContext(@NativeType(value="DPI_AWARENESS_CONTEXT") long l2) {
        long l3 = Functions.IsValidDpiAwarenessContext;
        if (Checks.CHECKS) {
            Checks.check(l3);
        }
        return JNI.callPI(l2, l3) != 0;
    ...
    @NativeType(value="DPI_AWARENESS_CONTEXT")
    public static long SetThreadDpiAwarenessContext(@NativeType(value="DPI_AWARENESS_CONTEXT") long l2) {
        long l3 = Functions.SetThreadDpiAwarenessContext;
        if (Checks.CHECKS) {
            Checks.check(l3);
            Checks.check(l2);
        }
    ...
    @NativeType(value="BOOL")
    public static boolean IsTouchWindow(@NativeType(value="HWND") long l2, @Nullable @NativeType(value="PULONG") int[] nArray) {
