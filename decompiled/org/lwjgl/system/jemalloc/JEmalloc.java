...
public class JEmalloc {
    ...
    public static PointerBuffer je_malloc_message() {
        long l2 = Functions.malloc_message;
        return MemoryUtil.memPointerBuffer(l2, 1);
    }

    public static long nje_malloc(long l2) {
        long l3 = Functions.malloc;
        return JNI.invokePP(l2, l3);
    }

    @Nullable
    @NativeType(value="void *")
    public static ByteBuffer je_malloc(@NativeType(value="size_t") long l2) {
        long l3 = JEmalloc.nje_malloc(l2);
        return MemoryUtil.memByteBufferSafe(l3, (int)l2);
    }

    public static long nje_calloc(long l2, long l3) {
        long l4 = Functions.calloc;
        return JNI.invokePPP(l2, l3, l4);
    }

    @Nullable
    @NativeType(value="void *")
    public static ByteBuffer je_calloc(@NativeType(value="size_t") long l2, @NativeType(value="size_t") long l3) {
        long l4 = JEmalloc.nje_calloc(l2, l3);
        return MemoryUtil.memByteBufferSafe(l4, (int)l2 * (int)l3);
    }

    public static int nje_posix_memalign(long l2, long l3, long l4) {
        long l5 = Functions.posix_memalign;
        return JNI.invokePPPI(l2, l3, l4, l5);
    }

    public static int je_posix_memalign(@NativeType(value="void **") PointerBuffer pointerBuffer, @NativeType(value="size_t") long l2, @NativeType(value="size_t") long l3) {
        if (Checks.CHECKS) {
    ...
    public static long nje_aligned_alloc(long l2, long l3) {
        long l4 = Functions.aligned_alloc;
        return JNI.invokePPP(l2, l3, l4);
    }

    @Nullable
    @NativeType(value="void *")
    public static ByteBuffer je_aligned_alloc(@NativeType(value="size_t") long l2, @NativeType(value="size_t") long l3) {
        long l4 = JEmalloc.nje_aligned_alloc(l2, l3);
        return MemoryUtil.memByteBufferSafe(l4, (int)l3);
    }

    public static long nje_realloc(long l2, long l3) {
        long l4 = Functions.realloc;
        return JNI.invokePPP(l2, l3, l4);
    }

    @Nullable
    @NativeType(value="void *")
    public static ByteBuffer je_realloc(@Nullable @NativeType(value="void *") ByteBuffer byteBuffer, @NativeType(value="size_t") long l2) {
        long l3 = JEmalloc.nje_realloc(MemoryUtil.memAddressSafe(byteBuffer), l2);
        return MemoryUtil.memByteBufferSafe(l3, (int)l2);
    }

    public static void nje_free(long l2) {
        long l3 = Functions.free;
        JNI.invokePV(l2, l3);
    }
    ...
    public static long nje_mallocx(long l2, int n2) {
        long l3 = Functions.mallocx;
        return JNI.invokePP(l2, n2, l3);
    }

    @Nullable
    @NativeType(value="void *")
    public static ByteBuffer je_mallocx(@NativeType(value="size_t") long l2, int n2) {
        long l3 = JEmalloc.nje_mallocx(l2, n2);
        return MemoryUtil.memByteBufferSafe(l3, (int)l2);
    }

    public static long nje_rallocx(long l2, long l3, int n2) {
        long l4 = Functions.rallocx;
        return JNI.invokePPP(l2, l3, n2, l4);
    }

    @Nullable
    @NativeType(value="void *")
    public static ByteBuffer je_rallocx(@Nullable @NativeType(value="void *") ByteBuffer byteBuffer, @NativeType(value="size_t") long l2, int n2) {
        long l3 = JEmalloc.nje_rallocx(MemoryUtil.memAddressSafe(byteBuffer), l2, n2);
        return MemoryUtil.memByteBufferSafe(l3, (int)l2);
    }

    public static long nje_xallocx(long l2, long l3, long l4, int n2) {
        long l5 = Functions.xallocx;
        return JNI.invokePPPP(l2, l3, l4, n2, l5);
    }

    @NativeType(value="size_t")
    public static long je_xallocx(@Nullable @NativeType(value="void *") ByteBuffer byteBuffer, @NativeType(value="size_t") long l2, @NativeType(value="size_t") long l3, int n2) {
        return JEmalloc.nje_xallocx(MemoryUtil.memAddressSafe(byteBuffer), l2, l3, n2);
    }

    public static long nje_sallocx(long l2, int n2) {
        long l3 = Functions.sallocx;
        return JNI.invokePP(l2, n2, l3);
    }

    @NativeType(value="size_t")
    public static long je_sallocx(@NativeType(value="void const *") ByteBuffer byteBuffer, int n2) {
        return JEmalloc.nje_sallocx(MemoryUtil.memAddress(byteBuffer), n2);
    }

    public static void nje_dallocx(long l2, int n2) {
        long l3 = Functions.dallocx;
        JNI.invokePV(l2, n2, l3);
    }

    public static void je_dallocx(@NativeType(value="void *") ByteBuffer byteBuffer, int n2) {
        JEmalloc.nje_dallocx(MemoryUtil.memAddress(byteBuffer), n2);
    }

    public static void je_dallocx(@NativeType(value="void *") ShortBuffer shortBuffer, int n2) {
        JEmalloc.nje_dallocx(MemoryUtil.memAddress(shortBuffer), n2);
    }

    public static void je_dallocx(@NativeType(value="void *") IntBuffer intBuffer, int n2) {
        JEmalloc.nje_dallocx(MemoryUtil.memAddress(intBuffer), n2);
    }

    public static void je_dallocx(@NativeType(value="void *") LongBuffer longBuffer, int n2) {
        JEmalloc.nje_dallocx(MemoryUtil.memAddress(longBuffer), n2);
    }

    public static void je_dallocx(@NativeType(value="void *") FloatBuffer floatBuffer, int n2) {
        JEmalloc.nje_dallocx(MemoryUtil.memAddress(floatBuffer), n2);
    }

    public static void je_dallocx(@NativeType(value="void *") DoubleBuffer doubleBuffer, int n2) {
        JEmalloc.nje_dallocx(MemoryUtil.memAddress(doubleBuffer), n2);
    }

    public static void je_dallocx(@NativeType(value="void *") PointerBuffer pointerBuffer, int n2) {
        JEmalloc.nje_dallocx(MemoryUtil.memAddress(pointerBuffer), n2);
    }

    public static void nje_sdallocx(long l2, long l3, int n2) {
        long l4 = Functions.sdallocx;
        JNI.invokePPV(l2, l3, n2, l4);
    }

    public static void je_sdallocx(@NativeType(value="void *") ByteBuffer byteBuffer, int n2) {
        JEmalloc.nje_sdallocx(MemoryUtil.memAddress(byteBuffer), byteBuffer.remaining(), n2);
    }

    public static void je_sdallocx(@NativeType(value="void *") ShortBuffer shortBuffer, int n2) {
        JEmalloc.nje_sdallocx(MemoryUtil.memAddress(shortBuffer), Integer.toUnsignedLong(shortBuffer.remaining()) << 1, n2);
    }

    public static void je_sdallocx(@NativeType(value="void *") IntBuffer intBuffer, int n2) {
        JEmalloc.nje_sdallocx(MemoryUtil.memAddress(intBuffer), Integer.toUnsignedLong(intBuffer.remaining()) << 2, n2);
    }

    public static void je_sdallocx(@NativeType(value="void *") LongBuffer longBuffer, int n2) {
        JEmalloc.nje_sdallocx(MemoryUtil.memAddress(longBuffer), Integer.toUnsignedLong(longBuffer.remaining()) << 3, n2);
    }

    public static void je_sdallocx(@NativeType(value="void *") FloatBuffer floatBuffer, int n2) {
        JEmalloc.nje_sdallocx(MemoryUtil.memAddress(floatBuffer), Integer.toUnsignedLong(floatBuffer.remaining()) << 2, n2);
    }

    public static void je_sdallocx(@NativeType(value="void *") DoubleBuffer doubleBuffer, int n2) {
        JEmalloc.nje_sdallocx(MemoryUtil.memAddress(doubleBuffer), Integer.toUnsignedLong(doubleBuffer.remaining()) << 3, n2);
    }

    public static void je_sdallocx(@NativeType(value="void *") PointerBuffer pointerBuffer, int n2) {
    ...
    public static long nje_nallocx(long l2, int n2) {
        long l3 = Functions.nallocx;
        return JNI.invokePP(l2, n2, l3);
    }

    @Nullable
    @NativeType(value="void *")
    public static ByteBuffer je_nallocx(@NativeType(value="size_t") long l2, int n2) {
        long l3 = JEmalloc.nje_nallocx(l2, n2);
        return MemoryUtil.memByteBufferSafe(l3, (int)l2);
    }

    public static int nje_mallctl(long l2, long l3, long l4, long l5, long l6) {
        long l7 = Functions.mallctl;
    ...
    public static int je_mallctl(@NativeType(value="char const *") CharSequence charSequence, @Nullable @NativeType(value="void *") ByteBuffer byteBuffer, @Nullable @NativeType(value="size_t *") PointerBuffer pointerBuffer, @Nullable @NativeType(value="void *") ByteBuffer byteBuffer2) {
        ...
        try {
            ...
            int n3 = JEmalloc.nje_mallctl(l2, MemoryUtil.memAddressSafe(byteBuffer), MemoryUtil.memAddressSafe(pointerBuffer), MemoryUtil.memAddressSafe(byteBuffer2), Checks.remainingSafe(byteBuffer2));
            return n3;
        }
        finally {
    ...
    public static int nje_mallctlnametomib(long l2, long l3, long l4) {
        long l5 = Functions.mallctlnametomib;
        return JNI.invokePPPI(l2, l3, l4, l5);
    }
    ...
    public static int je_mallctlnametomib(@NativeType(value="char const *") CharSequence charSequence, @NativeType(value="size_t *") PointerBuffer pointerBuffer, @NativeType(value="size_t *") PointerBuffer pointerBuffer2) {
        ...
        try {
            memoryStack.nASCII(charSequence, true);
            long l2 = memoryStack.getPointerAddress();
            int n3 = JEmalloc.nje_mallctlnametomib(l2, MemoryUtil.memAddress(pointerBuffer), MemoryUtil.memAddress(pointerBuffer2));
            return n3;
        }
        finally {
            memoryStack.setPointer(n2);
    ...
    public static int nje_mallctlbymib(long l2, long l3, long l4, long l5, long l6, long l7) {
        long l8 = Functions.mallctlbymib;
    ...
    public static void nje_malloc_stats_print(long l2, long l3, long l4) {
        long l5 = Functions.malloc_stats_print;
        JNI.invokePPPV(l2, l3, l4, l5);
    }

    public static void je_malloc_stats_print(@Nullable @NativeType(value="void (*) (void *, char const *)") MallocMessageCallbackI mallocMessageCallbackI, @NativeType(value="void *") long l2, @Nullable @NativeType(value="char const *") ByteBuffer byteBuffer) {
        if (Checks.CHECKS) {
     ...
     * WARNING - Removed try catching itself - possible behaviour change.
     */
    public static void je_malloc_stats_print(@Nullable @NativeType(value="void (*) (void *, char const *)") MallocMessageCallbackI mallocMessageCallbackI, @NativeType(value="void *") long l2, @Nullable @NativeType(value="char const *") CharSequence charSequence) {
        MemoryStack memoryStack = MemoryStack.stackGet();
        int n2 = memoryStack.getPointer();
        try {
    ...
    public static long nje_malloc_usable_size(long l2) {
        long l3 = Functions.malloc_usable_size;
        return JNI.invokePP(l2, l3);
    }
