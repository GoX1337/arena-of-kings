...
extends CallbackI {
    ...
    default public void callback(long l2, long l3) {
        boolean bl2 = this.invoke(MemoryUtil.memGetAddress(MemoryUtil.memGetAddress(l3)), MemoryUtil.memGetAddress(MemoryUtil.memGetAddress(l3 + (long)POINTER_SIZE)), MemoryUtil.memGetAddress(MemoryUtil.memGetAddress(l3 + (long)(2 * POINTER_SIZE))), MemoryUtil.memGetAddress(MemoryUtil.memGetAddress(l3 + (long)(3 * POINTER_SIZE))), MemoryUtil.memGetAddress(MemoryUtil.memGetAddress(l3 + (long)(4 * POINTER_SIZE))), MemoryUtil.memGetInt(MemoryUtil.memGetAddress(l3 + (long)(5 * POINTER_SIZE))));
