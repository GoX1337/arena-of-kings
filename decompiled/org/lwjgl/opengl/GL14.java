...
extends GL13 {
    ...
    public static void glFogCoordPointer(@NativeType(value="GLenum") int n2, @NativeType(value="GLsizei") int n3, @NativeType(value="void const *") ByteBuffer byteBuffer) {
        GL14.nglFogCoordPointer(n2, n3, MemoryUtil.memAddress(byteBuffer));
    }

    public static void glFogCoordPointer(@NativeType(value="GLenum") int n2, @NativeType(value="GLsizei") int n3, @NativeType(value="void const *") long l2) {
        GL14.nglFogCoordPointer(n2, n3, l2);
    }

    public static void glFogCoordPointer(@NativeType(value="GLenum") int n2, @NativeType(value="GLsizei") int n3, @NativeType(value="void const *") ShortBuffer shortBuffer) {
        GL14.nglFogCoordPointer(n2, n3, MemoryUtil.memAddress(shortBuffer));
    }

    public static void glFogCoordPointer(@NativeType(value="GLenum") int n2, @NativeType(value="GLsizei") int n3, @NativeType(value="void const *") FloatBuffer floatBuffer) {
        GL14.nglFogCoordPointer(n2, n3, MemoryUtil.memAddress(floatBuffer));
    }

    public static void nglMultiDrawArrays(int n2, long l2, long l3, int n3) {
        GL14C.nglMultiDrawArrays(n2, l2, l3, n3);
    }

    public static void glMultiDrawArrays(@NativeType(value="GLenum") int n2, @NativeType(value="GLint const *") IntBuffer intBuffer, @NativeType(value="GLsizei const *") IntBuffer intBuffer2) {
        GL14C.glMultiDrawArrays(n2, intBuffer, intBuffer2);
    }

    public static void nglMultiDrawElements(int n2, long l2, int n3, long l3, int n4) {
        GL14C.nglMultiDrawElements(n2, l2, n3, l3, n4);
    }

    public static void glMultiDrawElements(@NativeType(value="GLenum") int n2, @NativeType(value="GLsizei *") IntBuffer intBuffer, @NativeType(value="GLenum") int n3, @NativeType(value="void const **") PointerBuffer pointerBuffer) {
        GL14C.glMultiDrawElements(n2, intBuffer, n3, pointerBuffer);
    }

    public static void glPointParameterf(@NativeType(value="GLenum") int n2, @NativeType(value="GLfloat") float f2) {
        GL14C.glPointParameterf(n2, f2);
    }

    public static void glPointParameteri(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3) {
        GL14C.glPointParameteri(n2, n3);
    }

    public static void nglPointParameterfv(int n2, long l2) {
        GL14C.nglPointParameterfv(n2, l2);
    }

    public static void glPointParameterfv(@NativeType(value="GLenum") int n2, @NativeType(value="GLfloat const *") FloatBuffer floatBuffer) {
        GL14C.glPointParameterfv(n2, floatBuffer);
    }

    public static void nglPointParameteriv(int n2, long l2) {
        GL14C.nglPointParameteriv(n2, l2);
    }

    public static void glPointParameteriv(@NativeType(value="GLenum") int n2, @NativeType(value="GLint const *") IntBuffer intBuffer) {
        GL14C.glPointParameteriv(n2, intBuffer);
    }
    ...
    public static void glSecondaryColorPointer(@NativeType(value="GLint") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLsizei") int n4, @NativeType(value="void const *") ByteBuffer byteBuffer) {
        GL14.nglSecondaryColorPointer(n2, n3, n4, MemoryUtil.memAddress(byteBuffer));
    }

    public static void glSecondaryColorPointer(@NativeType(value="GLint") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLsizei") int n4, @NativeType(value="void const *") long l2) {
        GL14.nglSecondaryColorPointer(n2, n3, n4, l2);
    }

    public static void glSecondaryColorPointer(@NativeType(value="GLint") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLsizei") int n4, @NativeType(value="void const *") ShortBuffer shortBuffer) {
        GL14.nglSecondaryColorPointer(n2, n3, n4, MemoryUtil.memAddress(shortBuffer));
    }

    public static void glSecondaryColorPointer(@NativeType(value="GLint") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLsizei") int n4, @NativeType(value="void const *") IntBuffer intBuffer) {
        GL14.nglSecondaryColorPointer(n2, n3, n4, MemoryUtil.memAddress(intBuffer));
    }

    public static void glSecondaryColorPointer(@NativeType(value="GLint") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLsizei") int n4, @NativeType(value="void const *") FloatBuffer floatBuffer) {
        GL14.nglSecondaryColorPointer(n2, n3, n4, MemoryUtil.memAddress(floatBuffer));
    }

    public static void glBlendFuncSeparate(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLenum") int n4, @NativeType(value="GLenum") int n5) {
        GL14C.glBlendFuncSeparate(n2, n3, n4, n5);
    }
    ...
    public static void glFogCoordfv(@NativeType(value="GLfloat const *") float[] fArray) {
        long l2 = GL.getICD().glFogCoordfv;
        if (Checks.CHECKS) {
            Checks.check(l2);
    ...
    public static void glFogCoorddv(@NativeType(value="GLdouble const *") double[] dArray) {
        long l2 = GL.getICD().glFogCoorddv;
        if (Checks.CHECKS) {
            Checks.check(l2);
    ...
    public static void glMultiDrawArrays(@NativeType(value="GLenum") int n2, @NativeType(value="GLint const *") int[] nArray, @NativeType(value="GLsizei const *") int[] nArray2) {
        GL14C.glMultiDrawArrays(n2, nArray, nArray2);
    }

    public static void glMultiDrawElements(@NativeType(value="GLenum") int n2, @NativeType(value="GLsizei *") int[] nArray, @NativeType(value="GLenum") int n3, @NativeType(value="void const **") PointerBuffer pointerBuffer) {
        GL14C.glMultiDrawElements(n2, nArray, n3, pointerBuffer);
    }

    public static void glPointParameterfv(@NativeType(value="GLenum") int n2, @NativeType(value="GLfloat const *") float[] fArray) {
        GL14C.glPointParameterfv(n2, fArray);
    }

    public static void glPointParameteriv(@NativeType(value="GLenum") int n2, @NativeType(value="GLint const *") int[] nArray) {
        GL14C.glPointParameteriv(n2, nArray);
    }

    public static void glSecondaryColor3sv(@NativeType(value="GLshort const *") short[] sArray) {
        long l2 = GL.getICD().glSecondaryColor3sv;
        if (Checks.CHECKS) {
            Checks.check(l2);
    ...
    public static void glSecondaryColor3iv(@NativeType(value="GLint const *") int[] nArray) {
        long l2 = GL.getICD().glSecondaryColor3iv;
        if (Checks.CHECKS) {
            Checks.check(l2);
    ...
    public static void glSecondaryColor3fv(@NativeType(value="GLfloat const *") float[] fArray) {
        long l2 = GL.getICD().glSecondaryColor3fv;
        if (Checks.CHECKS) {
            Checks.check(l2);
    ...
    public static void glSecondaryColor3dv(@NativeType(value="GLdouble const *") double[] dArray) {
        long l2 = GL.getICD().glSecondaryColor3dv;
        if (Checks.CHECKS) {
            Checks.check(l2);
    ...
    public static void glSecondaryColor3usv(@NativeType(value="GLushort const *") short[] sArray) {
        long l2 = GL.getICD().glSecondaryColor3usv;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(sArray, 3);
        }
    ...
    public static void glSecondaryColor3uiv(@NativeType(value="GLuint const *") int[] nArray) {
        long l2 = GL.getICD().glSecondaryColor3uiv;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(nArray, 3);
        }
    ...
    public static void glWindowPos2iv(@NativeType(value="GLint const *") int[] nArray) {
        long l2 = GL.getICD().glWindowPos2iv;
        if (Checks.CHECKS) {
            Checks.check(l2);
    ...
    public static void glWindowPos2sv(@NativeType(value="GLshort const *") short[] sArray) {
        long l2 = GL.getICD().glWindowPos2sv;
        if (Checks.CHECKS) {
            Checks.check(l2);
    ...
    public static void glWindowPos2fv(@NativeType(value="GLfloat const *") float[] fArray) {
        long l2 = GL.getICD().glWindowPos2fv;
        if (Checks.CHECKS) {
            Checks.check(l2);
    ...
    public static void glWindowPos2dv(@NativeType(value="GLdouble const *") double[] dArray) {
        long l2 = GL.getICD().glWindowPos2dv;
        if (Checks.CHECKS) {
            Checks.check(l2);
    ...
    public static void glWindowPos3iv(@NativeType(value="GLint const *") int[] nArray) {
        long l2 = GL.getICD().glWindowPos3iv;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(nArray, 3);
        }
    ...
    public static void glWindowPos3sv(@NativeType(value="GLshort const *") short[] sArray) {
        long l2 = GL.getICD().glWindowPos3sv;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(sArray, 3);
        }
    ...
    public static void glWindowPos3fv(@NativeType(value="GLfloat const *") float[] fArray) {
        long l2 = GL.getICD().glWindowPos3fv;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(fArray, 3);
        }
    ...
    public static void glWindowPos3dv(@NativeType(value="GLdouble const *") double[] dArray) {
        long l2 = GL.getICD().glWindowPos3dv;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(dArray, 3);
        }
