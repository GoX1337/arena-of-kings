...
public class NVExplicitMultisample {
    ...
    public static void glGetMultisamplefvNV(@NativeType(value="GLenum") int n2, @NativeType(value="GLuint") int n3, @NativeType(value="GLfloat *") FloatBuffer floatBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)floatBuffer, 2);
        }
        NVExplicitMultisample.nglGetMultisamplefvNV(n2, n3, MemoryUtil.memAddress(floatBuffer));
    }
    ...
    public static void glGetMultisamplefvNV(@NativeType(value="GLenum") int n2, @NativeType(value="GLuint") int n3, @NativeType(value="GLfloat *") float[] fArray) {
        long l2 = GL.getICD().glGetMultisamplefvNV;
        if (Checks.CHECKS) {
            Checks.check(l2);
