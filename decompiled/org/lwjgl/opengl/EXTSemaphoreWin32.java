...
public class EXTSemaphoreWin32 {
    ...
    public static void glImportSemaphoreWin32HandleEXT(@NativeType(value="GLuint") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="void *") long l2) {
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        EXTSemaphoreWin32.nglImportSemaphoreWin32HandleEXT(n2, n3, l2);
    }

    public static native void nglImportSemaphoreWin32NameEXT(int var0, int var1, long var2);

    public static void glImportSemaphoreWin32NameEXT(@NativeType(value="GLuint") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="void const *") long l2) {
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        EXTSemaphoreWin32.nglImportSemaphoreWin32NameEXT(n2, n3, l2);
    }
