...
public class WGLARBRenderTexture {
    ...
    public static boolean wglBindTexImageARB(@NativeType(value="HPBUFFERARB") long l2, int n2) {
        long l3 = GL.getCapabilitiesWGL().wglBindTexImageARB;
        if (Checks.CHECKS) {
            Checks.check(l3);
            Checks.check(l2);
        }
    ...
    @NativeType(value="BOOL")
    public static boolean wglReleaseTexImageARB(@NativeType(value="HPBUFFERARB") long l2, int n2) {
        long l3 = GL.getCapabilitiesWGL().wglReleaseTexImageARB;
        if (Checks.CHECKS) {
            Checks.check(l3);
            Checks.check(l2);
        }
    ...
    public static int nwglSetPbufferAttribARB(long l2, long l3) {
        long l4 = GL.getCapabilitiesWGL().wglSetPbufferAttribARB;
        if (Checks.CHECKS) {
            Checks.check(l4);
            Checks.check(l2);
        }
    ...
    @NativeType(value="BOOL")
    public static boolean wglSetPbufferAttribARB(@NativeType(value="HPBUFFERARB") long l2, @Nullable @NativeType(value="int const *") IntBuffer intBuffer) {
        if (Checks.CHECKS) {
            Checks.checkNTSafe(intBuffer);
        }
        return WGLARBRenderTexture.nwglSetPbufferAttribARB(l2, MemoryUtil.memAddressSafe(intBuffer)) != 0;
    }

    @NativeType(value="BOOL")
    public static boolean wglSetPbufferAttribARB(@NativeType(value="HPBUFFERARB") long l2, @Nullable @NativeType(value="int const *") int[] nArray) {
