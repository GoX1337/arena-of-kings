...
public class NVFence {
     ...
     */
    public static void glDeleteFencesNV(@NativeType(value="GLuint const *") int n2) {
    ...
    public static void glGetFenceivNV(@NativeType(value="GLuint") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLint *") IntBuffer intBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)intBuffer, 1);
        }
        NVFence.nglGetFenceivNV(n2, n3, MemoryUtil.memAddress(intBuffer));
    }
     ...
     */
    @NativeType(value="void")
    public static int glGetFenceiNV(@NativeType(value="GLuint") int n2, @NativeType(value="GLenum") int n3) {
        MemoryStack memoryStack = MemoryStack.stackGet();
    ...
    public static void glDeleteFencesNV(@NativeType(value="GLuint const *") int[] nArray) {
        long l2 = GL.getICD().glDeleteFencesNV;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
    ...
    public static void glGenFencesNV(@NativeType(value="GLuint *") int[] nArray) {
        long l2 = GL.getICD().glGenFencesNV;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        JNI.callPV(nArray.length, nArray, l2);
    ...
    public static void glGetFenceivNV(@NativeType(value="GLuint") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLint *") int[] nArray) {
        long l2 = GL.getICD().glGetFenceivNV;
        if (Checks.CHECKS) {
            Checks.check(l2);
