...
extends GL41C {
    ...
    public static void glGetActiveAtomicCounterBufferiv(@NativeType(value="GLuint") int n2, @NativeType(value="GLuint") int n3, @NativeType(value="GLenum") int n4, @NativeType(value="GLint *") IntBuffer intBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)intBuffer, 1);
        }
        GL42C.nglGetActiveAtomicCounterBufferiv(n2, n3, n4, MemoryUtil.memAddress(intBuffer));
    }
    ...
    public static int glGetActiveAtomicCounterBufferi(@NativeType(value="GLuint") int n2, @NativeType(value="GLuint") int n3, @NativeType(value="GLenum") int n4) {
    ...
    public static void glDrawElementsInstancedBaseInstance(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="void const *") ByteBuffer byteBuffer, @NativeType(value="GLsizei") int n4, @NativeType(value="GLuint") int n5) {
        GL42C.nglDrawElementsInstancedBaseInstance(n2, byteBuffer.remaining() >> GLChecks.typeToByteShift(n3), n3, MemoryUtil.memAddress(byteBuffer), n4, n5);
    }
    ...
    public static void glDrawElementsInstancedBaseInstance(@NativeType(value="GLenum") int n2, @NativeType(value="void const *") ByteBuffer byteBuffer, @NativeType(value="GLsizei") int n3, @NativeType(value="GLuint") int n4) {
        GL42C.nglDrawElementsInstancedBaseInstance(n2, byteBuffer.remaining(), 5121, MemoryUtil.memAddress(byteBuffer), n3, n4);
    }
    ...
    public static void glDrawElementsInstancedBaseInstance(@NativeType(value="GLenum") int n2, @NativeType(value="void const *") ShortBuffer shortBuffer, @NativeType(value="GLsizei") int n3, @NativeType(value="GLuint") int n4) {
        GL42C.nglDrawElementsInstancedBaseInstance(n2, shortBuffer.remaining(), 5123, MemoryUtil.memAddress(shortBuffer), n3, n4);
    }
    ...
    public static void glDrawElementsInstancedBaseInstance(@NativeType(value="GLenum") int n2, @NativeType(value="void const *") IntBuffer intBuffer, @NativeType(value="GLsizei") int n3, @NativeType(value="GLuint") int n4) {
        GL42C.nglDrawElementsInstancedBaseInstance(n2, intBuffer.remaining(), 5125, MemoryUtil.memAddress(intBuffer), n3, n4);
    }
    ...
    public static void glDrawElementsInstancedBaseVertexBaseInstance(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="void const *") ByteBuffer byteBuffer, @NativeType(value="GLsizei") int n4, @NativeType(value="GLint") int n5, @NativeType(value="GLuint") int n6) {
        GL42C.nglDrawElementsInstancedBaseVertexBaseInstance(n2, byteBuffer.remaining() >> GLChecks.typeToByteShift(n3), n3, MemoryUtil.memAddress(byteBuffer), n4, n5, n6);
    }
    ...
    public static void glDrawElementsInstancedBaseVertexBaseInstance(@NativeType(value="GLenum") int n2, @NativeType(value="void const *") ByteBuffer byteBuffer, @NativeType(value="GLsizei") int n3, @NativeType(value="GLint") int n4, @NativeType(value="GLuint") int n5) {
        GL42C.nglDrawElementsInstancedBaseVertexBaseInstance(n2, byteBuffer.remaining(), 5121, MemoryUtil.memAddress(byteBuffer), n3, n4, n5);
    }
    ...
    public static void glDrawElementsInstancedBaseVertexBaseInstance(@NativeType(value="GLenum") int n2, @NativeType(value="void const *") ShortBuffer shortBuffer, @NativeType(value="GLsizei") int n3, @NativeType(value="GLint") int n4, @NativeType(value="GLuint") int n5) {
        GL42C.nglDrawElementsInstancedBaseVertexBaseInstance(n2, shortBuffer.remaining(), 5123, MemoryUtil.memAddress(shortBuffer), n3, n4, n5);
    }
    ...
    public static void glDrawElementsInstancedBaseVertexBaseInstance(@NativeType(value="GLenum") int n2, @NativeType(value="void const *") IntBuffer intBuffer, @NativeType(value="GLsizei") int n3, @NativeType(value="GLint") int n4, @NativeType(value="GLuint") int n5) {
        GL42C.nglDrawElementsInstancedBaseVertexBaseInstance(n2, intBuffer.remaining(), 5125, MemoryUtil.memAddress(intBuffer), n3, n4, n5);
    }
    ...
    public static void glGetInternalformativ(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLenum") int n4, @NativeType(value="GLint *") IntBuffer intBuffer) {
        GL42C.nglGetInternalformativ(n2, n3, n4, intBuffer.remaining(), MemoryUtil.memAddress(intBuffer));
    }
    ...
    public static int glGetInternalformati(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLenum") int n4) {
        ...
        try {
            IntBuffer intBuffer = memoryStack.callocInt(1);
            GL42C.nglGetInternalformativ(n2, n3, n4, 1, MemoryUtil.memAddress(intBuffer));
            int n6 = intBuffer.get(0);
            return n6;
        }
        finally {
    ...
    public static void glGetActiveAtomicCounterBufferiv(@NativeType(value="GLuint") int n2, @NativeType(value="GLuint") int n3, @NativeType(value="GLenum") int n4, @NativeType(value="GLint *") int[] nArray) {
        long l2 = GL.getICD().glGetActiveAtomicCounterBufferiv;
        if (Checks.CHECKS) {
            Checks.check(l2);
    ...
    public static void glGetInternalformativ(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLenum") int n4, @NativeType(value="GLint *") int[] nArray) {
        long l2 = GL.getICD().glGetInternalformativ;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        JNI.callPV(n2, n3, n4, nArray.length, nArray, l2);
    }
