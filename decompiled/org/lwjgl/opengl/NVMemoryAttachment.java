...
public class NVMemoryAttachment {
    ...
    public static void glGetMemoryObjectDetachedResourcesuivNV(@NativeType(value="GLuint") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLint") int n4, @NativeType(value="GLuint *") IntBuffer intBuffer) {
        NVMemoryAttachment.nglGetMemoryObjectDetachedResourcesuivNV(n2, n3, n4, intBuffer.remaining(), MemoryUtil.memAddress(intBuffer));
    }
    ...
    public static void glGetMemoryObjectDetachedResourcesuivNV(@NativeType(value="GLuint") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLint") int n4, @NativeType(value="GLuint *") int[] nArray) {
        long l2 = GL.getICD().glGetMemoryObjectDetachedResourcesuivNV;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
