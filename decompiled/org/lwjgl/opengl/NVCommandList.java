...
public class NVCommandList {
     ...
     * WARNING - Removed try catching itself - possible behaviour change.
     */
    public static void glDeleteStatesNV(@NativeType(value="GLuint const *") int n2) {
        MemoryStack memoryStack = MemoryStack.stackGet();
    ...
    public static void glDrawCommandsNV(@NativeType(value="GLenum") int n2, @NativeType(value="GLuint") int n3, @NativeType(value="GLintptr const *") PointerBuffer pointerBuffer, @NativeType(value="GLsizei const *") IntBuffer intBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)intBuffer, pointerBuffer.remaining());
        }
        NVCommandList.nglDrawCommandsNV(n2, n3, MemoryUtil.memAddress(pointerBuffer), MemoryUtil.memAddress(intBuffer), pointerBuffer.remaining());
    }

    public static native void nglDrawCommandsAddressNV(int var0, long var1, long var3, int var5);

    public static void glDrawCommandsAddressNV(@NativeType(value="GLenum") int n2, @NativeType(value="GLuint64 const *") LongBuffer longBuffer, @NativeType(value="GLsizei const *") IntBuffer intBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)intBuffer, longBuffer.remaining());
        }
        NVCommandList.nglDrawCommandsAddressNV(n2, MemoryUtil.memAddress(longBuffer), MemoryUtil.memAddress(intBuffer), longBuffer.remaining());
    }

    public static native void nglDrawCommandsStatesNV(int var0, long var1, long var3, long var5, long var7, int var9);

    public static void glDrawCommandsStatesNV(@NativeType(value="GLuint") int n2, @NativeType(value="GLintptr const *") PointerBuffer pointerBuffer, @NativeType(value="GLsizei const *") IntBuffer intBuffer, @NativeType(value="GLuint const *") IntBuffer intBuffer2, @NativeType(value="GLuint const *") IntBuffer intBuffer3) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)intBuffer, pointerBuffer.remaining());
            Checks.check((Buffer)intBuffer2, pointerBuffer.remaining());
            Checks.check((Buffer)intBuffer3, pointerBuffer.remaining());
        }
        NVCommandList.nglDrawCommandsStatesNV(n2, MemoryUtil.memAddress(pointerBuffer), MemoryUtil.memAddress(intBuffer), MemoryUtil.memAddress(intBuffer2), MemoryUtil.memAddress(intBuffer3), pointerBuffer.remaining());
    }
     ...
     * WARNING - Removed try catching itself - possible behaviour change.
     */
    public static void glDeleteCommandListsNV(@NativeType(value="GLuint const *") int n2) {
        MemoryStack memoryStack = MemoryStack.stackGet();
        int n3 = memoryStack.getPointer();
        try {
            IntBuffer intBuffer = memoryStack.ints(n2);
    ...
    public static void glListDrawCommandsStatesClientNV(@NativeType(value="GLuint") int n2, @NativeType(value="GLuint") int n3, @NativeType(value="void const **") PointerBuffer pointerBuffer, @NativeType(value="GLsizei const *") IntBuffer intBuffer, @NativeType(value="GLuint const *") IntBuffer intBuffer2, @NativeType(value="GLuint const *") IntBuffer intBuffer3) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)intBuffer, pointerBuffer.remaining());
            Checks.check((Buffer)intBuffer2, pointerBuffer.remaining());
            Checks.check((Buffer)intBuffer3, pointerBuffer.remaining());
        }
        NVCommandList.nglListDrawCommandsStatesClientNV(n2, n3, MemoryUtil.memAddress(pointerBuffer), MemoryUtil.memAddress(intBuffer), MemoryUtil.memAddress(intBuffer2), MemoryUtil.memAddress(intBuffer3), pointerBuffer.remaining());
    }
    ...
    public static void glCreateStatesNV(@NativeType(value="GLuint *") int[] nArray) {
        long l2 = GL.getICD().glCreateStatesNV;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
    ...
    public static void glDeleteStatesNV(@NativeType(value="GLuint const *") int[] nArray) {
        long l2 = GL.getICD().glDeleteStatesNV;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        JNI.callPV(nArray.length, nArray, l2);
    ...
    public static void glDrawCommandsNV(@NativeType(value="GLenum") int n2, @NativeType(value="GLuint") int n3, @NativeType(value="GLintptr const *") PointerBuffer pointerBuffer, @NativeType(value="GLsizei const *") int[] nArray) {
        long l2 = GL.getICD().glDrawCommandsNV;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(nArray, pointerBuffer.remaining());
        }
        JNI.callPPV(n2, n3, MemoryUtil.memAddress(pointerBuffer), nArray, pointerBuffer.remaining(), l2);
    }

    public static void glDrawCommandsAddressNV(@NativeType(value="GLenum") int n2, @NativeType(value="GLuint64 const *") long[] lArray, @NativeType(value="GLsizei const *") int[] nArray) {
        long l2 = GL.getICD().glDrawCommandsAddressNV;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(nArray, lArray.length);
        }
        JNI.callPPV(n2, lArray, nArray, lArray.length, l2);
    }

    public static void glDrawCommandsStatesNV(@NativeType(value="GLuint") int n2, @NativeType(value="GLintptr const *") PointerBuffer pointerBuffer, @NativeType(value="GLsizei const *") int[] nArray, @NativeType(value="GLuint const *") int[] nArray2, @NativeType(value="GLuint const *") int[] nArray3) {
        long l2 = GL.getICD().glDrawCommandsStatesNV;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(nArray, pointerBuffer.remaining());
        ...
        JNI.callPPPPV(n2, MemoryUtil.memAddress(pointerBuffer), nArray, nArray2, nArray3, pointerBuffer.remaining(), l2);
    }
    ...
    public static void glDrawCommandsStatesAddressNV(@NativeType(value="GLuint64 const *") long[] lArray, @NativeType(value="GLsizei const *") int[] nArray, @NativeType(value="GLuint const *") int[] nArray2, @NativeType(value="GLuint const *") int[] nArray3) {
        long l2 = GL.getICD().glDrawCommandsStatesAddressNV;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(nArray, lArray.length);
        ...
        JNI.callPPPPV(lArray, nArray, nArray2, nArray3, lArray.length, l2);
    }

    public static void glCreateCommandListsNV(@NativeType(value="GLuint *") int[] nArray) {
        long l2 = GL.getICD().glCreateCommandListsNV;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        JNI.callPV(nArray.length, nArray, l2);
    ...
    public static void glDeleteCommandListsNV(@NativeType(value="GLuint const *") int[] nArray) {
        long l2 = GL.getICD().glDeleteCommandListsNV;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        JNI.callPV(nArray.length, nArray, l2);
    ...
    public static void glListDrawCommandsStatesClientNV(@NativeType(value="GLuint") int n2, @NativeType(value="GLuint") int n3, @NativeType(value="void const **") PointerBuffer pointerBuffer, @NativeType(value="GLsizei const *") int[] nArray, @NativeType(value="GLuint const *") int[] nArray2, @NativeType(value="GLuint const *") int[] nArray3) {
        long l2 = GL.getICD().glListDrawCommandsStatesClientNV;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(nArray, pointerBuffer.remaining());
            Checks.check(nArray2, pointerBuffer.remaining());
        ...
        JNI.callPPPPV(n2, n3, MemoryUtil.memAddress(pointerBuffer), nArray, nArray2, nArray3, pointerBuffer.remaining(), l2);
    }
