...
extends GL41 {
    ...
    public static void nglGetActiveAtomicCounterBufferiv(int n2, int n3, int n4, long l2) {
        GL42C.nglGetActiveAtomicCounterBufferiv(n2, n3, n4, l2);
    }
    ...
    public static void glGetActiveAtomicCounterBufferiv(@NativeType(value="GLuint") int n2, @NativeType(value="GLuint") int n3, @NativeType(value="GLenum") int n4, @NativeType(value="GLint *") IntBuffer intBuffer) {
        GL42C.glGetActiveAtomicCounterBufferiv(n2, n3, n4, intBuffer);
    }
    ...
    public static int glGetActiveAtomicCounterBufferi(@NativeType(value="GLuint") int n2, @NativeType(value="GLuint") int n3, @NativeType(value="GLenum") int n4) {
        return GL42C.glGetActiveAtomicCounterBufferi(n2, n3, n4);
    }
    ...
    public static void glBindImageTexture(@NativeType(value="GLuint") int n2, @NativeType(value="GLuint") int n3, @NativeType(value="GLint") int n4, @NativeType(value="GLboolean") boolean bl2, @NativeType(value="GLint") int n5, @NativeType(value="GLenum") int n6, @NativeType(value="GLenum") int n7) {
        GL42C.glBindImageTexture(n2, n3, n4, bl2, n5, n6, n7);
    }

    public static void glMemoryBarrier(@NativeType(value="GLbitfield") int n2) {
        GL42C.glMemoryBarrier(n2);
    }
    ...
    public static void glGetActiveAtomicCounterBufferiv(@NativeType(value="GLuint") int n2, @NativeType(value="GLuint") int n3, @NativeType(value="GLenum") int n4, @NativeType(value="GLint *") int[] nArray) {
        GL42C.glGetActiveAtomicCounterBufferiv(n2, n3, n4, nArray);
    }
