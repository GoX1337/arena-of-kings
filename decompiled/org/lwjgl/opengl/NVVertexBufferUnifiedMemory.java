...
public class NVVertexBufferUnifiedMemory {
    ...
    public static void glGetIntegerui64i_vNV(@NativeType(value="GLenum") int n2, @NativeType(value="GLuint") int n3, @NativeType(value="GLuint64EXT *") LongBuffer longBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)longBuffer, 1);
        }
        NVVertexBufferUnifiedMemory.nglGetIntegerui64i_vNV(n2, n3, MemoryUtil.memAddress(longBuffer));
    }
    ...
    public static long glGetIntegerui64iNV(@NativeType(value="GLenum") int n2, @NativeType(value="GLuint") int n3) {
    ...
    public static void glGetIntegerui64i_vNV(@NativeType(value="GLenum") int n2, @NativeType(value="GLuint") int n3, @NativeType(value="GLuint64EXT *") long[] lArray) {
        long l2 = GL.getICD().glGetIntegerui64i_vNV;
        if (Checks.CHECKS) {
            Checks.check(l2);
