...
public class EXTGeometryShader4 {
    ...
    public static void glFramebufferTextureLayerEXT(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLuint") int n4, @NativeType(value="GLint") int n5, @NativeType(value="GLint") int n6) {
        EXTTextureArray.glFramebufferTextureLayerEXT(n2, n3, n4, n5, n6);
    }
