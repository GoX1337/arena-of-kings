...
public class AMDDebugOutput {
    ...
    public static void glDebugMessageEnableAMD(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @Nullable @NativeType(value="GLuint const *") IntBuffer intBuffer, @NativeType(value="GLboolean") boolean bl2) {
        AMDDebugOutput.nglDebugMessageEnableAMD(n2, n3, Checks.remainingSafe(intBuffer), MemoryUtil.memAddressSafe(intBuffer), bl2);
    }

    /*
     * WARNING - Removed try catching itself - possible behaviour change.
     */
    public static void glDebugMessageEnableAMD(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLuint const *") int n4, @NativeType(value="GLboolean") boolean bl2) {
        MemoryStack memoryStack = MemoryStack.stackGet();
        int n5 = memoryStack.getPointer();
        try {
            IntBuffer intBuffer = memoryStack.ints(n4);
            AMDDebugOutput.nglDebugMessageEnableAMD(n2, n3, 1, MemoryUtil.memAddress(intBuffer), bl2);
        }
        finally {
    ...
    public static void glDebugMessageCallbackAMD(@Nullable @NativeType(value="GLDEBUGPROCAMD") GLDebugMessageAMDCallbackI gLDebugMessageAMDCallbackI, @NativeType(value="void *") long l2) {
    ...
    public static void glDebugMessageEnableAMD(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @Nullable @NativeType(value="GLuint const *") int[] nArray, @NativeType(value="GLboolean") boolean bl2) {
        long l2 = GL.getICD().glDebugMessageEnableAMD;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        JNI.callPV(n2, n3, Checks.lengthSafe(nArray), nArray, bl2, l2);
    }

    @NativeType(value="GLuint")
    public static int glGetDebugMessageLogAMD(@NativeType(value="GLuint") int n2, @Nullable @NativeType(value="GLenum *") int[] nArray, @Nullable @NativeType(value="GLuint *") int[] nArray2, @Nullable @NativeType(value="GLuint *") int[] nArray3, @Nullable @NativeType(value="GLsizei *") int[] nArray4, @Nullable @NativeType(value="GLchar *") ByteBuffer byteBuffer) {
