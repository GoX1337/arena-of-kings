...
public class NVShadingRateImage {
    ...
    public static void glShadingRateImagePaletteNV(@NativeType(value="GLuint") int n2, @NativeType(value="GLuint") int n3, @NativeType(value="GLenum const *") IntBuffer intBuffer) {
        NVShadingRateImage.nglShadingRateImagePaletteNV(n2, n3, intBuffer.remaining(), MemoryUtil.memAddress(intBuffer));
    }

    public static native void nglGetShadingRateImagePaletteNV(int var0, int var1, long var2);

    public static void glGetShadingRateImagePaletteNV(@NativeType(value="GLuint") int n2, @NativeType(value="GLuint") int n3, @NativeType(value="GLenum *") IntBuffer intBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)intBuffer, 1);
        }
        NVShadingRateImage.nglGetShadingRateImagePaletteNV(n2, n3, MemoryUtil.memAddress(intBuffer));
    }
    ...
    public static void glShadingRateSampleOrderCustomNV(@NativeType(value="GLenum") int n2, @NativeType(value="GLuint") int n3, @NativeType(value="GLint const *") IntBuffer intBuffer) {
        NVShadingRateImage.nglShadingRateSampleOrderCustomNV(n2, n3, MemoryUtil.memAddress(intBuffer));
    }

    public static native void nglGetShadingRateSampleLocationivNV(int var0, int var1, int var2, long var3);

    public static void glGetShadingRateSampleLocationivNV(@NativeType(value="GLenum") int n2, @NativeType(value="GLuint") int n3, @NativeType(value="GLuint") int n4, @NativeType(value="GLint *") IntBuffer intBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)intBuffer, 3);
        }
        NVShadingRateImage.nglGetShadingRateSampleLocationivNV(n2, n3, n4, MemoryUtil.memAddress(intBuffer));
    }

    public static void glShadingRateImagePaletteNV(@NativeType(value="GLuint") int n2, @NativeType(value="GLuint") int n3, @NativeType(value="GLenum const *") int[] nArray) {
        long l2 = GL.getICD().glShadingRateImagePaletteNV;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
    ...
    public static void glGetShadingRateImagePaletteNV(@NativeType(value="GLuint") int n2, @NativeType(value="GLuint") int n3, @NativeType(value="GLenum *") int[] nArray) {
        long l2 = GL.getICD().glGetShadingRateImagePaletteNV;
        if (Checks.CHECKS) {
            Checks.check(l2);
    ...
    public static void glShadingRateSampleOrderCustomNV(@NativeType(value="GLenum") int n2, @NativeType(value="GLuint") int n3, @NativeType(value="GLint const *") int[] nArray) {
        long l2 = GL.getICD().glShadingRateSampleOrderCustomNV;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        JNI.callPV(n2, n3, nArray, l2);
    ...
    public static void glGetShadingRateSampleLocationivNV(@NativeType(value="GLenum") int n2, @NativeType(value="GLuint") int n3, @NativeType(value="GLuint") int n4, @NativeType(value="GLint *") int[] nArray) {
        long l2 = GL.getICD().glGetShadingRateSampleLocationivNV;
        if (Checks.CHECKS) {
            Checks.check(l2);
