...
implements NativeResource {
    ...
    public static Buffer malloc(int n2) {
        return GPU_DEVICE.wrap(Buffer.class, MemoryUtil.nmemAllocChecked(GPU_DEVICE.__checkMalloc(n2, SIZEOF)), n2);
    }

    public static Buffer calloc(int n2) {
        return GPU_DEVICE.wrap(Buffer.class, MemoryUtil.nmemCallocChecked(n2, SIZEOF), n2);
    }

    public static Buffer create(int n2) {
        ByteBuffer byteBuffer = GPU_DEVICE.__create(n2, SIZEOF);
        return GPU_DEVICE.wrap(Buffer.class, MemoryUtil.memAddress(byteBuffer), n2, byteBuffer);
    }

    public static Buffer create(long l2, int n2) {
        return GPU_DEVICE.wrap(Buffer.class, l2, n2);
    }

    @Nullable
    public static Buffer createSafe(long l2, int n2) {
        return l2 == 0L ? null : GPU_DEVICE.wrap(Buffer.class, l2, n2);
    }
    ...
    public static Buffer malloc(int n2, MemoryStack memoryStack) {
        return GPU_DEVICE.wrap(Buffer.class, memoryStack.nmalloc(ALIGNOF, n2 * SIZEOF), n2);
    }

    public static Buffer calloc(int n2, MemoryStack memoryStack) {
        return GPU_DEVICE.wrap(Buffer.class, memoryStack.ncalloc(ALIGNOF, n2, SIZEOF), n2);
    }
