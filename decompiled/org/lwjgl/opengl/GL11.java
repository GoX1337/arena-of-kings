...
public class GL11 {
    ...
    public static void glEnable(@NativeType(value="GLenum") int n2) {
        GL11C.glEnable(n2);
    }

    public static void glDisable(@NativeType(value="GLenum") int n2) {
        GL11C.glDisable(n2);
    }
     ...
     */
    @NativeType(value="GLboolean")
    public static boolean glAreTexturesResident(@NativeType(value="GLuint const *") int n2, @NativeType(value="GLboolean *") ByteBuffer byteBuffer) {
        if (Checks.CHECKS) {
        ...
        try {
            ...
            boolean bl2 = GL11.nglAreTexturesResident(1, MemoryUtil.memAddress(intBuffer), MemoryUtil.memAddress(byteBuffer));
            return bl2;
        }
        finally {
    ...
    public static void glBindTexture(@NativeType(value="GLenum") int n2, @NativeType(value="GLuint") int n3) {
        GL11C.glBindTexture(n2, n3);
    }

    public static native void nglBitmap(int var0, int var1, float var2, float var3, float var4, float var5, long var6);

    public static void glBitmap(@NativeType(value="GLsizei") int n2, @NativeType(value="GLsizei") int n3, @NativeType(value="GLfloat") float f2, @NativeType(value="GLfloat") float f3, @NativeType(value="GLfloat") float f4, @NativeType(value="GLfloat") float f5, @Nullable @NativeType(value="GLubyte const *") ByteBuffer byteBuffer) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)byteBuffer, (n2 + 7 >> 3) * n3);
        }
        GL11.nglBitmap(n2, n3, f2, f3, f4, f5, MemoryUtil.memAddressSafe(byteBuffer));
    }

    public static void glBitmap(@NativeType(value="GLsizei") int n2, @NativeType(value="GLsizei") int n3, @NativeType(value="GLfloat") float f2, @NativeType(value="GLfloat") float f3, @NativeType(value="GLfloat") float f4, @NativeType(value="GLfloat") float f5, @Nullable @NativeType(value="GLubyte const *") long l2) {
        GL11.nglBitmap(n2, n3, f2, f3, f4, f5, l2);
    }

    public static void glBlendFunc(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3) {
        GL11C.glBlendFunc(n2, n3);
    }
    ...
    public static void glCallLists(@NativeType(value="GLenum") int n2, @NativeType(value="void const *") ByteBuffer byteBuffer) {
        GL11.nglCallLists(byteBuffer.remaining() / GLChecks.typeToBytes(n2), n2, MemoryUtil.memAddress(byteBuffer));
    }
    ...
    public static void glClear(@NativeType(value="GLbitfield") int n2) {
        GL11C.glClear(n2);
    }
    ...
    public static void glClearColor(@NativeType(value="GLfloat") float f2, @NativeType(value="GLfloat") float f3, @NativeType(value="GLfloat") float f4, @NativeType(value="GLfloat") float f5) {
        GL11C.glClearColor(f2, f3, f4, f5);
    }

    public static void glClearDepth(@NativeType(value="GLdouble") double d2) {
        GL11C.glClearDepth(d2);
    }

    public static native void glClearIndex(@NativeType(value="GLfloat") float var0);

    public static void glClearStencil(@NativeType(value="GLint") int n2) {
        GL11C.glClearStencil(n2);
    }

    public static native void nglClipPlane(int var0, long var1);

    public static void glClipPlane(@NativeType(value="GLenum") int n2, @NativeType(value="GLdouble const *") DoubleBuffer doubleBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)doubleBuffer, 4);
        }
        GL11.nglClipPlane(n2, MemoryUtil.memAddress(doubleBuffer));
    }
    ...
    public static void glColorMask(@NativeType(value="GLboolean") boolean bl2, @NativeType(value="GLboolean") boolean bl3, @NativeType(value="GLboolean") boolean bl4, @NativeType(value="GLboolean") boolean bl5) {
        GL11C.glColorMask(bl2, bl3, bl4, bl5);
    }
    ...
    public static void glColorPointer(@NativeType(value="GLint") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLsizei") int n4, @NativeType(value="void const *") ByteBuffer byteBuffer) {
        GL11.nglColorPointer(n2, n3, n4, MemoryUtil.memAddress(byteBuffer));
    }

    public static void glColorPointer(@NativeType(value="GLint") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLsizei") int n4, @NativeType(value="void const *") long l2) {
        GL11.nglColorPointer(n2, n3, n4, l2);
    }

    public static void glColorPointer(@NativeType(value="GLint") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLsizei") int n4, @NativeType(value="void const *") ShortBuffer shortBuffer) {
        GL11.nglColorPointer(n2, n3, n4, MemoryUtil.memAddress(shortBuffer));
    }

    public static void glColorPointer(@NativeType(value="GLint") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLsizei") int n4, @NativeType(value="void const *") IntBuffer intBuffer) {
        GL11.nglColorPointer(n2, n3, n4, MemoryUtil.memAddress(intBuffer));
    }

    public static void glColorPointer(@NativeType(value="GLint") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLsizei") int n4, @NativeType(value="void const *") FloatBuffer floatBuffer) {
        GL11.nglColorPointer(n2, n3, n4, MemoryUtil.memAddress(floatBuffer));
    }
    ...
    public static void glCullFace(@NativeType(value="GLenum") int n2) {
        GL11C.glCullFace(n2);
    }

    public static native void glDeleteLists(@NativeType(value="GLuint") int var0, @NativeType(value="GLsizei") int var1);

    public static void glDepthFunc(@NativeType(value="GLenum") int n2) {
        GL11C.glDepthFunc(n2);
    }

    public static void glDepthMask(@NativeType(value="GLboolean") boolean bl2) {
        GL11C.glDepthMask(bl2);
    }

    public static void glDepthRange(@NativeType(value="GLdouble") double d2, @NativeType(value="GLdouble") double d3) {
        GL11C.glDepthRange(d2, d3);
    }

    public static native void glDisableClientState(@NativeType(value="GLenum") int var0);

    public static void glDrawArrays(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLsizei") int n4) {
        GL11C.glDrawArrays(n2, n3, n4);
    }

    public static void glDrawBuffer(@NativeType(value="GLenum") int n2) {
        GL11C.glDrawBuffer(n2);
    }

    public static void nglDrawElements(int n2, int n3, int n4, long l2) {
        GL11C.nglDrawElements(n2, n3, n4, l2);
    }

    public static void glDrawElements(@NativeType(value="GLenum") int n2, @NativeType(value="GLsizei") int n3, @NativeType(value="GLenum") int n4, @NativeType(value="void const *") long l2) {
        GL11C.glDrawElements(n2, n3, n4, l2);
    }

    public static void glDrawElements(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="void const *") ByteBuffer byteBuffer) {
        GL11C.glDrawElements(n2, n3, byteBuffer);
    }

    public static void glDrawElements(@NativeType(value="GLenum") int n2, @NativeType(value="void const *") ByteBuffer byteBuffer) {
        GL11C.glDrawElements(n2, byteBuffer);
    }

    public static void glDrawElements(@NativeType(value="GLenum") int n2, @NativeType(value="void const *") ShortBuffer shortBuffer) {
        GL11C.glDrawElements(n2, shortBuffer);
    }

    public static void glDrawElements(@NativeType(value="GLenum") int n2, @NativeType(value="void const *") IntBuffer intBuffer) {
        GL11C.glDrawElements(n2, intBuffer);
    }

    public static native void nglDrawPixels(int var0, int var1, int var2, int var3, long var4);

    public static void glDrawPixels(@NativeType(value="GLsizei") int n2, @NativeType(value="GLsizei") int n3, @NativeType(value="GLenum") int n4, @NativeType(value="GLenum") int n5, @NativeType(value="void const *") ByteBuffer byteBuffer) {
        GL11.nglDrawPixels(n2, n3, n4, n5, MemoryUtil.memAddress(byteBuffer));
    }

    public static void glDrawPixels(@NativeType(value="GLsizei") int n2, @NativeType(value="GLsizei") int n3, @NativeType(value="GLenum") int n4, @NativeType(value="GLenum") int n5, @NativeType(value="void const *") long l2) {
        GL11.nglDrawPixels(n2, n3, n4, n5, l2);
    }

    public static void glDrawPixels(@NativeType(value="GLsizei") int n2, @NativeType(value="GLsizei") int n3, @NativeType(value="GLenum") int n4, @NativeType(value="GLenum") int n5, @NativeType(value="void const *") ShortBuffer shortBuffer) {
        GL11.nglDrawPixels(n2, n3, n4, n5, MemoryUtil.memAddress(shortBuffer));
    }

    public static void glDrawPixels(@NativeType(value="GLsizei") int n2, @NativeType(value="GLsizei") int n3, @NativeType(value="GLenum") int n4, @NativeType(value="GLenum") int n5, @NativeType(value="void const *") IntBuffer intBuffer) {
        GL11.nglDrawPixels(n2, n3, n4, n5, MemoryUtil.memAddress(intBuffer));
    }

    public static void glDrawPixels(@NativeType(value="GLsizei") int n2, @NativeType(value="GLsizei") int n3, @NativeType(value="GLenum") int n4, @NativeType(value="GLenum") int n5, @NativeType(value="void const *") FloatBuffer floatBuffer) {
        GL11.nglDrawPixels(n2, n3, n4, n5, MemoryUtil.memAddress(floatBuffer));
    }
    ...
    public static void glEdgeFlagPointer(@NativeType(value="GLsizei") int n2, @NativeType(value="GLboolean const *") ByteBuffer byteBuffer) {
        GL11.nglEdgeFlagPointer(n2, MemoryUtil.memAddress(byteBuffer));
    }

    public static void glEdgeFlagPointer(@NativeType(value="GLsizei") int n2, @NativeType(value="GLboolean const *") long l2) {
        GL11.nglEdgeFlagPointer(n2, l2);
    }
    ...
    public static void glFeedbackBuffer(@NativeType(value="GLenum") int n2, @NativeType(value="GLfloat *") FloatBuffer floatBuffer) {
        GL11.nglFeedbackBuffer(floatBuffer.remaining(), n2, MemoryUtil.memAddress(floatBuffer));
    }
    ...
    public static void glFogiv(@NativeType(value="GLenum") int n2, @NativeType(value="GLint const *") IntBuffer intBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)intBuffer, 1);
        }
        GL11.nglFogiv(n2, MemoryUtil.memAddress(intBuffer));
    }
    ...
    public static void glFogfv(@NativeType(value="GLenum") int n2, @NativeType(value="GLfloat const *") FloatBuffer floatBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)floatBuffer, 1);
        }
        GL11.nglFogfv(n2, MemoryUtil.memAddress(floatBuffer));
    }

    public static void glFrontFace(@NativeType(value="GLenum") int n2) {
        GL11C.glFrontFace(n2);
    }

    @NativeType(value="GLuint")
    public static native int glGenLists(@NativeType(value="GLsizei") int var0);

    public static void nglGenTextures(int n2, long l2) {
        GL11C.nglGenTextures(n2, l2);
    }
    ...
    public static void nglDeleteTextures(int n2, long l2) {
        GL11C.nglDeleteTextures(n2, l2);
    }
    ...
    public static void glDeleteTextures(@NativeType(value="GLuint const *") int n2) {
        GL11C.glDeleteTextures(n2);
    }

    public static native void nglGetClipPlane(int var0, long var1);

    public static void glGetClipPlane(@NativeType(value="GLenum") int n2, @NativeType(value="GLdouble *") DoubleBuffer doubleBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)doubleBuffer, 4);
        }
        GL11.nglGetClipPlane(n2, MemoryUtil.memAddress(doubleBuffer));
    }

    public static void nglGetBooleanv(int n2, long l2) {
        GL11C.nglGetBooleanv(n2, l2);
    }

    public static void glGetBooleanv(@NativeType(value="GLenum") int n2, @NativeType(value="GLboolean *") ByteBuffer byteBuffer) {
        GL11C.glGetBooleanv(n2, byteBuffer);
    }

    @NativeType(value="void")
    public static boolean glGetBoolean(@NativeType(value="GLenum") int n2) {
        return GL11C.glGetBoolean(n2);
    }

    public static void nglGetFloatv(int n2, long l2) {
        GL11C.nglGetFloatv(n2, l2);
    }

    public static void glGetFloatv(@NativeType(value="GLenum") int n2, @NativeType(value="GLfloat *") FloatBuffer floatBuffer) {
        GL11C.glGetFloatv(n2, floatBuffer);
    }

    @NativeType(value="void")
    public static float glGetFloat(@NativeType(value="GLenum") int n2) {
        return GL11C.glGetFloat(n2);
    }

    public static void nglGetIntegerv(int n2, long l2) {
        GL11C.nglGetIntegerv(n2, l2);
    }

    public static void glGetIntegerv(@NativeType(value="GLenum") int n2, @NativeType(value="GLint *") IntBuffer intBuffer) {
        GL11C.glGetIntegerv(n2, intBuffer);
    }

    @NativeType(value="void")
    public static int glGetInteger(@NativeType(value="GLenum") int n2) {
        return GL11C.glGetInteger(n2);
    }

    public static void nglGetDoublev(int n2, long l2) {
        GL11C.nglGetDoublev(n2, l2);
    }

    public static void glGetDoublev(@NativeType(value="GLenum") int n2, @NativeType(value="GLdouble *") DoubleBuffer doubleBuffer) {
        GL11C.glGetDoublev(n2, doubleBuffer);
    }

    @NativeType(value="void")
    public static double glGetDouble(@NativeType(value="GLenum") int n2) {
        return GL11C.glGetDouble(n2);
    }
    ...
    public static void glGetLightiv(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLint *") IntBuffer intBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)intBuffer, 4);
        }
        GL11.nglGetLightiv(n2, n3, MemoryUtil.memAddress(intBuffer));
    }
     ...
     */
    @NativeType(value="void")
    public static int glGetLighti(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3) {
        MemoryStack memoryStack = MemoryStack.stackGet();
    ...
    public static void glGetLightfv(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLfloat *") FloatBuffer floatBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)floatBuffer, 4);
        }
        GL11.nglGetLightfv(n2, n3, MemoryUtil.memAddress(floatBuffer));
    }
     ...
     */
    @NativeType(value="void")
    public static float glGetLightf(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3) {
        MemoryStack memoryStack = MemoryStack.stackGet();
        int n4 = memoryStack.getPointer();
        try {
    ...
    public static void glGetMapiv(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLint *") IntBuffer intBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)intBuffer, 4);
        }
        GL11.nglGetMapiv(n2, n3, MemoryUtil.memAddress(intBuffer));
    }
     ...
     */
    @NativeType(value="void")
    public static int glGetMapi(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3) {
        MemoryStack memoryStack = MemoryStack.stackGet();
        int n4 = memoryStack.getPointer();
        try {
            IntBuffer intBuffer = memoryStack.callocInt(1);
    ...
    public static void glGetMapfv(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLfloat *") FloatBuffer floatBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)floatBuffer, 4);
        }
        GL11.nglGetMapfv(n2, n3, MemoryUtil.memAddress(floatBuffer));
    }
     ...
     */
    @NativeType(value="void")
    public static float glGetMapf(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3) {
        MemoryStack memoryStack = MemoryStack.stackGet();
        int n4 = memoryStack.getPointer();
        try {
            FloatBuffer floatBuffer = memoryStack.callocFloat(1);
    ...
    public static void glGetMapdv(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLdouble *") DoubleBuffer doubleBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)doubleBuffer, 4);
        }
        GL11.nglGetMapdv(n2, n3, MemoryUtil.memAddress(doubleBuffer));
    }
     ...
     */
    @NativeType(value="void")
    public static double glGetMapd(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3) {
        MemoryStack memoryStack = MemoryStack.stackGet();
        int n4 = memoryStack.getPointer();
        try {
    ...
    public static void glGetMaterialiv(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLint *") IntBuffer intBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)intBuffer, 1);
        }
        GL11.nglGetMaterialiv(n2, n3, MemoryUtil.memAddress(intBuffer));
    }

    public static native void nglGetMaterialfv(int var0, int var1, long var2);

    public static void glGetMaterialfv(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLfloat *") FloatBuffer floatBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)floatBuffer, 1);
        }
        GL11.nglGetMaterialfv(n2, n3, MemoryUtil.memAddress(floatBuffer));
    }

    public static native void nglGetPixelMapfv(int var0, long var1);

    public static void glGetPixelMapfv(@NativeType(value="GLenum") int n2, @NativeType(value="GLfloat *") FloatBuffer floatBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)floatBuffer, 32);
        }
        GL11.nglGetPixelMapfv(n2, MemoryUtil.memAddress(floatBuffer));
    }

    public static void glGetPixelMapfv(@NativeType(value="GLenum") int n2, @NativeType(value="GLfloat *") long l2) {
        GL11.nglGetPixelMapfv(n2, l2);
    }

    public static native void nglGetPixelMapusv(int var0, long var1);

    public static void glGetPixelMapusv(@NativeType(value="GLenum") int n2, @NativeType(value="GLushort *") ShortBuffer shortBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)shortBuffer, 32);
        }
        GL11.nglGetPixelMapusv(n2, MemoryUtil.memAddress(shortBuffer));
    }

    public static void glGetPixelMapusv(@NativeType(value="GLenum") int n2, @NativeType(value="GLushort *") long l2) {
        GL11.nglGetPixelMapusv(n2, l2);
    }

    public static native void nglGetPixelMapuiv(int var0, long var1);

    public static void glGetPixelMapuiv(@NativeType(value="GLenum") int n2, @NativeType(value="GLuint *") IntBuffer intBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)intBuffer, 32);
        }
        GL11.nglGetPixelMapuiv(n2, MemoryUtil.memAddress(intBuffer));
    }

    public static void glGetPixelMapuiv(@NativeType(value="GLenum") int n2, @NativeType(value="GLuint *") long l2) {
        GL11.nglGetPixelMapuiv(n2, l2);
    }

    public static void nglGetPointerv(int n2, long l2) {
        GL11C.nglGetPointerv(n2, l2);
    }

    public static void glGetPointerv(@NativeType(value="GLenum") int n2, @NativeType(value="void **") PointerBuffer pointerBuffer) {
        GL11C.glGetPointerv(n2, pointerBuffer);
    }

    @NativeType(value="void")
    public static long glGetPointer(@NativeType(value="GLenum") int n2) {
        return GL11C.glGetPointer(n2);
    }
    ...
    public static void glGetPolygonStipple(@NativeType(value="void *") long l2) {
        GL11.nglGetPolygonStipple(l2);
    }

    public static long nglGetString(int n2) {
        return GL11C.nglGetString(n2);
    }

    @Nullable
    @NativeType(value="GLubyte const *")
    public static String glGetString(@NativeType(value="GLenum") int n2) {
        return GL11C.glGetString(n2);
    }

    public static native void nglGetTexEnviv(int var0, int var1, long var2);

    public static void glGetTexEnviv(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLint *") IntBuffer intBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)intBuffer, 1);
        }
        GL11.nglGetTexEnviv(n2, n3, MemoryUtil.memAddress(intBuffer));
    }
     ...
     */
    @NativeType(value="void")
    public static int glGetTexEnvi(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3) {
        MemoryStack memoryStack = MemoryStack.stackGet();
        int n4 = memoryStack.getPointer();
        try {
            IntBuffer intBuffer = memoryStack.callocInt(1);
    ...
    public static void glGetTexEnvfv(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLfloat *") FloatBuffer floatBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)floatBuffer, 1);
        }
        GL11.nglGetTexEnvfv(n2, n3, MemoryUtil.memAddress(floatBuffer));
    }
     ...
     */
    @NativeType(value="void")
    public static float glGetTexEnvf(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3) {
        MemoryStack memoryStack = MemoryStack.stackGet();
        int n4 = memoryStack.getPointer();
        try {
            FloatBuffer floatBuffer = memoryStack.callocFloat(1);
    ...
    public static void glGetTexGeniv(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLint *") IntBuffer intBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)intBuffer, 1);
        }
        GL11.nglGetTexGeniv(n2, n3, MemoryUtil.memAddress(intBuffer));
    }
     ...
     */
    @NativeType(value="void")
    public static int glGetTexGeni(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3) {
        MemoryStack memoryStack = MemoryStack.stackGet();
        int n4 = memoryStack.getPointer();
        try {
            IntBuffer intBuffer = memoryStack.callocInt(1);
    ...
    public static void glGetTexGenfv(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLfloat *") FloatBuffer floatBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)floatBuffer, 4);
        }
        GL11.nglGetTexGenfv(n2, n3, MemoryUtil.memAddress(floatBuffer));
    }
     ...
     */
    @NativeType(value="void")
    public static float glGetTexGenf(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3) {
        MemoryStack memoryStack = MemoryStack.stackGet();
        int n4 = memoryStack.getPointer();
        try {
            FloatBuffer floatBuffer = memoryStack.callocFloat(1);
    ...
    public static void glGetTexGendv(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLdouble *") DoubleBuffer doubleBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)doubleBuffer, 4);
        }
        GL11.nglGetTexGendv(n2, n3, MemoryUtil.memAddress(doubleBuffer));
    }
     ...
     */
    @NativeType(value="void")
    public static double glGetTexGend(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3) {
        MemoryStack memoryStack = MemoryStack.stackGet();
        int n4 = memoryStack.getPointer();
        try {
            DoubleBuffer doubleBuffer = memoryStack.callocDouble(1);
    ...
    public static void nglGetTexImage(int n2, int n3, int n4, int n5, long l2) {
        GL11C.nglGetTexImage(n2, n3, n4, n5, l2);
    }

    public static void glGetTexImage(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLenum") int n4, @NativeType(value="GLenum") int n5, @NativeType(value="void *") ByteBuffer byteBuffer) {
        GL11C.glGetTexImage(n2, n3, n4, n5, byteBuffer);
    }

    public static void glGetTexImage(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLenum") int n4, @NativeType(value="GLenum") int n5, @NativeType(value="void *") long l2) {
        GL11C.glGetTexImage(n2, n3, n4, n5, l2);
    }

    public static void glGetTexImage(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLenum") int n4, @NativeType(value="GLenum") int n5, @NativeType(value="void *") ShortBuffer shortBuffer) {
        GL11C.glGetTexImage(n2, n3, n4, n5, shortBuffer);
    }

    public static void glGetTexImage(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLenum") int n4, @NativeType(value="GLenum") int n5, @NativeType(value="void *") IntBuffer intBuffer) {
        GL11C.glGetTexImage(n2, n3, n4, n5, intBuffer);
    }

    public static void glGetTexImage(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLenum") int n4, @NativeType(value="GLenum") int n5, @NativeType(value="void *") FloatBuffer floatBuffer) {
        GL11C.glGetTexImage(n2, n3, n4, n5, floatBuffer);
    }

    public static void glGetTexImage(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLenum") int n4, @NativeType(value="GLenum") int n5, @NativeType(value="void *") DoubleBuffer doubleBuffer) {
        GL11C.glGetTexImage(n2, n3, n4, n5, doubleBuffer);
    }

    public static void nglGetTexLevelParameteriv(int n2, int n3, int n4, long l2) {
        GL11C.nglGetTexLevelParameteriv(n2, n3, n4, l2);
    }

    public static void glGetTexLevelParameteriv(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLenum") int n4, @NativeType(value="GLint *") IntBuffer intBuffer) {
        GL11C.glGetTexLevelParameteriv(n2, n3, n4, intBuffer);
    }

    @NativeType(value="void")
    public static int glGetTexLevelParameteri(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLenum") int n4) {
        return GL11C.glGetTexLevelParameteri(n2, n3, n4);
    }

    public static void nglGetTexLevelParameterfv(int n2, int n3, int n4, long l2) {
        GL11C.nglGetTexLevelParameterfv(n2, n3, n4, l2);
    }

    public static void glGetTexLevelParameterfv(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLenum") int n4, @NativeType(value="GLfloat *") FloatBuffer floatBuffer) {
        GL11C.glGetTexLevelParameterfv(n2, n3, n4, floatBuffer);
    }

    @NativeType(value="void")
    public static float glGetTexLevelParameterf(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLenum") int n4) {
        return GL11C.glGetTexLevelParameterf(n2, n3, n4);
    }

    public static void nglGetTexParameteriv(int n2, int n3, long l2) {
        GL11C.nglGetTexParameteriv(n2, n3, l2);
    }

    public static void glGetTexParameteriv(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLint *") IntBuffer intBuffer) {
        GL11C.glGetTexParameteriv(n2, n3, intBuffer);
    }

    @NativeType(value="void")
    public static int glGetTexParameteri(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3) {
        return GL11C.glGetTexParameteri(n2, n3);
    }

    public static void nglGetTexParameterfv(int n2, int n3, long l2) {
        GL11C.nglGetTexParameterfv(n2, n3, l2);
    }

    public static void glGetTexParameterfv(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLfloat *") FloatBuffer floatBuffer) {
        GL11C.glGetTexParameterfv(n2, n3, floatBuffer);
    }

    @NativeType(value="void")
    public static float glGetTexParameterf(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3) {
        return GL11C.glGetTexParameterf(n2, n3);
    }

    public static void glHint(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3) {
        GL11C.glHint(n2, n3);
    }
    ...
    public static void glIndexPointer(@NativeType(value="GLenum") int n2, @NativeType(value="GLsizei") int n3, @NativeType(value="void const *") ByteBuffer byteBuffer) {
        GL11.nglIndexPointer(n2, n3, MemoryUtil.memAddress(byteBuffer));
    }

    public static void glIndexPointer(@NativeType(value="GLenum") int n2, @NativeType(value="GLsizei") int n3, @NativeType(value="void const *") long l2) {
        GL11.nglIndexPointer(n2, n3, l2);
    }

    public static void glIndexPointer(@NativeType(value="GLsizei") int n2, @NativeType(value="void const *") ByteBuffer byteBuffer) {
        GL11.nglIndexPointer(5121, n2, MemoryUtil.memAddress(byteBuffer));
    }

    public static void glIndexPointer(@NativeType(value="GLsizei") int n2, @NativeType(value="void const *") ShortBuffer shortBuffer) {
        GL11.nglIndexPointer(5122, n2, MemoryUtil.memAddress(shortBuffer));
    }

    public static void glIndexPointer(@NativeType(value="GLsizei") int n2, @NativeType(value="void const *") IntBuffer intBuffer) {
        GL11.nglIndexPointer(5124, n2, MemoryUtil.memAddress(intBuffer));
    }
    ...
    public static void glInterleavedArrays(@NativeType(value="GLenum") int n2, @NativeType(value="GLsizei") int n3, @NativeType(value="void const *") ByteBuffer byteBuffer) {
        GL11.nglInterleavedArrays(n2, n3, MemoryUtil.memAddress(byteBuffer));
    }

    public static void glInterleavedArrays(@NativeType(value="GLenum") int n2, @NativeType(value="GLsizei") int n3, @NativeType(value="void const *") long l2) {
        GL11.nglInterleavedArrays(n2, n3, l2);
    }

    public static void glInterleavedArrays(@NativeType(value="GLenum") int n2, @NativeType(value="GLsizei") int n3, @NativeType(value="void const *") ShortBuffer shortBuffer) {
        GL11.nglInterleavedArrays(n2, n3, MemoryUtil.memAddress(shortBuffer));
    }

    public static void glInterleavedArrays(@NativeType(value="GLenum") int n2, @NativeType(value="GLsizei") int n3, @NativeType(value="void const *") IntBuffer intBuffer) {
        GL11.nglInterleavedArrays(n2, n3, MemoryUtil.memAddress(intBuffer));
    }

    public static void glInterleavedArrays(@NativeType(value="GLenum") int n2, @NativeType(value="GLsizei") int n3, @NativeType(value="void const *") FloatBuffer floatBuffer) {
        GL11.nglInterleavedArrays(n2, n3, MemoryUtil.memAddress(floatBuffer));
    }

    public static void glInterleavedArrays(@NativeType(value="GLenum") int n2, @NativeType(value="GLsizei") int n3, @NativeType(value="void const *") DoubleBuffer doubleBuffer) {
        GL11.nglInterleavedArrays(n2, n3, MemoryUtil.memAddress(doubleBuffer));
    }

    @NativeType(value="GLboolean")
    public static boolean glIsEnabled(@NativeType(value="GLenum") int n2) {
        return GL11C.glIsEnabled(n2);
    }
    ...
    @NativeType(value="GLboolean")
    public static boolean glIsTexture(@NativeType(value="GLuint") int n2) {
        return GL11C.glIsTexture(n2);
    }
    ...
    public static void glLightModeliv(@NativeType(value="GLenum") int n2, @NativeType(value="GLint const *") IntBuffer intBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)intBuffer, 4);
        }
        GL11.nglLightModeliv(n2, MemoryUtil.memAddress(intBuffer));
    }

    public static native void nglLightModelfv(int var0, long var1);

    public static void glLightModelfv(@NativeType(value="GLenum") int n2, @NativeType(value="GLfloat const *") FloatBuffer floatBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)floatBuffer, 4);
        }
        GL11.nglLightModelfv(n2, MemoryUtil.memAddress(floatBuffer));
    }
    ...
    public static void glLightiv(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLint const *") IntBuffer intBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)intBuffer, 4);
        }
        GL11.nglLightiv(n2, n3, MemoryUtil.memAddress(intBuffer));
    }

    public static native void nglLightfv(int var0, int var1, long var2);

    public static void glLightfv(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLfloat const *") FloatBuffer floatBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)floatBuffer, 4);
        }
        GL11.nglLightfv(n2, n3, MemoryUtil.memAddress(floatBuffer));
    }

    public static native void glLineStipple(@NativeType(value="GLint") int var0, @NativeType(value="GLushort") short var1);

    public static void glLineWidth(@NativeType(value="GLfloat") float f2) {
        GL11C.glLineWidth(f2);
    }
    ...
    public static void glLogicOp(@NativeType(value="GLenum") int n2) {
        GL11C.glLogicOp(n2);
    }

    public static native void nglMap1f(int var0, float var1, float var2, int var3, int var4, long var5);

    public static void glMap1f(@NativeType(value="GLenum") int n2, @NativeType(value="GLfloat") float f2, @NativeType(value="GLfloat") float f3, @NativeType(value="GLint") int n3, @NativeType(value="GLint") int n4, @NativeType(value="GLfloat const *") FloatBuffer floatBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)floatBuffer, n4 * n3);
        }
        GL11.nglMap1f(n2, f2, f3, n3, n4, MemoryUtil.memAddress(floatBuffer));
    }

    public static native void nglMap1d(int var0, double var1, double var3, int var5, int var6, long var7);

    public static void glMap1d(@NativeType(value="GLenum") int n2, @NativeType(value="GLdouble") double d2, @NativeType(value="GLdouble") double d3, @NativeType(value="GLint") int n3, @NativeType(value="GLint") int n4, @NativeType(value="GLdouble const *") DoubleBuffer doubleBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)doubleBuffer, n3 * n4);
        }
        GL11.nglMap1d(n2, d2, d3, n3, n4, MemoryUtil.memAddress(doubleBuffer));
    }
    ...
    public static void glMap2f(@NativeType(value="GLenum") int n2, @NativeType(value="GLfloat") float f2, @NativeType(value="GLfloat") float f3, @NativeType(value="GLint") int n3, @NativeType(value="GLint") int n4, @NativeType(value="GLfloat") float f4, @NativeType(value="GLfloat") float f5, @NativeType(value="GLint") int n5, @NativeType(value="GLint") int n6, @NativeType(value="GLfloat const *") FloatBuffer floatBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)floatBuffer, n3 * n4 * n5 * n6);
        }
        GL11.nglMap2f(n2, f2, f3, n3, n4, f4, f5, n5, n6, MemoryUtil.memAddress(floatBuffer));
    }
    ...
    public static void glMap2d(@NativeType(value="GLenum") int n2, @NativeType(value="GLdouble") double d2, @NativeType(value="GLdouble") double d3, @NativeType(value="GLint") int n3, @NativeType(value="GLint") int n4, @NativeType(value="GLdouble") double d4, @NativeType(value="GLdouble") double d5, @NativeType(value="GLint") int n5, @NativeType(value="GLint") int n6, @NativeType(value="GLdouble const *") DoubleBuffer doubleBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)doubleBuffer, n3 * n4 * n5 * n6);
        }
        GL11.nglMap2d(n2, d2, d3, n3, n4, d4, d5, n5, n6, MemoryUtil.memAddress(doubleBuffer));
    }
    ...
    public static void glMaterialiv(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLint const *") IntBuffer intBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)intBuffer, 4);
        }
        GL11.nglMaterialiv(n2, n3, MemoryUtil.memAddress(intBuffer));
    }

    public static native void nglMaterialfv(int var0, int var1, long var2);

    public static void glMaterialfv(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLfloat const *") FloatBuffer floatBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)floatBuffer, 4);
        }
        GL11.nglMaterialfv(n2, n3, MemoryUtil.memAddress(floatBuffer));
    }
    ...
    public static void glNormalPointer(@NativeType(value="GLenum") int n2, @NativeType(value="GLsizei") int n3, @NativeType(value="void const *") ByteBuffer byteBuffer) {
        GL11.nglNormalPointer(n2, n3, MemoryUtil.memAddress(byteBuffer));
    }

    public static void glNormalPointer(@NativeType(value="GLenum") int n2, @NativeType(value="GLsizei") int n3, @NativeType(value="void const *") long l2) {
        GL11.nglNormalPointer(n2, n3, l2);
    }

    public static void glNormalPointer(@NativeType(value="GLenum") int n2, @NativeType(value="GLsizei") int n3, @NativeType(value="void const *") ShortBuffer shortBuffer) {
        GL11.nglNormalPointer(n2, n3, MemoryUtil.memAddress(shortBuffer));
    }

    public static void glNormalPointer(@NativeType(value="GLenum") int n2, @NativeType(value="GLsizei") int n3, @NativeType(value="void const *") IntBuffer intBuffer) {
        GL11.nglNormalPointer(n2, n3, MemoryUtil.memAddress(intBuffer));
    }

    public static void glNormalPointer(@NativeType(value="GLenum") int n2, @NativeType(value="GLsizei") int n3, @NativeType(value="void const *") FloatBuffer floatBuffer) {
        GL11.nglNormalPointer(n2, n3, MemoryUtil.memAddress(floatBuffer));
    }
    ...
    public static void glPixelMapfv(@NativeType(value="GLenum") int n2, @NativeType(value="GLsizei") int n3, @NativeType(value="GLfloat const *") long l2) {
        GL11.nglPixelMapfv(n2, n3, l2);
    }

    public static void glPixelMapfv(@NativeType(value="GLenum") int n2, @NativeType(value="GLfloat const *") FloatBuffer floatBuffer) {
        GL11.nglPixelMapfv(n2, floatBuffer.remaining(), MemoryUtil.memAddress(floatBuffer));
    }

    public static native void nglPixelMapusv(int var0, int var1, long var2);

    public static void glPixelMapusv(@NativeType(value="GLenum") int n2, @NativeType(value="GLsizei") int n3, @NativeType(value="GLushort const *") long l2) {
        GL11.nglPixelMapusv(n2, n3, l2);
    }

    public static void glPixelMapusv(@NativeType(value="GLenum") int n2, @NativeType(value="GLushort const *") ShortBuffer shortBuffer) {
        GL11.nglPixelMapusv(n2, shortBuffer.remaining(), MemoryUtil.memAddress(shortBuffer));
    }

    public static native void nglPixelMapuiv(int var0, int var1, long var2);

    public static void glPixelMapuiv(@NativeType(value="GLenum") int n2, @NativeType(value="GLsizei") int n3, @NativeType(value="GLuint const *") long l2) {
        GL11.nglPixelMapuiv(n2, n3, l2);
    }

    public static void glPixelMapuiv(@NativeType(value="GLenum") int n2, @NativeType(value="GLuint const *") IntBuffer intBuffer) {
        GL11.nglPixelMapuiv(n2, intBuffer.remaining(), MemoryUtil.memAddress(intBuffer));
    }

    public static void glPixelStorei(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3) {
        GL11C.glPixelStorei(n2, n3);
    }

    public static void glPixelStoref(@NativeType(value="GLenum") int n2, @NativeType(value="GLfloat") float f2) {
        GL11C.glPixelStoref(n2, f2);
    }
    ...
    public static void glPointSize(@NativeType(value="GLfloat") float f2) {
        GL11C.glPointSize(f2);
    }

    public static void glPolygonMode(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3) {
        GL11C.glPolygonMode(n2, n3);
    }

    public static void glPolygonOffset(@NativeType(value="GLfloat") float f2, @NativeType(value="GLfloat") float f3) {
        GL11C.glPolygonOffset(f2, f3);
    }
    ...
    public static void glPolygonStipple(@NativeType(value="GLubyte const *") long l2) {
        GL11.nglPolygonStipple(l2);
    }
    ...
    public static void glReadBuffer(@NativeType(value="GLenum") int n2) {
        GL11C.glReadBuffer(n2);
    }

    public static void nglReadPixels(int n2, int n3, int n4, int n5, int n6, int n7, long l2) {
        GL11C.nglReadPixels(n2, n3, n4, n5, n6, n7, l2);
    }

    public static void glReadPixels(@NativeType(value="GLint") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLsizei") int n4, @NativeType(value="GLsizei") int n5, @NativeType(value="GLenum") int n6, @NativeType(value="GLenum") int n7, @NativeType(value="void *") ByteBuffer byteBuffer) {
        GL11C.glReadPixels(n2, n3, n4, n5, n6, n7, byteBuffer);
    }

    public static void glReadPixels(@NativeType(value="GLint") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLsizei") int n4, @NativeType(value="GLsizei") int n5, @NativeType(value="GLenum") int n6, @NativeType(value="GLenum") int n7, @NativeType(value="void *") long l2) {
        GL11C.glReadPixels(n2, n3, n4, n5, n6, n7, l2);
    }

    public static void glReadPixels(@NativeType(value="GLint") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLsizei") int n4, @NativeType(value="GLsizei") int n5, @NativeType(value="GLenum") int n6, @NativeType(value="GLenum") int n7, @NativeType(value="void *") ShortBuffer shortBuffer) {
        GL11C.glReadPixels(n2, n3, n4, n5, n6, n7, shortBuffer);
    }

    public static void glReadPixels(@NativeType(value="GLint") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLsizei") int n4, @NativeType(value="GLsizei") int n5, @NativeType(value="GLenum") int n6, @NativeType(value="GLenum") int n7, @NativeType(value="void *") IntBuffer intBuffer) {
        GL11C.glReadPixels(n2, n3, n4, n5, n6, n7, intBuffer);
    }

    public static void glReadPixels(@NativeType(value="GLint") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLsizei") int n4, @NativeType(value="GLsizei") int n5, @NativeType(value="GLenum") int n6, @NativeType(value="GLenum") int n7, @NativeType(value="void *") FloatBuffer floatBuffer) {
        GL11C.glReadPixels(n2, n3, n4, n5, n6, n7, floatBuffer);
    }
    ...
    public static void glScissor(@NativeType(value="GLint") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLsizei") int n4, @NativeType(value="GLsizei") int n5) {
        GL11C.glScissor(n2, n3, n4, n5);
    }
    ...
    public static void glStencilFunc(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLuint") int n4) {
        GL11C.glStencilFunc(n2, n3, n4);
    }

    public static void glStencilMask(@NativeType(value="GLuint") int n2) {
        GL11C.glStencilMask(n2);
    }

    public static void glStencilOp(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLenum") int n4) {
        GL11C.glStencilOp(n2, n3, n4);
    }
    ...
    public static void glTexCoordPointer(@NativeType(value="GLint") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLsizei") int n4, @NativeType(value="void const *") ByteBuffer byteBuffer) {
        GL11.nglTexCoordPointer(n2, n3, n4, MemoryUtil.memAddress(byteBuffer));
    }

    public static void glTexCoordPointer(@NativeType(value="GLint") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLsizei") int n4, @NativeType(value="void const *") long l2) {
        GL11.nglTexCoordPointer(n2, n3, n4, l2);
    }

    public static void glTexCoordPointer(@NativeType(value="GLint") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLsizei") int n4, @NativeType(value="void const *") ShortBuffer shortBuffer) {
        GL11.nglTexCoordPointer(n2, n3, n4, MemoryUtil.memAddress(shortBuffer));
    }

    public static void glTexCoordPointer(@NativeType(value="GLint") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLsizei") int n4, @NativeType(value="void const *") IntBuffer intBuffer) {
        GL11.nglTexCoordPointer(n2, n3, n4, MemoryUtil.memAddress(intBuffer));
    }

    public static void glTexCoordPointer(@NativeType(value="GLint") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLsizei") int n4, @NativeType(value="void const *") FloatBuffer floatBuffer) {
        GL11.nglTexCoordPointer(n2, n3, n4, MemoryUtil.memAddress(floatBuffer));
    }
    ...
    public static void glTexEnviv(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLint const *") IntBuffer intBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)intBuffer, 4);
        }
        GL11.nglTexEnviv(n2, n3, MemoryUtil.memAddress(intBuffer));
    }
    ...
    public static void glTexEnvfv(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLfloat const *") FloatBuffer floatBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)floatBuffer, 4);
        }
        GL11.nglTexEnvfv(n2, n3, MemoryUtil.memAddress(floatBuffer));
    }
    ...
    public static void glTexGeniv(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLint const *") IntBuffer intBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)intBuffer, 4);
        }
        GL11.nglTexGeniv(n2, n3, MemoryUtil.memAddress(intBuffer));
    }
    ...
    public static void glTexGenfv(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLfloat const *") FloatBuffer floatBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)floatBuffer, 4);
        }
        GL11.nglTexGenfv(n2, n3, MemoryUtil.memAddress(floatBuffer));
    }
    ...
    public static void glTexGendv(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLdouble const *") DoubleBuffer doubleBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)doubleBuffer, 4);
        }
        GL11.nglTexGendv(n2, n3, MemoryUtil.memAddress(doubleBuffer));
    }

    public static void nglTexImage1D(int n2, int n3, int n4, int n5, int n6, int n7, int n8, long l2) {
        GL11C.nglTexImage1D(n2, n3, n4, n5, n6, n7, n8, l2);
    }

    public static void glTexImage1D(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLint") int n4, @NativeType(value="GLsizei") int n5, @NativeType(value="GLint") int n6, @NativeType(value="GLenum") int n7, @NativeType(value="GLenum") int n8, @Nullable @NativeType(value="void const *") ByteBuffer byteBuffer) {
        GL11C.glTexImage1D(n2, n3, n4, n5, n6, n7, n8, byteBuffer);
    }

    public static void glTexImage1D(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLint") int n4, @NativeType(value="GLsizei") int n5, @NativeType(value="GLint") int n6, @NativeType(value="GLenum") int n7, @NativeType(value="GLenum") int n8, @Nullable @NativeType(value="void const *") long l2) {
        GL11C.glTexImage1D(n2, n3, n4, n5, n6, n7, n8, l2);
    }

    public static void glTexImage1D(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLint") int n4, @NativeType(value="GLsizei") int n5, @NativeType(value="GLint") int n6, @NativeType(value="GLenum") int n7, @NativeType(value="GLenum") int n8, @Nullable @NativeType(value="void const *") ShortBuffer shortBuffer) {
        GL11C.glTexImage1D(n2, n3, n4, n5, n6, n7, n8, shortBuffer);
    }

    public static void glTexImage1D(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLint") int n4, @NativeType(value="GLsizei") int n5, @NativeType(value="GLint") int n6, @NativeType(value="GLenum") int n7, @NativeType(value="GLenum") int n8, @Nullable @NativeType(value="void const *") IntBuffer intBuffer) {
        GL11C.glTexImage1D(n2, n3, n4, n5, n6, n7, n8, intBuffer);
    }

    public static void glTexImage1D(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLint") int n4, @NativeType(value="GLsizei") int n5, @NativeType(value="GLint") int n6, @NativeType(value="GLenum") int n7, @NativeType(value="GLenum") int n8, @Nullable @NativeType(value="void const *") FloatBuffer floatBuffer) {
        GL11C.glTexImage1D(n2, n3, n4, n5, n6, n7, n8, floatBuffer);
    }

    public static void glTexImage1D(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLint") int n4, @NativeType(value="GLsizei") int n5, @NativeType(value="GLint") int n6, @NativeType(value="GLenum") int n7, @NativeType(value="GLenum") int n8, @Nullable @NativeType(value="void const *") DoubleBuffer doubleBuffer) {
        GL11C.glTexImage1D(n2, n3, n4, n5, n6, n7, n8, doubleBuffer);
    }

    public static void nglTexImage2D(int n2, int n3, int n4, int n5, int n6, int n7, int n8, int n9, long l2) {
        GL11C.nglTexImage2D(n2, n3, n4, n5, n6, n7, n8, n9, l2);
    }

    public static void glTexImage2D(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLint") int n4, @NativeType(value="GLsizei") int n5, @NativeType(value="GLsizei") int n6, @NativeType(value="GLint") int n7, @NativeType(value="GLenum") int n8, @NativeType(value="GLenum") int n9, @Nullable @NativeType(value="void const *") ByteBuffer byteBuffer) {
        GL11C.glTexImage2D(n2, n3, n4, n5, n6, n7, n8, n9, byteBuffer);
    }

    public static void glTexImage2D(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLint") int n4, @NativeType(value="GLsizei") int n5, @NativeType(value="GLsizei") int n6, @NativeType(value="GLint") int n7, @NativeType(value="GLenum") int n8, @NativeType(value="GLenum") int n9, @Nullable @NativeType(value="void const *") long l2) {
        GL11C.glTexImage2D(n2, n3, n4, n5, n6, n7, n8, n9, l2);
    }
    ...
    public static void glTexImage2D(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLint") int n4, @NativeType(value="GLsizei") int n5, @NativeType(value="GLsizei") int n6, @NativeType(value="GLint") int n7, @NativeType(value="GLenum") int n8, @NativeType(value="GLenum") int n9, @Nullable @NativeType(value="void const *") DoubleBuffer doubleBuffer) {
        GL11C.glTexImage2D(n2, n3, n4, n5, n6, n7, n8, n9, doubleBuffer);
    }

    public static void glCopyTexImage1D(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLenum") int n4, @NativeType(value="GLint") int n5, @NativeType(value="GLint") int n6, @NativeType(value="GLsizei") int n7, @NativeType(value="GLint") int n8) {
        GL11C.glCopyTexImage1D(n2, n3, n4, n5, n6, n7, n8);
    }

    public static void glCopyTexImage2D(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLenum") int n4, @NativeType(value="GLint") int n5, @NativeType(value="GLint") int n6, @NativeType(value="GLsizei") int n7, @NativeType(value="GLsizei") int n8, @NativeType(value="GLint") int n9) {
        GL11C.glCopyTexImage2D(n2, n3, n4, n5, n6, n7, n8, n9);
    }

    public static void glCopyTexSubImage1D(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLint") int n4, @NativeType(value="GLint") int n5, @NativeType(value="GLint") int n6, @NativeType(value="GLsizei") int n7) {
        GL11C.glCopyTexSubImage1D(n2, n3, n4, n5, n6, n7);
    }

    public static void glCopyTexSubImage2D(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLint") int n4, @NativeType(value="GLint") int n5, @NativeType(value="GLint") int n6, @NativeType(value="GLint") int n7, @NativeType(value="GLsizei") int n8, @NativeType(value="GLsizei") int n9) {
        GL11C.glCopyTexSubImage2D(n2, n3, n4, n5, n6, n7, n8, n9);
    }

    public static void glTexParameteri(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLint") int n4) {
        GL11C.glTexParameteri(n2, n3, n4);
    }

    public static void nglTexParameteriv(int n2, int n3, long l2) {
        GL11C.nglTexParameteriv(n2, n3, l2);
    }

    public static void glTexParameteriv(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLint const *") IntBuffer intBuffer) {
        GL11C.glTexParameteriv(n2, n3, intBuffer);
    }

    public static void glTexParameterf(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLfloat") float f2) {
        GL11C.glTexParameterf(n2, n3, f2);
    }

    public static void nglTexParameterfv(int n2, int n3, long l2) {
        GL11C.nglTexParameterfv(n2, n3, l2);
    }

    public static void glTexParameterfv(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLfloat const *") FloatBuffer floatBuffer) {
        GL11C.glTexParameterfv(n2, n3, floatBuffer);
    }

    public static void nglTexSubImage1D(int n2, int n3, int n4, int n5, int n6, int n7, long l2) {
        GL11C.nglTexSubImage1D(n2, n3, n4, n5, n6, n7, l2);
    }

    public static void glTexSubImage1D(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLint") int n4, @NativeType(value="GLsizei") int n5, @NativeType(value="GLenum") int n6, @NativeType(value="GLenum") int n7, @NativeType(value="void const *") ByteBuffer byteBuffer) {
        GL11C.glTexSubImage1D(n2, n3, n4, n5, n6, n7, byteBuffer);
    }

    public static void glTexSubImage1D(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLint") int n4, @NativeType(value="GLsizei") int n5, @NativeType(value="GLenum") int n6, @NativeType(value="GLenum") int n7, @NativeType(value="void const *") long l2) {
        GL11C.glTexSubImage1D(n2, n3, n4, n5, n6, n7, l2);
    }

    public static void glTexSubImage1D(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLint") int n4, @NativeType(value="GLsizei") int n5, @NativeType(value="GLenum") int n6, @NativeType(value="GLenum") int n7, @NativeType(value="void const *") ShortBuffer shortBuffer) {
        GL11C.glTexSubImage1D(n2, n3, n4, n5, n6, n7, shortBuffer);
    }

    public static void glTexSubImage1D(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLint") int n4, @NativeType(value="GLsizei") int n5, @NativeType(value="GLenum") int n6, @NativeType(value="GLenum") int n7, @NativeType(value="void const *") IntBuffer intBuffer) {
        GL11C.glTexSubImage1D(n2, n3, n4, n5, n6, n7, intBuffer);
    }

    public static void glTexSubImage1D(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLint") int n4, @NativeType(value="GLsizei") int n5, @NativeType(value="GLenum") int n6, @NativeType(value="GLenum") int n7, @NativeType(value="void const *") FloatBuffer floatBuffer) {
        GL11C.glTexSubImage1D(n2, n3, n4, n5, n6, n7, floatBuffer);
    }

    public static void glTexSubImage1D(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLint") int n4, @NativeType(value="GLsizei") int n5, @NativeType(value="GLenum") int n6, @NativeType(value="GLenum") int n7, @NativeType(value="void const *") DoubleBuffer doubleBuffer) {
        GL11C.glTexSubImage1D(n2, n3, n4, n5, n6, n7, doubleBuffer);
    }

    public static void nglTexSubImage2D(int n2, int n3, int n4, int n5, int n6, int n7, int n8, int n9, long l2) {
        GL11C.nglTexSubImage2D(n2, n3, n4, n5, n6, n7, n8, n9, l2);
    }

    public static void glTexSubImage2D(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLint") int n4, @NativeType(value="GLint") int n5, @NativeType(value="GLsizei") int n6, @NativeType(value="GLsizei") int n7, @NativeType(value="GLenum") int n8, @NativeType(value="GLenum") int n9, @NativeType(value="void const *") ByteBuffer byteBuffer) {
        GL11C.glTexSubImage2D(n2, n3, n4, n5, n6, n7, n8, n9, byteBuffer);
    }

    public static void glTexSubImage2D(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLint") int n4, @NativeType(value="GLint") int n5, @NativeType(value="GLsizei") int n6, @NativeType(value="GLsizei") int n7, @NativeType(value="GLenum") int n8, @NativeType(value="GLenum") int n9, @NativeType(value="void const *") long l2) {
        GL11C.glTexSubImage2D(n2, n3, n4, n5, n6, n7, n8, n9, l2);
    }

    public static void glTexSubImage2D(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLint") int n4, @NativeType(value="GLint") int n5, @NativeType(value="GLsizei") int n6, @NativeType(value="GLsizei") int n7, @NativeType(value="GLenum") int n8, @NativeType(value="GLenum") int n9, @NativeType(value="void const *") ShortBuffer shortBuffer) {
        GL11C.glTexSubImage2D(n2, n3, n4, n5, n6, n7, n8, n9, shortBuffer);
    }

    public static void glTexSubImage2D(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLint") int n4, @NativeType(value="GLint") int n5, @NativeType(value="GLsizei") int n6, @NativeType(value="GLsizei") int n7, @NativeType(value="GLenum") int n8, @NativeType(value="GLenum") int n9, @NativeType(value="void const *") IntBuffer intBuffer) {
        GL11C.glTexSubImage2D(n2, n3, n4, n5, n6, n7, n8, n9, intBuffer);
    }

    public static void glTexSubImage2D(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLint") int n4, @NativeType(value="GLint") int n5, @NativeType(value="GLsizei") int n6, @NativeType(value="GLsizei") int n7, @NativeType(value="GLenum") int n8, @NativeType(value="GLenum") int n9, @NativeType(value="void const *") FloatBuffer floatBuffer) {
        GL11C.glTexSubImage2D(n2, n3, n4, n5, n6, n7, n8, n9, floatBuffer);
    }

    public static void glTexSubImage2D(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLint") int n4, @NativeType(value="GLint") int n5, @NativeType(value="GLsizei") int n6, @NativeType(value="GLsizei") int n7, @NativeType(value="GLenum") int n8, @NativeType(value="GLenum") int n9, @NativeType(value="void const *") DoubleBuffer doubleBuffer) {
        GL11C.glTexSubImage2D(n2, n3, n4, n5, n6, n7, n8, n9, doubleBuffer);
    }
    ...
    public static void glVertexPointer(@NativeType(value="GLint") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLsizei") int n4, @NativeType(value="void const *") ByteBuffer byteBuffer) {
        GL11.nglVertexPointer(n2, n3, n4, MemoryUtil.memAddress(byteBuffer));
    }

    public static void glVertexPointer(@NativeType(value="GLint") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLsizei") int n4, @NativeType(value="void const *") long l2) {
        GL11.nglVertexPointer(n2, n3, n4, l2);
    }

    public static void glVertexPointer(@NativeType(value="GLint") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLsizei") int n4, @NativeType(value="void const *") ShortBuffer shortBuffer) {
        GL11.nglVertexPointer(n2, n3, n4, MemoryUtil.memAddress(shortBuffer));
    }

    public static void glVertexPointer(@NativeType(value="GLint") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLsizei") int n4, @NativeType(value="void const *") IntBuffer intBuffer) {
        GL11.nglVertexPointer(n2, n3, n4, MemoryUtil.memAddress(intBuffer));
    }

    public static void glVertexPointer(@NativeType(value="GLint") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLsizei") int n4, @NativeType(value="void const *") FloatBuffer floatBuffer) {
        GL11.nglVertexPointer(n2, n3, n4, MemoryUtil.memAddress(floatBuffer));
    }

    public static void glViewport(@NativeType(value="GLint") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLsizei") int n4, @NativeType(value="GLsizei") int n5) {
        GL11C.glViewport(n2, n3, n4, n5);
    }
    ...
    public static boolean glAreTexturesResident(@NativeType(value="GLuint const *") int[] nArray, @NativeType(value="GLboolean *") ByteBuffer byteBuffer) {
        long l2 = GL.getICD().glAreTexturesResident;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check((Buffer)byteBuffer, nArray.length);
        }
        return JNI.callPPZ(nArray.length, nArray, MemoryUtil.memAddress(byteBuffer), l2);
    }

    public static void glClipPlane(@NativeType(value="GLenum") int n2, @NativeType(value="GLdouble const *") double[] dArray) {
        long l2 = GL.getICD().glClipPlane;
        if (Checks.CHECKS) {
            Checks.check(l2);
    ...
    public static void glDrawPixels(@NativeType(value="GLsizei") int n2, @NativeType(value="GLsizei") int n3, @NativeType(value="GLenum") int n4, @NativeType(value="GLenum") int n5, @NativeType(value="void const *") short[] sArray) {
        long l2 = GL.getICD().glDrawPixels;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
    ...
    public static void glDrawPixels(@NativeType(value="GLsizei") int n2, @NativeType(value="GLsizei") int n3, @NativeType(value="GLenum") int n4, @NativeType(value="GLenum") int n5, @NativeType(value="void const *") int[] nArray) {
        long l2 = GL.getICD().glDrawPixels;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
    ...
    public static void glDrawPixels(@NativeType(value="GLsizei") int n2, @NativeType(value="GLsizei") int n3, @NativeType(value="GLenum") int n4, @NativeType(value="GLenum") int n5, @NativeType(value="void const *") float[] fArray) {
        long l2 = GL.getICD().glDrawPixels;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
    ...
    public static void glEvalCoord1fv(@NativeType(value="GLfloat const *") float[] fArray) {
        long l2 = GL.getICD().glEvalCoord1fv;
        if (Checks.CHECKS) {
            Checks.check(l2);
    ...
    public static void glEvalCoord1dv(@NativeType(value="GLdouble const *") double[] dArray) {
        long l2 = GL.getICD().glEvalCoord1dv;
        if (Checks.CHECKS) {
            Checks.check(l2);
    ...
    public static void glEvalCoord2fv(@NativeType(value="GLfloat const *") float[] fArray) {
        long l2 = GL.getICD().glEvalCoord2fv;
        if (Checks.CHECKS) {
            Checks.check(l2);
    ...
    public static void glEvalCoord2dv(@NativeType(value="GLdouble const *") double[] dArray) {
        long l2 = GL.getICD().glEvalCoord2dv;
        if (Checks.CHECKS) {
            Checks.check(l2);
    ...
    public static void glFeedbackBuffer(@NativeType(value="GLenum") int n2, @NativeType(value="GLfloat *") float[] fArray) {
        long l2 = GL.getICD().glFeedbackBuffer;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        JNI.callPV(fArray.length, n2, fArray, l2);
    }

    public static void glFogiv(@NativeType(value="GLenum") int n2, @NativeType(value="GLint const *") int[] nArray) {
        long l2 = GL.getICD().glFogiv;
        if (Checks.CHECKS) {
            Checks.check(l2);
    ...
    public static void glFogfv(@NativeType(value="GLenum") int n2, @NativeType(value="GLfloat const *") float[] fArray) {
        long l2 = GL.getICD().glFogfv;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(fArray, 1);
        }
    ...
    public static void glGetClipPlane(@NativeType(value="GLenum") int n2, @NativeType(value="GLdouble *") double[] dArray) {
        long l2 = GL.getICD().glGetClipPlane;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(dArray, 4);
        }
    ...
    public static void glGetFloatv(@NativeType(value="GLenum") int n2, @NativeType(value="GLfloat *") float[] fArray) {
        GL11C.glGetFloatv(n2, fArray);
    }

    public static void glGetIntegerv(@NativeType(value="GLenum") int n2, @NativeType(value="GLint *") int[] nArray) {
        GL11C.glGetIntegerv(n2, nArray);
    }

    public static void glGetDoublev(@NativeType(value="GLenum") int n2, @NativeType(value="GLdouble *") double[] dArray) {
        GL11C.glGetDoublev(n2, dArray);
    }

    public static void glGetLightiv(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLint *") int[] nArray) {
        long l2 = GL.getICD().glGetLightiv;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(nArray, 4);
        }
    ...
    public static void glGetLightfv(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLfloat *") float[] fArray) {
        long l2 = GL.getICD().glGetLightfv;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(fArray, 4);
        }
    ...
    public static void glGetMapiv(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLint *") int[] nArray) {
        long l2 = GL.getICD().glGetMapiv;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(nArray, 4);
        }
    ...
    public static void glGetMapfv(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLfloat *") float[] fArray) {
        long l2 = GL.getICD().glGetMapfv;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(fArray, 4);
        }
    ...
    public static void glGetMapdv(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLdouble *") double[] dArray) {
        long l2 = GL.getICD().glGetMapdv;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(dArray, 4);
        }
    ...
    public static void glGetMaterialiv(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLint *") int[] nArray) {
        long l2 = GL.getICD().glGetMaterialiv;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(nArray, 1);
        }
    ...
    public static void glGetMaterialfv(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLfloat *") float[] fArray) {
        long l2 = GL.getICD().glGetMaterialfv;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(fArray, 1);
        }
    ...
    public static void glGetPixelMapfv(@NativeType(value="GLenum") int n2, @NativeType(value="GLfloat *") float[] fArray) {
        long l2 = GL.getICD().glGetPixelMapfv;
        if (Checks.CHECKS) {
            Checks.check(l2);
    ...
    public static void glGetPixelMapusv(@NativeType(value="GLenum") int n2, @NativeType(value="GLushort *") short[] sArray) {
        long l2 = GL.getICD().glGetPixelMapusv;
        if (Checks.CHECKS) {
            Checks.check(l2);
    ...
    public static void glGetPixelMapuiv(@NativeType(value="GLenum") int n2, @NativeType(value="GLuint *") int[] nArray) {
        long l2 = GL.getICD().glGetPixelMapuiv;
        if (Checks.CHECKS) {
            Checks.check(l2);
    ...
    public static void glGetTexEnviv(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLint *") int[] nArray) {
        long l2 = GL.getICD().glGetTexEnviv;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(nArray, 1);
        }
    ...
    public static void glGetTexEnvfv(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLfloat *") float[] fArray) {
        long l2 = GL.getICD().glGetTexEnvfv;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(fArray, 1);
        }
    ...
    public static void glGetTexGeniv(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLint *") int[] nArray) {
        long l2 = GL.getICD().glGetTexGeniv;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(nArray, 1);
        }
    ...
    public static void glGetTexGenfv(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLfloat *") float[] fArray) {
        long l2 = GL.getICD().glGetTexGenfv;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(fArray, 4);
        }
    ...
    public static void glGetTexGendv(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLdouble *") double[] dArray) {
        long l2 = GL.getICD().glGetTexGendv;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(dArray, 4);
        }
    ...
    public static void glGetTexImage(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLenum") int n4, @NativeType(value="GLenum") int n5, @NativeType(value="void *") short[] sArray) {
        GL11C.glGetTexImage(n2, n3, n4, n5, sArray);
    }

    public static void glGetTexImage(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLenum") int n4, @NativeType(value="GLenum") int n5, @NativeType(value="void *") int[] nArray) {
        GL11C.glGetTexImage(n2, n3, n4, n5, nArray);
    }

    public static void glGetTexImage(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLenum") int n4, @NativeType(value="GLenum") int n5, @NativeType(value="void *") float[] fArray) {
        GL11C.glGetTexImage(n2, n3, n4, n5, fArray);
    }

    public static void glGetTexImage(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLenum") int n4, @NativeType(value="GLenum") int n5, @NativeType(value="void *") double[] dArray) {
        GL11C.glGetTexImage(n2, n3, n4, n5, dArray);
    }

    public static void glGetTexLevelParameteriv(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLenum") int n4, @NativeType(value="GLint *") int[] nArray) {
        GL11C.glGetTexLevelParameteriv(n2, n3, n4, nArray);
    }

    public static void glGetTexLevelParameterfv(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLenum") int n4, @NativeType(value="GLfloat *") float[] fArray) {
        GL11C.glGetTexLevelParameterfv(n2, n3, n4, fArray);
    }

    public static void glGetTexParameteriv(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLint *") int[] nArray) {
        GL11C.glGetTexParameteriv(n2, n3, nArray);
    }

    public static void glGetTexParameterfv(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLfloat *") float[] fArray) {
        GL11C.glGetTexParameterfv(n2, n3, fArray);
    }

    public static void glIndexiv(@NativeType(value="GLint const *") int[] nArray) {
        long l2 = GL.getICD().glIndexiv;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(nArray, 1);
        }
    ...
    public static void glInterleavedArrays(@NativeType(value="GLenum") int n2, @NativeType(value="GLsizei") int n3, @NativeType(value="void const *") short[] sArray) {
        long l2 = GL.getICD().glInterleavedArrays;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        JNI.callPV(n2, n3, sArray, l2);
    }

    public static void glInterleavedArrays(@NativeType(value="GLenum") int n2, @NativeType(value="GLsizei") int n3, @NativeType(value="void const *") int[] nArray) {
        long l2 = GL.getICD().glInterleavedArrays;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
    ...
    public static void glInterleavedArrays(@NativeType(value="GLenum") int n2, @NativeType(value="GLsizei") int n3, @NativeType(value="void const *") float[] fArray) {
        long l2 = GL.getICD().glInterleavedArrays;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
    ...
    public static void glInterleavedArrays(@NativeType(value="GLenum") int n2, @NativeType(value="GLsizei") int n3, @NativeType(value="void const *") double[] dArray) {
        long l2 = GL.getICD().glInterleavedArrays;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
    ...
    public static void glLightModeliv(@NativeType(value="GLenum") int n2, @NativeType(value="GLint const *") int[] nArray) {
        long l2 = GL.getICD().glLightModeliv;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(nArray, 4);
        }
    ...
    public static void glLightModelfv(@NativeType(value="GLenum") int n2, @NativeType(value="GLfloat const *") float[] fArray) {
        long l2 = GL.getICD().glLightModelfv;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(fArray, 4);
        }
    ...
    public static void glLightiv(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLint const *") int[] nArray) {
        long l2 = GL.getICD().glLightiv;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(nArray, 4);
        }
    ...
    public static void glLightfv(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLfloat const *") float[] fArray) {
        long l2 = GL.getICD().glLightfv;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(fArray, 4);
        }
    ...
    public static void glLoadMatrixf(@NativeType(value="GLfloat const *") float[] fArray) {
        long l2 = GL.getICD().glLoadMatrixf;
        if (Checks.CHECKS) {
            Checks.check(l2);
    ...
    public static void glLoadMatrixd(@NativeType(value="GLdouble const *") double[] dArray) {
        long l2 = GL.getICD().glLoadMatrixd;
        if (Checks.CHECKS) {
            Checks.check(l2);
    ...
    public static void glMap1f(@NativeType(value="GLenum") int n2, @NativeType(value="GLfloat") float f2, @NativeType(value="GLfloat") float f3, @NativeType(value="GLint") int n3, @NativeType(value="GLint") int n4, @NativeType(value="GLfloat const *") float[] fArray) {
        long l2 = GL.getICD().glMap1f;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(fArray, n4 * n3);
        }
        JNI.callPV(n2, f2, f3, n3, n4, fArray, l2);
    }

    public static void glMap1d(@NativeType(value="GLenum") int n2, @NativeType(value="GLdouble") double d2, @NativeType(value="GLdouble") double d3, @NativeType(value="GLint") int n3, @NativeType(value="GLint") int n4, @NativeType(value="GLdouble const *") double[] dArray) {
        long l2 = GL.getICD().glMap1d;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(dArray, n3 * n4);
        }
        JNI.callPV(n2, d2, d3, n3, n4, dArray, l2);
    }

    public static void glMap2f(@NativeType(value="GLenum") int n2, @NativeType(value="GLfloat") float f2, @NativeType(value="GLfloat") float f3, @NativeType(value="GLint") int n3, @NativeType(value="GLint") int n4, @NativeType(value="GLfloat") float f4, @NativeType(value="GLfloat") float f5, @NativeType(value="GLint") int n5, @NativeType(value="GLint") int n6, @NativeType(value="GLfloat const *") float[] fArray) {
        long l2 = GL.getICD().glMap2f;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(fArray, n3 * n4 * n5 * n6);
        }
        JNI.callPV(n2, f2, f3, n3, n4, f4, f5, n5, n6, fArray, l2);
    }

    public static void glMap2d(@NativeType(value="GLenum") int n2, @NativeType(value="GLdouble") double d2, @NativeType(value="GLdouble") double d3, @NativeType(value="GLint") int n3, @NativeType(value="GLint") int n4, @NativeType(value="GLdouble") double d4, @NativeType(value="GLdouble") double d5, @NativeType(value="GLint") int n5, @NativeType(value="GLint") int n6, @NativeType(value="GLdouble const *") double[] dArray) {
        long l2 = GL.getICD().glMap2d;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(dArray, n3 * n4 * n5 * n6);
        }
        JNI.callPV(n2, d2, d3, n3, n4, d4, d5, n5, n6, dArray, l2);
    }

    public static void glMaterialiv(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLint const *") int[] nArray) {
        long l2 = GL.getICD().glMaterialiv;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(nArray, 4);
        }
    ...
    public static void glMaterialfv(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLfloat const *") float[] fArray) {
        long l2 = GL.getICD().glMaterialfv;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(fArray, 4);
        }
    ...
    public static void glMultMatrixf(@NativeType(value="GLfloat const *") float[] fArray) {
        long l2 = GL.getICD().glMultMatrixf;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(fArray, 16);
        }
    ...
    public static void glMultMatrixd(@NativeType(value="GLdouble const *") double[] dArray) {
        long l2 = GL.getICD().glMultMatrixd;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(dArray, 16);
        }
    ...
    public static void glPixelMapfv(@NativeType(value="GLenum") int n2, @NativeType(value="GLfloat const *") float[] fArray) {
        long l2 = GL.getICD().glPixelMapfv;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
    ...
    public static void glPixelMapusv(@NativeType(value="GLenum") int n2, @NativeType(value="GLushort const *") short[] sArray) {
        long l2 = GL.getICD().glPixelMapusv;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
    ...
    public static void glPixelMapuiv(@NativeType(value="GLenum") int n2, @NativeType(value="GLuint const *") int[] nArray) {
        long l2 = GL.getICD().glPixelMapuiv;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
    ...
    public static void glPrioritizeTextures(@NativeType(value="GLuint const *") int[] nArray, @NativeType(value="GLfloat const *") float[] fArray) {
        long l2 = GL.getICD().glPrioritizeTextures;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(fArray, nArray.length);
        }
        JNI.callPPV(nArray.length, nArray, fArray, l2);
    }

    public static void glRasterPos2iv(@NativeType(value="GLint const *") int[] nArray) {
        long l2 = GL.getICD().glRasterPos2iv;
        if (Checks.CHECKS) {
            Checks.check(l2);
    ...
    public static void glRasterPos2sv(@NativeType(value="GLshort const *") short[] sArray) {
        long l2 = GL.getICD().glRasterPos2sv;
        if (Checks.CHECKS) {
            Checks.check(l2);
    ...
    public static void glRasterPos2fv(@NativeType(value="GLfloat const *") float[] fArray) {
        long l2 = GL.getICD().glRasterPos2fv;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(fArray, 2);
        }
    ...
    public static void glRasterPos2dv(@NativeType(value="GLdouble const *") double[] dArray) {
        long l2 = GL.getICD().glRasterPos2dv;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(dArray, 2);
        }
    ...
    public static void glRasterPos3iv(@NativeType(value="GLint const *") int[] nArray) {
        long l2 = GL.getICD().glRasterPos3iv;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(nArray, 3);
        }
    ...
    public static void glRasterPos3sv(@NativeType(value="GLshort const *") short[] sArray) {
        long l2 = GL.getICD().glRasterPos3sv;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(sArray, 3);
        }
    ...
    public static void glRasterPos3fv(@NativeType(value="GLfloat const *") float[] fArray) {
        long l2 = GL.getICD().glRasterPos3fv;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(fArray, 3);
        }
    ...
    public static void glRasterPos3dv(@NativeType(value="GLdouble const *") double[] dArray) {
        long l2 = GL.getICD().glRasterPos3dv;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(dArray, 3);
        }
    ...
    public static void glRasterPos4iv(@NativeType(value="GLint const *") int[] nArray) {
        long l2 = GL.getICD().glRasterPos4iv;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(nArray, 4);
        }
    ...
    public static void glRasterPos4sv(@NativeType(value="GLshort const *") short[] sArray) {
        long l2 = GL.getICD().glRasterPos4sv;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(sArray, 4);
        }
    ...
    public static void glRasterPos4fv(@NativeType(value="GLfloat const *") float[] fArray) {
        long l2 = GL.getICD().glRasterPos4fv;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(fArray, 4);
        }
    ...
    public static void glRasterPos4dv(@NativeType(value="GLdouble const *") double[] dArray) {
        long l2 = GL.getICD().glRasterPos4dv;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(dArray, 4);
        }
    ...
    public static void glReadPixels(@NativeType(value="GLint") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLsizei") int n4, @NativeType(value="GLsizei") int n5, @NativeType(value="GLenum") int n6, @NativeType(value="GLenum") int n7, @NativeType(value="void *") short[] sArray) {
        GL11C.glReadPixels(n2, n3, n4, n5, n6, n7, sArray);
    }

    public static void glReadPixels(@NativeType(value="GLint") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLsizei") int n4, @NativeType(value="GLsizei") int n5, @NativeType(value="GLenum") int n6, @NativeType(value="GLenum") int n7, @NativeType(value="void *") int[] nArray) {
        GL11C.glReadPixels(n2, n3, n4, n5, n6, n7, nArray);
    }

    public static void glReadPixels(@NativeType(value="GLint") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLsizei") int n4, @NativeType(value="GLsizei") int n5, @NativeType(value="GLenum") int n6, @NativeType(value="GLenum") int n7, @NativeType(value="void *") float[] fArray) {
        GL11C.glReadPixels(n2, n3, n4, n5, n6, n7, fArray);
    }

    public static void glRectiv(@NativeType(value="GLint const *") int[] nArray, @NativeType(value="GLint const *") int[] nArray2) {
        long l2 = GL.getICD().glRectiv;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(nArray, 2);
    ...
    public static void glTexCoord1fv(@NativeType(value="GLfloat const *") float[] fArray) {
        long l2 = GL.getICD().glTexCoord1fv;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(fArray, 1);
        }
    ...
    public static void glTexCoord1sv(@NativeType(value="GLshort const *") short[] sArray) {
        long l2 = GL.getICD().glTexCoord1sv;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(sArray, 1);
        }
    ...
    public static void glTexCoord1iv(@NativeType(value="GLint const *") int[] nArray) {
        long l2 = GL.getICD().glTexCoord1iv;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(nArray, 1);
        }
    ...
    public static void glTexCoord1dv(@NativeType(value="GLdouble const *") double[] dArray) {
        long l2 = GL.getICD().glTexCoord1dv;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(dArray, 1);
        }
    ...
    public static void glTexCoord2fv(@NativeType(value="GLfloat const *") float[] fArray) {
        long l2 = GL.getICD().glTexCoord2fv;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(fArray, 2);
        }
    ...
    public static void glTexCoord2sv(@NativeType(value="GLshort const *") short[] sArray) {
        long l2 = GL.getICD().glTexCoord2sv;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(sArray, 2);
        }
    ...
    public static void glTexCoord2iv(@NativeType(value="GLint const *") int[] nArray) {
        long l2 = GL.getICD().glTexCoord2iv;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(nArray, 2);
        }
    ...
    public static void glTexCoord2dv(@NativeType(value="GLdouble const *") double[] dArray) {
        long l2 = GL.getICD().glTexCoord2dv;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(dArray, 2);
        }
    ...
    public static void glTexCoord3fv(@NativeType(value="GLfloat const *") float[] fArray) {
        long l2 = GL.getICD().glTexCoord3fv;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(fArray, 3);
        }
    ...
    public static void glTexCoord3sv(@NativeType(value="GLshort const *") short[] sArray) {
        long l2 = GL.getICD().glTexCoord3sv;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(sArray, 3);
        }
    ...
    public static void glTexCoord3iv(@NativeType(value="GLint const *") int[] nArray) {
        long l2 = GL.getICD().glTexCoord3iv;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(nArray, 3);
        }
    ...
    public static void glTexCoord3dv(@NativeType(value="GLdouble const *") double[] dArray) {
        long l2 = GL.getICD().glTexCoord3dv;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(dArray, 3);
        }
    ...
    public static void glTexCoord4fv(@NativeType(value="GLfloat const *") float[] fArray) {
        long l2 = GL.getICD().glTexCoord4fv;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(fArray, 4);
        }
    ...
    public static void glTexCoord4sv(@NativeType(value="GLshort const *") short[] sArray) {
        long l2 = GL.getICD().glTexCoord4sv;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(sArray, 4);
        }
    ...
    public static void glTexCoord4iv(@NativeType(value="GLint const *") int[] nArray) {
        long l2 = GL.getICD().glTexCoord4iv;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(nArray, 4);
        }
    ...
    public static void glTexCoord4dv(@NativeType(value="GLdouble const *") double[] dArray) {
        long l2 = GL.getICD().glTexCoord4dv;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(dArray, 4);
        }
    ...
    public static void glTexEnviv(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLint const *") int[] nArray) {
        long l2 = GL.getICD().glTexEnviv;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(nArray, 4);
        }
    ...
    public static void glTexEnvfv(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLfloat const *") float[] fArray) {
        long l2 = GL.getICD().glTexEnvfv;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(fArray, 4);
        }
    ...
    public static void glTexGeniv(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLint const *") int[] nArray) {
        long l2 = GL.getICD().glTexGeniv;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(nArray, 4);
        }
    ...
    public static void glTexGenfv(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLfloat const *") float[] fArray) {
        long l2 = GL.getICD().glTexGenfv;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(fArray, 4);
        }
    ...
    public static void glTexGendv(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLdouble const *") double[] dArray) {
        long l2 = GL.getICD().glTexGendv;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(dArray, 4);
        }
    ...
    public static void glTexImage1D(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLint") int n4, @NativeType(value="GLsizei") int n5, @NativeType(value="GLint") int n6, @NativeType(value="GLenum") int n7, @NativeType(value="GLenum") int n8, @Nullable @NativeType(value="void const *") short[] sArray) {
        GL11C.glTexImage1D(n2, n3, n4, n5, n6, n7, n8, sArray);
    }

    public static void glTexImage1D(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLint") int n4, @NativeType(value="GLsizei") int n5, @NativeType(value="GLint") int n6, @NativeType(value="GLenum") int n7, @NativeType(value="GLenum") int n8, @Nullable @NativeType(value="void const *") int[] nArray) {
        GL11C.glTexImage1D(n2, n3, n4, n5, n6, n7, n8, nArray);
    }

    public static void glTexImage1D(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLint") int n4, @NativeType(value="GLsizei") int n5, @NativeType(value="GLint") int n6, @NativeType(value="GLenum") int n7, @NativeType(value="GLenum") int n8, @Nullable @NativeType(value="void const *") float[] fArray) {
        GL11C.glTexImage1D(n2, n3, n4, n5, n6, n7, n8, fArray);
    }

    public static void glTexImage1D(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLint") int n4, @NativeType(value="GLsizei") int n5, @NativeType(value="GLint") int n6, @NativeType(value="GLenum") int n7, @NativeType(value="GLenum") int n8, @Nullable @NativeType(value="void const *") double[] dArray) {
        GL11C.glTexImage1D(n2, n3, n4, n5, n6, n7, n8, dArray);
    }

    public static void glTexImage2D(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLint") int n4, @NativeType(value="GLsizei") int n5, @NativeType(value="GLsizei") int n6, @NativeType(value="GLint") int n7, @NativeType(value="GLenum") int n8, @NativeType(value="GLenum") int n9, @Nullable @NativeType(value="void const *") short[] sArray) {
        GL11C.glTexImage2D(n2, n3, n4, n5, n6, n7, n8, n9, sArray);
    }

    public static void glTexImage2D(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLint") int n4, @NativeType(value="GLsizei") int n5, @NativeType(value="GLsizei") int n6, @NativeType(value="GLint") int n7, @NativeType(value="GLenum") int n8, @NativeType(value="GLenum") int n9, @Nullable @NativeType(value="void const *") int[] nArray) {
        GL11C.glTexImage2D(n2, n3, n4, n5, n6, n7, n8, n9, nArray);
    }

    public static void glTexImage2D(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLint") int n4, @NativeType(value="GLsizei") int n5, @NativeType(value="GLsizei") int n6, @NativeType(value="GLint") int n7, @NativeType(value="GLenum") int n8, @NativeType(value="GLenum") int n9, @Nullable @NativeType(value="void const *") float[] fArray) {
        GL11C.glTexImage2D(n2, n3, n4, n5, n6, n7, n8, n9, fArray);
    }

    public static void glTexImage2D(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLint") int n4, @NativeType(value="GLsizei") int n5, @NativeType(value="GLsizei") int n6, @NativeType(value="GLint") int n7, @NativeType(value="GLenum") int n8, @NativeType(value="GLenum") int n9, @Nullable @NativeType(value="void const *") double[] dArray) {
        GL11C.glTexImage2D(n2, n3, n4, n5, n6, n7, n8, n9, dArray);
    }

    public static void glTexParameteriv(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLint const *") int[] nArray) {
        GL11C.glTexParameteriv(n2, n3, nArray);
    }

    public static void glTexParameterfv(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLfloat const *") float[] fArray) {
        GL11C.glTexParameterfv(n2, n3, fArray);
    }

    public static void glTexSubImage1D(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLint") int n4, @NativeType(value="GLsizei") int n5, @NativeType(value="GLenum") int n6, @NativeType(value="GLenum") int n7, @NativeType(value="void const *") short[] sArray) {
        GL11C.glTexSubImage1D(n2, n3, n4, n5, n6, n7, sArray);
    }

    public static void glTexSubImage1D(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLint") int n4, @NativeType(value="GLsizei") int n5, @NativeType(value="GLenum") int n6, @NativeType(value="GLenum") int n7, @NativeType(value="void const *") int[] nArray) {
        GL11C.glTexSubImage1D(n2, n3, n4, n5, n6, n7, nArray);
    }

    public static void glTexSubImage1D(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLint") int n4, @NativeType(value="GLsizei") int n5, @NativeType(value="GLenum") int n6, @NativeType(value="GLenum") int n7, @NativeType(value="void const *") float[] fArray) {
        GL11C.glTexSubImage1D(n2, n3, n4, n5, n6, n7, fArray);
    }

    public static void glTexSubImage1D(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLint") int n4, @NativeType(value="GLsizei") int n5, @NativeType(value="GLenum") int n6, @NativeType(value="GLenum") int n7, @NativeType(value="void const *") double[] dArray) {
        GL11C.glTexSubImage1D(n2, n3, n4, n5, n6, n7, dArray);
    }

    public static void glTexSubImage2D(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLint") int n4, @NativeType(value="GLint") int n5, @NativeType(value="GLsizei") int n6, @NativeType(value="GLsizei") int n7, @NativeType(value="GLenum") int n8, @NativeType(value="GLenum") int n9, @NativeType(value="void const *") short[] sArray) {
        GL11C.glTexSubImage2D(n2, n3, n4, n5, n6, n7, n8, n9, sArray);
    }

    public static void glTexSubImage2D(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLint") int n4, @NativeType(value="GLint") int n5, @NativeType(value="GLsizei") int n6, @NativeType(value="GLsizei") int n7, @NativeType(value="GLenum") int n8, @NativeType(value="GLenum") int n9, @NativeType(value="void const *") int[] nArray) {
        GL11C.glTexSubImage2D(n2, n3, n4, n5, n6, n7, n8, n9, nArray);
    }

    public static void glTexSubImage2D(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLint") int n4, @NativeType(value="GLint") int n5, @NativeType(value="GLsizei") int n6, @NativeType(value="GLsizei") int n7, @NativeType(value="GLenum") int n8, @NativeType(value="GLenum") int n9, @NativeType(value="void const *") float[] fArray) {
        GL11C.glTexSubImage2D(n2, n3, n4, n5, n6, n7, n8, n9, fArray);
    }

    public static void glTexSubImage2D(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLint") int n4, @NativeType(value="GLint") int n5, @NativeType(value="GLsizei") int n6, @NativeType(value="GLsizei") int n7, @NativeType(value="GLenum") int n8, @NativeType(value="GLenum") int n9, @NativeType(value="void const *") double[] dArray) {
        GL11C.glTexSubImage2D(n2, n3, n4, n5, n6, n7, n8, n9, dArray);
    }

    public static void glVertex2fv(@NativeType(value="GLfloat const *") float[] fArray) {
        long l2 = GL.getICD().glVertex2fv;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(fArray, 2);
        }
