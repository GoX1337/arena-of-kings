...
public class NVPixelDataRange {
    ...
    public static void glPixelDataRangeNV(@NativeType(value="GLenum") int n2, @NativeType(value="void const *") ByteBuffer byteBuffer) {
        NVPixelDataRange.nglPixelDataRangeNV(n2, byteBuffer.remaining(), MemoryUtil.memAddress(byteBuffer));
    }
