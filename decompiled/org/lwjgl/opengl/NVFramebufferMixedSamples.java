...
public class NVFramebufferMixedSamples {
    ...
    public static void glRasterSamplesEXT(@NativeType(value="GLuint") int n2, @NativeType(value="GLboolean") boolean bl2) {
        EXTRasterMultisample.glRasterSamplesEXT(n2, bl2);
    }
    ...
    public static void glCoverageModulationTableNV(@NativeType(value="GLfloat const *") float[] fArray) {
        long l2 = GL.getICD().glCoverageModulationTableNV;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
    ...
    public static void glGetCoverageModulationTableNV(@NativeType(value="GLfloat *") float[] fArray) {
        long l2 = GL.getICD().glGetCoverageModulationTableNV;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        JNI.callPV(fArray.length, fArray, l2);
