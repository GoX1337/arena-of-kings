...
public class ARBGPUShaderFP64 {
    ...
    public static void glProgramUniform1dvEXT(@NativeType(value="GLuint") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLdouble const *") DoubleBuffer doubleBuffer) {
        ARBGPUShaderFP64.nglProgramUniform1dvEXT(n2, n3, doubleBuffer.remaining(), MemoryUtil.memAddress(doubleBuffer));
    }

    public static native void nglProgramUniform2dvEXT(int var0, int var1, int var2, long var3);

    public static void glProgramUniform2dvEXT(@NativeType(value="GLuint") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLdouble const *") DoubleBuffer doubleBuffer) {
        ARBGPUShaderFP64.nglProgramUniform2dvEXT(n2, n3, doubleBuffer.remaining() >> 1, MemoryUtil.memAddress(doubleBuffer));
    }

    public static native void nglProgramUniform3dvEXT(int var0, int var1, int var2, long var3);

    public static void glProgramUniform3dvEXT(@NativeType(value="GLuint") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLdouble const *") DoubleBuffer doubleBuffer) {
        ARBGPUShaderFP64.nglProgramUniform3dvEXT(n2, n3, doubleBuffer.remaining() / 3, MemoryUtil.memAddress(doubleBuffer));
    }

    public static native void nglProgramUniform4dvEXT(int var0, int var1, int var2, long var3);

    public static void glProgramUniform4dvEXT(@NativeType(value="GLuint") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLdouble const *") DoubleBuffer doubleBuffer) {
        ARBGPUShaderFP64.nglProgramUniform4dvEXT(n2, n3, doubleBuffer.remaining() >> 2, MemoryUtil.memAddress(doubleBuffer));
    }

    public static native void nglProgramUniformMatrix2dvEXT(int var0, int var1, int var2, boolean var3, long var4);

    public static void glProgramUniformMatrix2dvEXT(@NativeType(value="GLuint") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLboolean") boolean bl2, @NativeType(value="GLdouble const *") DoubleBuffer doubleBuffer) {
        ARBGPUShaderFP64.nglProgramUniformMatrix2dvEXT(n2, n3, doubleBuffer.remaining() >> 2, bl2, MemoryUtil.memAddress(doubleBuffer));
    }

    public static native void nglProgramUniformMatrix3dvEXT(int var0, int var1, int var2, boolean var3, long var4);

    public static void glProgramUniformMatrix3dvEXT(@NativeType(value="GLuint") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLboolean") boolean bl2, @NativeType(value="GLdouble const *") DoubleBuffer doubleBuffer) {
        ARBGPUShaderFP64.nglProgramUniformMatrix3dvEXT(n2, n3, doubleBuffer.remaining() / 9, bl2, MemoryUtil.memAddress(doubleBuffer));
    }

    public static native void nglProgramUniformMatrix4dvEXT(int var0, int var1, int var2, boolean var3, long var4);

    public static void glProgramUniformMatrix4dvEXT(@NativeType(value="GLuint") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLboolean") boolean bl2, @NativeType(value="GLdouble const *") DoubleBuffer doubleBuffer) {
        ARBGPUShaderFP64.nglProgramUniformMatrix4dvEXT(n2, n3, doubleBuffer.remaining() >> 4, bl2, MemoryUtil.memAddress(doubleBuffer));
    }

    public static native void nglProgramUniformMatrix2x3dvEXT(int var0, int var1, int var2, boolean var3, long var4);

    public static void glProgramUniformMatrix2x3dvEXT(@NativeType(value="GLuint") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLboolean") boolean bl2, @NativeType(value="GLdouble const *") DoubleBuffer doubleBuffer) {
        ARBGPUShaderFP64.nglProgramUniformMatrix2x3dvEXT(n2, n3, doubleBuffer.remaining() / 6, bl2, MemoryUtil.memAddress(doubleBuffer));
    }

    public static native void nglProgramUniformMatrix2x4dvEXT(int var0, int var1, int var2, boolean var3, long var4);

    public static void glProgramUniformMatrix2x4dvEXT(@NativeType(value="GLuint") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLboolean") boolean bl2, @NativeType(value="GLdouble const *") DoubleBuffer doubleBuffer) {
        ARBGPUShaderFP64.nglProgramUniformMatrix2x4dvEXT(n2, n3, doubleBuffer.remaining() >> 3, bl2, MemoryUtil.memAddress(doubleBuffer));
    }

    public static native void nglProgramUniformMatrix3x2dvEXT(int var0, int var1, int var2, boolean var3, long var4);

    public static void glProgramUniformMatrix3x2dvEXT(@NativeType(value="GLuint") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLboolean") boolean bl2, @NativeType(value="GLdouble const *") DoubleBuffer doubleBuffer) {
        ARBGPUShaderFP64.nglProgramUniformMatrix3x2dvEXT(n2, n3, doubleBuffer.remaining() / 6, bl2, MemoryUtil.memAddress(doubleBuffer));
    }

    public static native void nglProgramUniformMatrix3x4dvEXT(int var0, int var1, int var2, boolean var3, long var4);

    public static void glProgramUniformMatrix3x4dvEXT(@NativeType(value="GLuint") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLboolean") boolean bl2, @NativeType(value="GLdouble const *") DoubleBuffer doubleBuffer) {
        ARBGPUShaderFP64.nglProgramUniformMatrix3x4dvEXT(n2, n3, doubleBuffer.remaining() / 12, bl2, MemoryUtil.memAddress(doubleBuffer));
    }

    public static native void nglProgramUniformMatrix4x2dvEXT(int var0, int var1, int var2, boolean var3, long var4);

    public static void glProgramUniformMatrix4x2dvEXT(@NativeType(value="GLuint") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLboolean") boolean bl2, @NativeType(value="GLdouble const *") DoubleBuffer doubleBuffer) {
        ARBGPUShaderFP64.nglProgramUniformMatrix4x2dvEXT(n2, n3, doubleBuffer.remaining() >> 3, bl2, MemoryUtil.memAddress(doubleBuffer));
    }

    public static native void nglProgramUniformMatrix4x3dvEXT(int var0, int var1, int var2, boolean var3, long var4);

    public static void glProgramUniformMatrix4x3dvEXT(@NativeType(value="GLuint") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLboolean") boolean bl2, @NativeType(value="GLdouble const *") DoubleBuffer doubleBuffer) {
        ARBGPUShaderFP64.nglProgramUniformMatrix4x3dvEXT(n2, n3, doubleBuffer.remaining() / 12, bl2, MemoryUtil.memAddress(doubleBuffer));
    }
    ...
    public static void glProgramUniform1dvEXT(@NativeType(value="GLuint") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLdouble const *") double[] dArray) {
        long l2 = GL.getICD().glProgramUniform1dvEXT;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
    ...
    public static void glProgramUniform2dvEXT(@NativeType(value="GLuint") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLdouble const *") double[] dArray) {
        long l2 = GL.getICD().glProgramUniform2dvEXT;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
    ...
    public static void glProgramUniform3dvEXT(@NativeType(value="GLuint") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLdouble const *") double[] dArray) {
        long l2 = GL.getICD().glProgramUniform3dvEXT;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
    ...
    public static void glProgramUniform4dvEXT(@NativeType(value="GLuint") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLdouble const *") double[] dArray) {
        long l2 = GL.getICD().glProgramUniform4dvEXT;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
    ...
    public static void glProgramUniformMatrix2dvEXT(@NativeType(value="GLuint") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLboolean") boolean bl2, @NativeType(value="GLdouble const *") double[] dArray) {
        long l2 = GL.getICD().glProgramUniformMatrix2dvEXT;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
    ...
    public static void glProgramUniformMatrix3dvEXT(@NativeType(value="GLuint") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLboolean") boolean bl2, @NativeType(value="GLdouble const *") double[] dArray) {
        long l2 = GL.getICD().glProgramUniformMatrix3dvEXT;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
    ...
    public static void glProgramUniformMatrix4dvEXT(@NativeType(value="GLuint") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLboolean") boolean bl2, @NativeType(value="GLdouble const *") double[] dArray) {
        long l2 = GL.getICD().glProgramUniformMatrix4dvEXT;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
    ...
    public static void glProgramUniformMatrix2x3dvEXT(@NativeType(value="GLuint") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLboolean") boolean bl2, @NativeType(value="GLdouble const *") double[] dArray) {
        long l2 = GL.getICD().glProgramUniformMatrix2x3dvEXT;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
    ...
    public static void glProgramUniformMatrix2x4dvEXT(@NativeType(value="GLuint") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLboolean") boolean bl2, @NativeType(value="GLdouble const *") double[] dArray) {
        long l2 = GL.getICD().glProgramUniformMatrix2x4dvEXT;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
    ...
    public static void glProgramUniformMatrix3x2dvEXT(@NativeType(value="GLuint") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLboolean") boolean bl2, @NativeType(value="GLdouble const *") double[] dArray) {
        long l2 = GL.getICD().glProgramUniformMatrix3x2dvEXT;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        JNI.callPV(n2, n3, dArray.length / 6, bl2, dArray, l2);
    ...
    public static void glProgramUniformMatrix3x4dvEXT(@NativeType(value="GLuint") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLboolean") boolean bl2, @NativeType(value="GLdouble const *") double[] dArray) {
        long l2 = GL.getICD().glProgramUniformMatrix3x4dvEXT;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
    ...
    public static void glProgramUniformMatrix4x2dvEXT(@NativeType(value="GLuint") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLboolean") boolean bl2, @NativeType(value="GLdouble const *") double[] dArray) {
        long l2 = GL.getICD().glProgramUniformMatrix4x2dvEXT;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        JNI.callPV(n2, n3, dArray.length >> 3, bl2, dArray, l2);
    ...
    public static void glProgramUniformMatrix4x3dvEXT(@NativeType(value="GLuint") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLboolean") boolean bl2, @NativeType(value="GLdouble const *") double[] dArray) {
        long l2 = GL.getICD().glProgramUniformMatrix4x3dvEXT;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        JNI.callPV(n2, n3, dArray.length / 12, bl2, dArray, l2);
