...
public class ARBVertexBlend {
    ...
    public static void glWeightPointerARB(@NativeType(value="GLint") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLsizei") int n4, @NativeType(value="void const *") ByteBuffer byteBuffer) {
        ARBVertexBlend.nglWeightPointerARB(n2, n3, n4, MemoryUtil.memAddress(byteBuffer));
    }

    public static void glWeightPointerARB(@NativeType(value="GLint") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLsizei") int n4, @NativeType(value="void const *") long l2) {
        ARBVertexBlend.nglWeightPointerARB(n2, n3, n4, l2);
    }

    public static void glWeightPointerARB(@NativeType(value="GLint") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLsizei") int n4, @NativeType(value="void const *") ShortBuffer shortBuffer) {
        ARBVertexBlend.nglWeightPointerARB(n2, n3, n4, MemoryUtil.memAddress(shortBuffer));
    }

    public static void glWeightPointerARB(@NativeType(value="GLint") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLsizei") int n4, @NativeType(value="void const *") IntBuffer intBuffer) {
        ARBVertexBlend.nglWeightPointerARB(n2, n3, n4, MemoryUtil.memAddress(intBuffer));
    }

    public static void glWeightPointerARB(@NativeType(value="GLint") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLsizei") int n4, @NativeType(value="void const *") FloatBuffer floatBuffer) {
        ARBVertexBlend.nglWeightPointerARB(n2, n3, n4, MemoryUtil.memAddress(floatBuffer));
    }
    ...
    public static void glWeightfvARB(@NativeType(value="GLfloat *") float[] fArray) {
        long l2 = GL.getICD().glWeightfvARB;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        JNI.callPV(fArray.length, fArray, l2);
    }

    public static void glWeightsvARB(@NativeType(value="GLshort *") short[] sArray) {
        long l2 = GL.getICD().glWeightsvARB;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
    ...
    public static void glWeightusvARB(@NativeType(value="GLushort *") short[] sArray) {
        long l2 = GL.getICD().glWeightusvARB;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        JNI.callPV(sArray.length, sArray, l2);
    ...
    public static void glWeightivARB(@NativeType(value="GLint *") int[] nArray) {
        long l2 = GL.getICD().glWeightivARB;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
    ...
    public static void glWeightuivARB(@NativeType(value="GLuint *") int[] nArray) {
        long l2 = GL.getICD().glWeightuivARB;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        JNI.callPV(nArray.length, nArray, l2);
    ...
    public static void glWeightdvARB(@NativeType(value="GLdouble *") double[] dArray) {
        long l2 = GL.getICD().glWeightdvARB;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        JNI.callPV(dArray.length, dArray, l2);
    }

    public static void glWeightPointerARB(@NativeType(value="GLint") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLsizei") int n4, @NativeType(value="void const *") short[] sArray) {
        long l2 = GL.getICD().glWeightPointerARB;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
    ...
    public static void glWeightPointerARB(@NativeType(value="GLint") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLsizei") int n4, @NativeType(value="void const *") int[] nArray) {
        long l2 = GL.getICD().glWeightPointerARB;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
    ...
    public static void glWeightPointerARB(@NativeType(value="GLint") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLsizei") int n4, @NativeType(value="void const *") float[] fArray) {
        long l2 = GL.getICD().glWeightPointerARB;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
