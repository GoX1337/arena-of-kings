...
public class NVQueryResource {
    ...
    public static int glQueryResourceNV(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLint *") IntBuffer intBuffer) {
        return NVQueryResource.nglQueryResourceNV(n2, n3, intBuffer.remaining(), MemoryUtil.memAddress(intBuffer));
    }

    @NativeType(value="GLint")
    public static int glQueryResourceNV(@NativeType(value="GLenum") int n2, @NativeType(value="GLint") int n3, @NativeType(value="GLint *") int[] nArray) {
        long l2 = GL.getICD().glQueryResourceNV;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        return JNI.callPI(n2, n3, nArray.length, nArray, l2);
    }
