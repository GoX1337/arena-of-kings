...
public class EXTFramebufferObject {
     ...
     */
    public static void glDeleteRenderbuffersEXT(@NativeType(value="GLuint const *") int n2) {
    ...
    public static void glGetRenderbufferParameterivEXT(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLint *") IntBuffer intBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)intBuffer, 1);
        }
        EXTFramebufferObject.nglGetRenderbufferParameterivEXT(n2, n3, MemoryUtil.memAddress(intBuffer));
    }
     ...
     */
    @NativeType(value="void")
    public static int glGetRenderbufferParameteriEXT(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3) {
        MemoryStack memoryStack = MemoryStack.stackGet();
     ...
     * WARNING - Removed try catching itself - possible behaviour change.
     */
    public static void glDeleteFramebuffersEXT(@NativeType(value="GLuint const *") int n2) {
        MemoryStack memoryStack = MemoryStack.stackGet();
        int n3 = memoryStack.getPointer();
        try {
            IntBuffer intBuffer = memoryStack.ints(n2);
    ...
    public static void glGetFramebufferAttachmentParameterivEXT(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLenum") int n4, @NativeType(value="GLint *") IntBuffer intBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)intBuffer, 1);
        }
        EXTFramebufferObject.nglGetFramebufferAttachmentParameterivEXT(n2, n3, n4, MemoryUtil.memAddress(intBuffer));
    }
     ...
     */
    @NativeType(value="void")
    public static int glGetFramebufferAttachmentParameteriEXT(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLenum") int n4) {
        MemoryStack memoryStack = MemoryStack.stackGet();
    ...
    public static void glDeleteRenderbuffersEXT(@NativeType(value="GLuint const *") int[] nArray) {
        long l2 = GL.getICD().glDeleteRenderbuffersEXT;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
    ...
    public static void glGenRenderbuffersEXT(@NativeType(value="GLuint *") int[] nArray) {
        long l2 = GL.getICD().glGenRenderbuffersEXT;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        JNI.callPV(nArray.length, nArray, l2);
    ...
    public static void glGetRenderbufferParameterivEXT(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLint *") int[] nArray) {
        long l2 = GL.getICD().glGetRenderbufferParameterivEXT;
        if (Checks.CHECKS) {
            Checks.check(l2);
    ...
    public static void glDeleteFramebuffersEXT(@NativeType(value="GLuint const *") int[] nArray) {
        long l2 = GL.getICD().glDeleteFramebuffersEXT;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        JNI.callPV(nArray.length, nArray, l2);
    ...
    public static void glGenFramebuffersEXT(@NativeType(value="GLuint *") int[] nArray) {
        long l2 = GL.getICD().glGenFramebuffersEXT;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        JNI.callPV(nArray.length, nArray, l2);
    ...
    public static void glGetFramebufferAttachmentParameterivEXT(@NativeType(value="GLenum") int n2, @NativeType(value="GLenum") int n3, @NativeType(value="GLenum") int n4, @NativeType(value="GLint *") int[] nArray) {
        long l2 = GL.getICD().glGetFramebufferAttachmentParameterivEXT;
        if (Checks.CHECKS) {
            Checks.check(l2);
            Checks.check(nArray, 1);
        }
