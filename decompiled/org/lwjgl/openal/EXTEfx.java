...
public class EXTEfx {
    ...
    public static void nalGenEffects(int n2, long l2) {
        long l3 = AL.getICD().alGenEffects;
        if (Checks.CHECKS) {
            Checks.check(l3);
        }
    ...
    public static void nalDeleteEffects(int n2, long l2) {
        long l3 = AL.getICD().alDeleteEffects;
        if (Checks.CHECKS) {
            Checks.check(l3);
        }
        JNI.invokePV(n2, l2, l3);
     ...
     */
    @NativeType(value="ALvoid")
    public static void alDeleteEffects(@NativeType(value="ALuint *") int n2) {
        MemoryStack memoryStack = MemoryStack.stackGet();
    ...
    public static boolean alIsEffect(@NativeType(value="ALuint") int n2) {
        long l2 = AL.getICD().alIsEffect;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
    ...
    @NativeType(value="ALvoid")
    public static void alEffecti(@NativeType(value="ALuint") int n2, @NativeType(value="ALenum") int n3, @NativeType(value="ALint") int n4) {
        long l2 = AL.getICD().alEffecti;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
    ...
    public static void nalEffectiv(int n2, int n3, long l2) {
        long l3 = AL.getICD().alEffectiv;
        if (Checks.CHECKS) {
            Checks.check(l3);
        }
    ...
    @NativeType(value="ALvoid")
    public static void alEffectiv(@NativeType(value="ALuint") int n2, @NativeType(value="ALenum") int n3, @NativeType(value="ALint const *") IntBuffer intBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)intBuffer, 1);
        }
        EXTEfx.nalEffectiv(n2, n3, MemoryUtil.memAddress(intBuffer));
    }

    @NativeType(value="ALvoid")
    public static void alEffectf(@NativeType(value="ALuint") int n2, @NativeType(value="ALenum") int n3, @NativeType(value="ALfloat") float f2) {
        long l2 = AL.getICD().alEffectf;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
    ...
    public static void nalEffectfv(int n2, int n3, long l2) {
        long l3 = AL.getICD().alEffectfv;
        if (Checks.CHECKS) {
            Checks.check(l3);
        }
        JNI.invokePV(n2, n3, l2, l3);
    ...
    @NativeType(value="ALvoid")
    public static void alEffectfv(@NativeType(value="ALuint") int n2, @NativeType(value="ALenum") int n3, @NativeType(value="ALfloat const *") FloatBuffer floatBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)floatBuffer, 1);
        }
        EXTEfx.nalEffectfv(n2, n3, MemoryUtil.memAddress(floatBuffer));
    }

    public static void nalGetEffecti(int n2, int n3, long l2) {
        long l3 = AL.getICD().alGetEffecti;
        if (Checks.CHECKS) {
            Checks.check(l3);
        }
        JNI.invokePV(n2, n3, l2, l3);
    ...
    @NativeType(value="ALvoid")
    public static void alGetEffecti(@NativeType(value="ALuint") int n2, @NativeType(value="ALenum") int n3, @NativeType(value="ALint *") IntBuffer intBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)intBuffer, 1);
        }
        EXTEfx.nalGetEffecti(n2, n3, MemoryUtil.memAddress(intBuffer));
    }
     ...
     */
    @NativeType(value="ALvoid")
    public static int alGetEffecti(@NativeType(value="ALuint") int n2, @NativeType(value="ALenum") int n3) {
        MemoryStack memoryStack = MemoryStack.stackGet();
    ...
    public static void nalGetEffectiv(int n2, int n3, long l2) {
        long l3 = AL.getICD().alGetEffectiv;
        if (Checks.CHECKS) {
            Checks.check(l3);
        }
        JNI.invokePV(n2, n3, l2, l3);
    ...
    @NativeType(value="ALvoid")
    public static void alGetEffectiv(@NativeType(value="ALuint") int n2, @NativeType(value="ALenum") int n3, @NativeType(value="ALint *") IntBuffer intBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)intBuffer, 1);
        }
        EXTEfx.nalGetEffectiv(n2, n3, MemoryUtil.memAddress(intBuffer));
    }

    public static void nalGetEffectf(int n2, int n3, long l2) {
        long l3 = AL.getICD().alGetEffectf;
        if (Checks.CHECKS) {
            Checks.check(l3);
        }
        JNI.invokePV(n2, n3, l2, l3);
    ...
    @NativeType(value="ALvoid")
    public static void alGetEffectf(@NativeType(value="ALuint") int n2, @NativeType(value="ALenum") int n3, @NativeType(value="ALfloat *") FloatBuffer floatBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)floatBuffer, 1);
        }
        EXTEfx.nalGetEffectf(n2, n3, MemoryUtil.memAddress(floatBuffer));
    }
     ...
     */
    @NativeType(value="ALvoid")
    public static float alGetEffectf(@NativeType(value="ALuint") int n2, @NativeType(value="ALenum") int n3) {
        MemoryStack memoryStack = MemoryStack.stackGet();
        int n4 = memoryStack.getPointer();
        try {
    ...
    public static void nalGetEffectfv(int n2, int n3, long l2) {
        long l3 = AL.getICD().alGetEffectfv;
        if (Checks.CHECKS) {
            Checks.check(l3);
        }
        JNI.invokePV(n2, n3, l2, l3);
    ...
    @NativeType(value="ALvoid")
    public static void alGetEffectfv(@NativeType(value="ALuint") int n2, @NativeType(value="ALenum") int n3, @NativeType(value="ALfloat *") FloatBuffer floatBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)floatBuffer, 1);
        }
        EXTEfx.nalGetEffectfv(n2, n3, MemoryUtil.memAddress(floatBuffer));
    }

    public static void nalGenFilters(int n2, long l2) {
        long l3 = AL.getICD().alGenFilters;
        if (Checks.CHECKS) {
            Checks.check(l3);
        }
        JNI.invokePV(n2, l2, l3);
    ...
    public static void nalDeleteFilters(int n2, long l2) {
        long l3 = AL.getICD().alDeleteFilters;
        if (Checks.CHECKS) {
            Checks.check(l3);
        }
        JNI.invokePV(n2, l2, l3);
     ...
     */
    @NativeType(value="ALvoid")
    public static void alDeleteFilters(@NativeType(value="ALuint *") int n2) {
        MemoryStack memoryStack = MemoryStack.stackGet();
        int n3 = memoryStack.getPointer();
        try {
            IntBuffer intBuffer = memoryStack.ints(n2);
    ...
    @NativeType(value="ALboolean")
    public static boolean alIsFilter(@NativeType(value="ALuint") int n2) {
        long l2 = AL.getICD().alIsFilter;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        return JNI.invokeZ(n2, l2);
    ...
    @NativeType(value="ALvoid")
    public static void alFilteri(@NativeType(value="ALuint") int n2, @NativeType(value="ALenum") int n3, @NativeType(value="ALint") int n4) {
        long l2 = AL.getICD().alFilteri;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        JNI.invokeV(n2, n3, n4, l2);
    ...
    public static void nalFilteriv(int n2, int n3, long l2) {
        long l3 = AL.getICD().alFilteriv;
        if (Checks.CHECKS) {
            Checks.check(l3);
        }
        JNI.invokePV(n2, n3, l2, l3);
    ...
    @NativeType(value="ALvoid")
    public static void alFilteriv(@NativeType(value="ALuint") int n2, @NativeType(value="ALenum") int n3, @NativeType(value="ALint const *") IntBuffer intBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)intBuffer, 1);
        }
        EXTEfx.nalFilteriv(n2, n3, MemoryUtil.memAddress(intBuffer));
    }

    @NativeType(value="ALvoid")
    public static void alFilterf(@NativeType(value="ALuint") int n2, @NativeType(value="ALenum") int n3, @NativeType(value="ALfloat") float f2) {
        long l2 = AL.getICD().alFilterf;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        JNI.invokeV(n2, n3, f2, l2);
    ...
    public static void nalFilterfv(int n2, int n3, long l2) {
        long l3 = AL.getICD().alFilterfv;
        if (Checks.CHECKS) {
            Checks.check(l3);
        }
        JNI.invokePV(n2, n3, l2, l3);
    ...
    @NativeType(value="ALvoid")
    public static void alFilterfv(@NativeType(value="ALuint") int n2, @NativeType(value="ALenum") int n3, @NativeType(value="ALfloat const *") FloatBuffer floatBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)floatBuffer, 1);
        }
        EXTEfx.nalFilterfv(n2, n3, MemoryUtil.memAddress(floatBuffer));
    }

    public static void nalGetFilteri(int n2, int n3, long l2) {
        long l3 = AL.getICD().alGetFilteri;
        if (Checks.CHECKS) {
            Checks.check(l3);
        }
        JNI.invokePV(n2, n3, l2, l3);
    ...
    @NativeType(value="ALvoid")
    public static void alGetFilteri(@NativeType(value="ALuint") int n2, @NativeType(value="ALenum") int n3, @NativeType(value="ALint *") IntBuffer intBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)intBuffer, 1);
        }
        EXTEfx.nalGetFilteri(n2, n3, MemoryUtil.memAddress(intBuffer));
    }
     ...
     */
    @NativeType(value="ALvoid")
    public static int alGetFilteri(@NativeType(value="ALuint") int n2, @NativeType(value="ALenum") int n3) {
        MemoryStack memoryStack = MemoryStack.stackGet();
        int n4 = memoryStack.getPointer();
        try {
            IntBuffer intBuffer = memoryStack.callocInt(1);
    ...
    public static void nalGetFilteriv(int n2, int n3, long l2) {
        long l3 = AL.getICD().alGetFilteriv;
        if (Checks.CHECKS) {
            Checks.check(l3);
        }
        JNI.invokePV(n2, n3, l2, l3);
    ...
    @NativeType(value="ALvoid")
    public static void alGetFilteriv(@NativeType(value="ALuint") int n2, @NativeType(value="ALenum") int n3, @NativeType(value="ALint *") IntBuffer intBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)intBuffer, 1);
        }
        EXTEfx.nalGetFilteriv(n2, n3, MemoryUtil.memAddress(intBuffer));
    }

    public static void nalGetFilterf(int n2, int n3, long l2) {
        long l3 = AL.getICD().alGetFilterf;
        if (Checks.CHECKS) {
            Checks.check(l3);
        }
        JNI.invokePV(n2, n3, l2, l3);
    ...
    @NativeType(value="ALvoid")
    public static void alGetFilterf(@NativeType(value="ALuint") int n2, @NativeType(value="ALenum") int n3, @NativeType(value="ALfloat *") FloatBuffer floatBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)floatBuffer, 1);
        }
        EXTEfx.nalGetFilterf(n2, n3, MemoryUtil.memAddress(floatBuffer));
    }
     ...
     */
    @NativeType(value="ALvoid")
    public static float alGetFilterf(@NativeType(value="ALuint") int n2, @NativeType(value="ALenum") int n3) {
        MemoryStack memoryStack = MemoryStack.stackGet();
        int n4 = memoryStack.getPointer();
        try {
            FloatBuffer floatBuffer = memoryStack.callocFloat(1);
    ...
    public static void nalGetFilterfv(int n2, int n3, long l2) {
        long l3 = AL.getICD().alGetFilterfv;
        if (Checks.CHECKS) {
            Checks.check(l3);
        }
        JNI.invokePV(n2, n3, l2, l3);
    ...
    @NativeType(value="ALvoid")
    public static void alGetFilterfv(@NativeType(value="ALuint") int n2, @NativeType(value="ALenum") int n3, @NativeType(value="ALfloat *") FloatBuffer floatBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)floatBuffer, 1);
        }
        EXTEfx.nalGetFilterfv(n2, n3, MemoryUtil.memAddress(floatBuffer));
    }

    public static void nalGenAuxiliaryEffectSlots(int n2, long l2) {
        long l3 = AL.getICD().alGenAuxiliaryEffectSlots;
        if (Checks.CHECKS) {
            Checks.check(l3);
        }
        JNI.invokePV(n2, l2, l3);
    ...
    public static void nalDeleteAuxiliaryEffectSlots(int n2, long l2) {
        long l3 = AL.getICD().alDeleteAuxiliaryEffectSlots;
        if (Checks.CHECKS) {
            Checks.check(l3);
        }
        JNI.invokePV(n2, l2, l3);
     ...
     */
    @NativeType(value="ALvoid")
    public static void alDeleteAuxiliaryEffectSlots(@NativeType(value="ALuint *") int n2) {
        MemoryStack memoryStack = MemoryStack.stackGet();
        int n3 = memoryStack.getPointer();
        try {
            IntBuffer intBuffer = memoryStack.ints(n2);
    ...
    @NativeType(value="ALboolean")
    public static boolean alIsAuxiliaryEffectSlot(@NativeType(value="ALuint") int n2) {
        long l2 = AL.getICD().alIsAuxiliaryEffectSlot;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        return JNI.invokeZ(n2, l2);
    ...
    @NativeType(value="ALvoid")
    public static void alAuxiliaryEffectSloti(@NativeType(value="ALuint") int n2, @NativeType(value="ALenum") int n3, @NativeType(value="ALint") int n4) {
        long l2 = AL.getICD().alAuxiliaryEffectSloti;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        JNI.invokeV(n2, n3, n4, l2);
    ...
    public static void nalAuxiliaryEffectSlotiv(int n2, int n3, long l2) {
        long l3 = AL.getICD().alAuxiliaryEffectSlotiv;
        if (Checks.CHECKS) {
            Checks.check(l3);
        }
        JNI.invokePV(n2, n3, l2, l3);
    ...
    @NativeType(value="ALvoid")
    public static void alAuxiliaryEffectSlotiv(@NativeType(value="ALuint") int n2, @NativeType(value="ALenum") int n3, @NativeType(value="ALint const *") IntBuffer intBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)intBuffer, 1);
        }
        EXTEfx.nalAuxiliaryEffectSlotiv(n2, n3, MemoryUtil.memAddress(intBuffer));
    }

    @NativeType(value="ALvoid")
    public static void alAuxiliaryEffectSlotf(@NativeType(value="ALuint") int n2, @NativeType(value="ALenum") int n3, @NativeType(value="ALfloat") float f2) {
        long l2 = AL.getICD().alAuxiliaryEffectSlotf;
        if (Checks.CHECKS) {
            Checks.check(l2);
        }
        JNI.invokeV(n2, n3, f2, l2);
    ...
    public static void nalAuxiliaryEffectSlotfv(int n2, int n3, long l2) {
        long l3 = AL.getICD().alAuxiliaryEffectSlotfv;
        if (Checks.CHECKS) {
            Checks.check(l3);
        }
        JNI.invokePV(n2, n3, l2, l3);
    ...
    @NativeType(value="ALvoid")
    public static void alAuxiliaryEffectSlotfv(@NativeType(value="ALuint") int n2, @NativeType(value="ALenum") int n3, @NativeType(value="ALfloat const *") FloatBuffer floatBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)floatBuffer, 1);
        }
        EXTEfx.nalAuxiliaryEffectSlotfv(n2, n3, MemoryUtil.memAddress(floatBuffer));
    }

    public static void nalGetAuxiliaryEffectSloti(int n2, int n3, long l2) {
        long l3 = AL.getICD().alGetAuxiliaryEffectSloti;
        if (Checks.CHECKS) {
            Checks.check(l3);
        }
        JNI.invokePV(n2, n3, l2, l3);
    ...
    @NativeType(value="ALvoid")
    public static void alGetAuxiliaryEffectSloti(@NativeType(value="ALuint") int n2, @NativeType(value="ALenum") int n3, @NativeType(value="ALint *") IntBuffer intBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)intBuffer, 1);
        }
        EXTEfx.nalGetAuxiliaryEffectSloti(n2, n3, MemoryUtil.memAddress(intBuffer));
    }
     ...
     */
    @NativeType(value="ALvoid")
    public static int alGetAuxiliaryEffectSloti(@NativeType(value="ALuint") int n2, @NativeType(value="ALenum") int n3) {
        MemoryStack memoryStack = MemoryStack.stackGet();
        int n4 = memoryStack.getPointer();
        try {
            IntBuffer intBuffer = memoryStack.callocInt(1);
    ...
    public static void nalGetAuxiliaryEffectSlotiv(int n2, int n3, long l2) {
        long l3 = AL.getICD().alGetAuxiliaryEffectSlotiv;
        if (Checks.CHECKS) {
            Checks.check(l3);
        }
        JNI.invokePV(n2, n3, l2, l3);
    ...
    @NativeType(value="ALvoid")
    public static void alGetAuxiliaryEffectSlotiv(@NativeType(value="ALuint") int n2, @NativeType(value="ALenum") int n3, @NativeType(value="ALint *") IntBuffer intBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)intBuffer, 1);
        }
        EXTEfx.nalGetAuxiliaryEffectSlotiv(n2, n3, MemoryUtil.memAddress(intBuffer));
    }

    public static void nalGetAuxiliaryEffectSlotf(int n2, int n3, long l2) {
        long l3 = AL.getICD().alGetAuxiliaryEffectSlotf;
        if (Checks.CHECKS) {
            Checks.check(l3);
        }
        JNI.invokePV(n2, n3, l2, l3);
    ...
    @NativeType(value="ALvoid")
    public static void alGetAuxiliaryEffectSlotf(@NativeType(value="ALuint") int n2, @NativeType(value="ALenum") int n3, @NativeType(value="ALfloat *") FloatBuffer floatBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)floatBuffer, 1);
        }
        EXTEfx.nalGetAuxiliaryEffectSlotf(n2, n3, MemoryUtil.memAddress(floatBuffer));
    }
     ...
     */
    @NativeType(value="ALvoid")
    public static float alGetAuxiliaryEffectSlotf(@NativeType(value="ALuint") int n2, @NativeType(value="ALenum") int n3) {
        MemoryStack memoryStack = MemoryStack.stackGet();
        int n4 = memoryStack.getPointer();
        try {
            FloatBuffer floatBuffer = memoryStack.callocFloat(1);
    ...
    public static void nalGetAuxiliaryEffectSlotfv(int n2, int n3, long l2) {
        long l3 = AL.getICD().alGetAuxiliaryEffectSlotfv;
        if (Checks.CHECKS) {
            Checks.check(l3);
        }
        JNI.invokePV(n2, n3, l2, l3);
    ...
    @NativeType(value="ALvoid")
    public static void alGetAuxiliaryEffectSlotfv(@NativeType(value="ALuint") int n2, @NativeType(value="ALenum") int n3, @NativeType(value="ALfloat *") FloatBuffer floatBuffer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)floatBuffer, 1);
        }
        EXTEfx.nalGetAuxiliaryEffectSlotfv(n2, n3, MemoryUtil.memAddress(floatBuffer));
    }
    ...
    @NativeType(value="ALvoid")
    public static void alEffectiv(@NativeType(value="ALuint") int n2, @NativeType(value="ALenum") int n3, @NativeType(value="ALint const *") int[] nArray) {
    ...
    @NativeType(value="ALvoid")
    public static void alEffectfv(@NativeType(value="ALuint") int n2, @NativeType(value="ALenum") int n3, @NativeType(value="ALfloat const *") float[] fArray) {
    ...
    @NativeType(value="ALvoid")
    public static void alGetEffecti(@NativeType(value="ALuint") int n2, @NativeType(value="ALenum") int n3, @NativeType(value="ALint *") int[] nArray) {
    ...
    @NativeType(value="ALvoid")
    public static void alGetEffectiv(@NativeType(value="ALuint") int n2, @NativeType(value="ALenum") int n3, @NativeType(value="ALint *") int[] nArray) {
    ...
    @NativeType(value="ALvoid")
    public static void alGetEffectf(@NativeType(value="ALuint") int n2, @NativeType(value="ALenum") int n3, @NativeType(value="ALfloat *") float[] fArray) {
    ...
    @NativeType(value="ALvoid")
    public static void alGetEffectfv(@NativeType(value="ALuint") int n2, @NativeType(value="ALenum") int n3, @NativeType(value="ALfloat *") float[] fArray) {
    ...
    @NativeType(value="ALvoid")
    public static void alFilteriv(@NativeType(value="ALuint") int n2, @NativeType(value="ALenum") int n3, @NativeType(value="ALint const *") int[] nArray) {
    ...
    @NativeType(value="ALvoid")
    public static void alFilterfv(@NativeType(value="ALuint") int n2, @NativeType(value="ALenum") int n3, @NativeType(value="ALfloat const *") float[] fArray) {
    ...
    @NativeType(value="ALvoid")
    public static void alGetFilteri(@NativeType(value="ALuint") int n2, @NativeType(value="ALenum") int n3, @NativeType(value="ALint *") int[] nArray) {
    ...
    @NativeType(value="ALvoid")
    public static void alGetFilteriv(@NativeType(value="ALuint") int n2, @NativeType(value="ALenum") int n3, @NativeType(value="ALint *") int[] nArray) {
    ...
    @NativeType(value="ALvoid")
    public static void alGetFilterf(@NativeType(value="ALuint") int n2, @NativeType(value="ALenum") int n3, @NativeType(value="ALfloat *") float[] fArray) {
    ...
    @NativeType(value="ALvoid")
    public static void alGetFilterfv(@NativeType(value="ALuint") int n2, @NativeType(value="ALenum") int n3, @NativeType(value="ALfloat *") float[] fArray) {
    ...
    @NativeType(value="ALvoid")
    public static void alAuxiliaryEffectSlotiv(@NativeType(value="ALuint") int n2, @NativeType(value="ALenum") int n3, @NativeType(value="ALint const *") int[] nArray) {
    ...
    @NativeType(value="ALvoid")
    public static void alAuxiliaryEffectSlotfv(@NativeType(value="ALuint") int n2, @NativeType(value="ALenum") int n3, @NativeType(value="ALfloat const *") float[] fArray) {
    ...
    @NativeType(value="ALvoid")
    public static void alGetAuxiliaryEffectSloti(@NativeType(value="ALuint") int n2, @NativeType(value="ALenum") int n3, @NativeType(value="ALint *") int[] nArray) {
    ...
    @NativeType(value="ALvoid")
    public static void alGetAuxiliaryEffectSlotiv(@NativeType(value="ALuint") int n2, @NativeType(value="ALenum") int n3, @NativeType(value="ALint *") int[] nArray) {
    ...
    @NativeType(value="ALvoid")
    public static void alGetAuxiliaryEffectSlotf(@NativeType(value="ALuint") int n2, @NativeType(value="ALenum") int n3, @NativeType(value="ALfloat *") float[] fArray) {
    ...
    @NativeType(value="ALvoid")
    public static void alGetAuxiliaryEffectSlotfv(@NativeType(value="ALuint") int n2, @NativeType(value="ALenum") int n3, @NativeType(value="ALfloat *") float[] fArray) {
