...
public class DateUtils {
    ...
    private static Date parseDateWithLeniency(String string, Locale locale, String[] stringArray, boolean bl2) {
    ...
    public static Date round(Date date, int n2) {
        ...
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(date);
        DateUtils.modify(calendar, n2, ModifyType.ROUND);
        return calendar.getTime();
    }
    ...
    public static Calendar round(Calendar calendar, int n2) {
        ...
        DateUtils.modify(calendar2, n2, ModifyType.ROUND);
        return calendar2;
    }
    ...
    public static Date truncate(Date date, int n2) {
        ...
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(date);
        DateUtils.modify(calendar, n2, ModifyType.TRUNCATE);
        return calendar.getTime();
    }
    ...
    public static Calendar truncate(Calendar calendar, int n2) {
        ...
        Calendar calendar2 = (Calendar)calendar.clone();
        DateUtils.modify(calendar2, n2, ModifyType.TRUNCATE);
        return calendar2;
    }
    ...
    public static Date ceiling(Date date, int n2) {
        ...
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(date);
        DateUtils.modify(calendar, n2, ModifyType.CEILING);
        return calendar.getTime();
    }
    ...
    public static Calendar ceiling(Calendar calendar, int n2) {
        ...
        Calendar calendar2 = (Calendar)calendar.clone();
        DateUtils.modify(calendar2, n2, ModifyType.CEILING);
        return calendar2;
    }
    ...
    private static void modify(Calendar calendar, int n2, ModifyType modifyType) {
