...
implements ExceptionContext {
    ...
    public ContextedException(String string) {
        super(string);
        this.exceptionContext = new DefaultExceptionContext();
    }
    ...
    public ContextedException(String string, Throwable throwable) {
        super(string, throwable);
        this.exceptionContext = new DefaultExceptionContext();
    }

    public ContextedException(String string, Throwable throwable, ExceptionContext exceptionContext) {
        super(string, throwable);
    ...
    @Override
    public ContextedException addContextValue(String string, Object object) {
        this.exceptionContext.addContextValue(string, object);
        return this;
    }

    @Override
    public ContextedException setContextValue(String string, Object object) {
