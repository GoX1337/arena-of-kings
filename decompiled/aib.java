...
extends aie {
    ...
    public aib(Engine engine, String string, Color color, boolean bl2, float f2, float f3) {
        ...
        if (bl2) {
            ...
            this.f = 0.1f;
            this.var_axy_a.a().getData().setScale(this.f);
            this.var_axy_a.a().getColor().set(this.var_axy_a.a().getColor().r, this.var_axy_a.a().getColor().g, this.var_axy_a.a().getColor().b, 0.0f);
            this.var_com_badlogic_gdx_graphics_Color_a.set(0.0f, 0.0f, 0.0f, this.var_axy_a.a().getColor().a);
        } else {
            this.f = 0.1f;
            this.var_axy_a.a().getData().setScale(this.f);
            this.var_com_badlogic_gdx_graphics_g2d_GlyphLayout_a = new azv(1500L, true);
        }
        this.b = (Color)MathUtils.randomBoolean();
    }

    @Override
    public void a(float f2, Engine engine) {
        this.e += f2;
        Engine.a("Elapsed: " + this.e + " Delta: " + f2 + " Scale: " + this.var_axy_a.a().getScaleX() + " Alpha: " + this.var_axy_a.a().getColor().a);
        if (this.var_com_badlogic_gdx_graphics_g2d_GlyphLayout_a != false) {
            if (this.e < 0.05f) {
                this.f += f2 * 2.0f;
            } else if (this.e < 0.15f) {
                this.f += f2 * 6.0f;
            } else if (this.e < 0.25f) {
                this.f += f2 * 12.0f;
            } else if (this.e < 0.325f) {
                this.f -= f2 * 14.0f;
            }
            if (this.e < 0.125f) {
                if (this.e < 0.5f) {
                    Engine.a("1: scale: " + this.var_axy_a.a().getScaleX());
                    this.var_com_badlogic_gdx_graphics_Color_a.set(0.0f, 0.0f, 0.0f, this.var_axy_a.a().getColor().a);
                } else {
                    Engine.a("2: scale: " + this.var_axy_a.a().getScaleX());
                    this.var_com_badlogic_gdx_graphics_Color_a.set(0.0f, 0.0f, 0.0f, this.var_axy_a.a().getColor().a);
                }
            } else if (this.e >= 0.25f && this.e < 0.75f) {
                Engine.a("5: scale: " + this.var_axy_a.a().getScaleX());
            } else if (this.e >= 0.85f) {
                this.g += f2 * 6.65f;
                this.var_axy_a.a().getColor().set(this.var_axy_a.a().getColor().r, this.var_axy_a.a().getColor().g, this.var_axy_a.a().getColor().b, 1.0f - this.g);
                this.var_com_badlogic_gdx_graphics_Color_a.set(0.0f, 0.0f, 0.0f, this.var_axy_a.a().getColor().a);
            }
            this.var_axy_a.a().getData().setScale(this.f);
        } else {
            ...
            if (this.var_com_badlogic_gdx_graphics_g2d_GlyphLayout_a == false) {
                this.b += f2 * 20.0f;
            } else if (this.var_com_badlogic_gdx_graphics_g2d_GlyphLayout_a == true) {
                this.b += f2 * 35.0f;
            } else if (this.var_com_badlogic_gdx_graphics_g2d_GlyphLayout_a == 2) {
                this.b += f2 * 35.0f;
            }
            if (this.e < 0.1f) {
                if (this.e < 0.1f) {
                    this.var_axy_a.a().getColor().set(this.var_axy_a.a().getColor().r, this.var_axy_a.a().getColor().g, this.var_axy_a.a().getColor().b, this.e / 1.0f * 10.0f);
                    this.var_com_badlogic_gdx_graphics_Color_a.set(0.0f, 0.0f, 0.0f, this.var_axy_a.a().getColor().a);
                } else {
                    this.var_axy_a.a().getColor().set(this.var_axy_a.a().getColor().r, this.var_axy_a.a().getColor().g, this.var_axy_a.a().getColor().b, 1.0f);
                    this.var_com_badlogic_gdx_graphics_Color_a.set(0.0f, 0.0f, 0.0f, this.var_axy_a.a().getColor().a);
                    this.var_axy_a.a().getData().setScale(1.0f);
                }
            } else if ((double)this.e >= 0.35 && (f3 = this.var_axy_a.a().getColor().a) > 0.0f) {
                if (f3 - f2 * 2.5f > 0.0f) {
                    if (this.var_com_badlogic_gdx_graphics_g2d_GlyphLayout_a == false) {
                        this.g = this.var_com_badlogic_gdx_graphics_g2d_GlyphLayout_a == false ? (this.g += f2 * 1.25f) : (this.g += f2 * 1.5f);
                    }
                    this.var_axy_a.a().getColor().set(this.var_axy_a.a().getColor().r, this.var_axy_a.a().getColor().g, this.var_axy_a.a().getColor().b, this.var_axy_a.a().getColor().a - this.g);
                    this.var_com_badlogic_gdx_graphics_Color_a.set(0.0f, 0.0f, 0.0f, this.var_axy_a.a().getColor().a);
                } else {
                    this.var_axy_a.a().getColor().set(this.var_axy_a.a().getColor().r, this.var_axy_a.a().getColor().g, this.var_axy_a.a().getColor().b, 0.0f);
                    this.var_com_badlogic_gdx_graphics_Color_a.set(0.0f, 0.0f, 0.0f, this.var_axy_a.a().getColor().a);
