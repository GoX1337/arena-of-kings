...
implements axr {
    ...
    public gp(Engine engine, TextureAtlas textureAtlas) {
        this.var_ayh_a = new ayh(1575, 400, textureAtlas, "trade_request_frame", false);
        this.var_ayf_a = new gq(this, 1610, 415, textureAtlas, "accept_default", "accept_hovered", true, engine);
        this.var_ayf_b = new gr(this, 1730, 415, textureAtlas, "decline_default", "decline_hovered", true, engine);
