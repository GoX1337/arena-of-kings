...
public class aho
extends ahs {
    public aho(Engine engine, TextureAtlas textureAtlas, TextureAtlas textureAtlas2, br br2, gz gz2, EffectManager effectManager, HitCircle hitCircle, boolean bl2, gx gx2, CharacterClass characterClass, int n2) {
