 ...
 */
class bwd {
    static void a(float[] fArray, int[] nArray, int n2, int n3, float[] fArray2, int n4, float f2, float f3) {
        int n5;
        float f4 = (float)Math.PI / (float)n3;
        for (n5 = 0; n5 < n4; ++n5) {
            fArray2[n5] = bwb.a(fArray2[n5]);
        }
        int n6 = n4 / 2 * 2;
        n5 = 0;
        while (n5 < n2) {
            ...
            f6 = bwb.c(f2 * bwb.b(f6) * bwb.a(n10 + n4) - f3);
            do {
                int n11 = n5++;
