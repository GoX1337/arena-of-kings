...
public class boy {
    protected static final Set<String> var_java_util_Set_java_lang_String__a;
    protected Set<String> b = var_java_util_Set_java_lang_String__a;
    private static final boy var_boy_a;
    ...
    public void a(bfs bfs2, bfw bfw2, bfo bfo2) {
        String string;
        block6: {
            block7: {
                block8: {
                    Object t2 = bfw2.a();
                    string = ((Class)t2).getName();
                    if (this.b.contains(string)) break block6;
                    if (((Class)t2).isInterface()) break block7;
                    if (!string.startsWith("org.springframework.")) break block8;
                    for (Object object = t2; object != null && object != Object.class; object = ((Class)object).getSuperclass()) {
                        String string2 = ((Class)object).getSimpleName();
                        if (!"AbstractPointcutAdvisor".equals(string2) && !"AbstractApplicationContext".equals(string2)) {
                            continue;
                        }
                        break block6;
                    }
                ...
                if (string.startsWith("com.mchange.v2.c3p0.") && string.endsWith("DataSource")) break block6;
            }
            return;
        }
        bfs2.a(bfo2, "Illegal type (%s) to deserialize: prevented for security reasons", string);
    }
    ...
    static {
        ...
        var_java_util_Set_java_lang_String__a = Collections.unmodifiableSet(hashSet);
        var_boy_a = new boy();
    }
}
