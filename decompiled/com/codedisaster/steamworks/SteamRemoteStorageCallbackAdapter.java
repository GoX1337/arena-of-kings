...
extends SteamCallbackAdapter<SteamRemoteStorageCallback> {
    ...
    void onFileShareResult(long l2, String string, int n2) {
        ((SteamRemoteStorageCallback)this.callback).onFileShareResult(new SteamUGCHandle(l2), string, SteamResult.byValue(n2));
    }
