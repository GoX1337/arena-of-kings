...
extends SteamCallbackAdapter<SteamUGCCallback> {
    ...
    void onRequestUGCDetails(long l2, int n2, String string, String string2, long l3, long l4, String string3, boolean bl2, int n3, int n4, long l5, int n5, int n6) {
    ...
    void onSubmitItemUpdate(long l2, boolean bl2, int n2) {
        ((SteamUGCCallback)this.callback).onSubmitItemUpdate(new SteamPublishedFileID(l2), bl2, SteamResult.byValue(n2));
    }
    ...
    void onDeleteItem(long l2, int n2) {
        ((SteamUGCCallback)this.callback).onDeleteItem(new SteamPublishedFileID(l2), SteamResult.byValue(n2));
    }
}
