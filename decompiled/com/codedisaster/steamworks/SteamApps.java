...
extends SteamInterface {
    ...
    public boolean isDlcInstalled(int n2) {
        return SteamApps.isDlcInstalled(this.pointer, n2);
    }

    public int getEarliestPurchaseUnixTime(int n2) {
        return SteamApps.getEarliestPurchaseUnixTime(this.pointer, n2);
    }
    ...
    public void installDLC(int n2) {
        SteamApps.installDLC(this.pointer, n2);
    }

    public void uninstallDLC(int n2) {
        SteamApps.uninstallDLC(this.pointer, n2);
    }
