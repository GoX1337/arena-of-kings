...
extends SteamCallbackAdapter<SteamUserStatsCallback> {
    ...
    void onUserAchievementStored(long l2, boolean bl2, String string, int n2, int n3) {
        ((SteamUserStatsCallback)this.callback).onUserAchievementStored(l2, bl2, string, n2, n3);
    }
