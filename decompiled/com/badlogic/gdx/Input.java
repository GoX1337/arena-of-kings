...
public interface Input {
    ...
    public static class Keys {
        ...
        public static String toString(int n2) {
            if (n2 < 0) {
                throw new IllegalArgumentException("keycode cannot be negative, keycode: " + n2);
            }
            if (n2 > 255) {
                throw new IllegalArgumentException("keycode cannot be greater than 255, keycode: " + n2);
            }
            switch (n2) {
                case 0: {
                    return "Unknown";
        ...
        public static int valueOf(String string) {
            ...
            return keyNames.get(string, -1);
        }

        private static void initializeKeyNames() {
            keyNames = new ObjectIntMap();
            for (int i2 = 0; i2 < 256; ++i2) {
                String string = Keys.toString(i2);
                if (string == null) continue;
                keyNames.put(string, i2);
            }
        }
    }
