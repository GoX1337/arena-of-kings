...
implements InstanceData {
    ...
    public InstanceBufferObjectSubData(boolean bl2, int n2, VertexAttribute ... vertexAttributeArray) {
        this(bl2, n2, new VertexAttributes(vertexAttributeArray));
    }

    public InstanceBufferObjectSubData(boolean bl2, int n2, VertexAttributes vertexAttributes) {
        this.isStatic = bl2;
