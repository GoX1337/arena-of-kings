...
public class ParticleChannels {
    ...
    implements ParallelArray.ChannelInitializer<ParallelArray.FloatChannel> {
        ...
        public void init(ParallelArray.FloatChannel floatChannel) {
            int n2 = floatChannel.data.length;
            for (int i2 = 0; i2 < n2; i2 += floatChannel.strideSize) {
                floatChannel.data[i2 + 2] = 0.0f;
                floatChannel.data[i2 + 1] = 0.0f;
                floatChannel.data[i2 + 0] = 0.0f;
                floatChannel.data[i2 + 3] = 1.0f;
            }
        }
    }
    ...
    implements ParallelArray.ChannelInitializer<ParallelArray.FloatChannel> {
        ...
        public void init(ParallelArray.FloatChannel floatChannel) {
            ...
            for (int i2 = 0; i2 < n2; i2 += floatChannel.strideSize) {
                floatChannel.data[i2 + 0] = 0.0f;
                floatChannel.data[i2 + 1] = 0.0f;
                floatChannel.data[i2 + 2] = 1.0f;
                floatChannel.data[i2 + 3] = 1.0f;
                floatChannel.data[i2 + 4] = 0.5f;
                floatChannel.data[i2 + 5] = 0.5f;
            }
        }
    }
}
