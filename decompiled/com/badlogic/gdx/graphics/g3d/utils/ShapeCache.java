...
Disposable {
    ...
    public ShapeCache(int n2, int n3, VertexAttributes vertexAttributes, int n4) {
        this.mesh = new Mesh(false, n2, n3, vertexAttributes);
        this.builder = new MeshBuilder();
        this.renderable.meshPart.mesh = this.mesh;
        this.renderable.meshPart.primitiveType = n4;
    ...
    public MeshPartBuilder begin(int n2) {
        if (this.building) {
            throw new GdxRuntimeException("Call end() after calling begin()");
        }
        this.building = true;
        this.builder.begin(this.mesh.getVertexAttributes());
        this.builder.part("id", n2, this.renderable.meshPart);
        return this.builder;
    }
