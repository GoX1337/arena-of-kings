...
public class Base {
    ...
    public static final int StateUpdateChar(int n2) {
        if (n2 < 4) {
            return 0;
        }
        if (n2 < 10) {
    ...
    public static final int StateUpdateMatch(int n2) {
        return n2 < 7 ? 7 : 10;
    }

    public static final int StateUpdateRep(int n2) {
        return n2 < 7 ? 8 : 11;
    }

    public static final int StateUpdateShortRep(int n2) {
        return n2 < 7 ? 9 : 11;
    }

    public static final boolean StateIsCharState(int n2) {
        return n2 < 7;
    }

    public static final int GetLenToPosState(int n2) {
        if ((n2 -= 2) < 4) {
            return n2;
        }
        return 3;
