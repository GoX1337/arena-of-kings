...
public interface Graphics {
    ...
    public static class BufferFormat {
        ...
        public BufferFormat(int n2, int n3, int n4, int n5, int n6, int n7, int n8, boolean bl2) {
            this.r = n2;
            this.g = n3;
            this.b = n4;
            this.a = n5;
    ...
    public static class Monitor {
        ...
        public Monitor(int n2, int n3, String string) {
            this.virtualX = n2;
            this.virtualY = n3;
            this.name = string;
        }
    ...
    public static class DisplayMode {
        ...
        public DisplayMode(int n2, int n3, int n4, int n5) {
            this.width = n2;
            this.height = n3;
            this.refreshRate = n4;
