...
public class PUB_ITEM_SEASONAL_PURCHASE_RESPONSE
    ...
    public void handle(Engine engine) {
        if (this.itemData.getItemLocation() == ItemLocation.INVENTORY) {
            ...
            if (fm2 != null) {
                ...
                if (t.a(we.class, engine) && ay.ay_a().com_arenaofkings_packets_gameserver_data_player_me_MyAccountData_a().getActive_character_entity().int_b() != this.newAP) {
                ...
                } else if (fm2.com_arenaofkings_packets_misc_items_ItemRarity_a() == ItemRarity.LEGENDARY || fm2.com_arenaofkings_packets_misc_items_ItemRarity_a() == ItemRarity.ANCIENT) {
                ...
                ay.ay_a().com_arenaofkings_packets_gameserver_data_player_me_MyAccountData_a().getActive_character_entity().b(this.newAP);
            }
        }
    }
}
