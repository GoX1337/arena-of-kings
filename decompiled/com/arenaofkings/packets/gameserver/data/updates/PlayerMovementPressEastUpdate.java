...
public class PlayerMovementPressEastUpdate
extends PlayerSnapshot {
    ...
    public void handle(String string, PlayerSnapshot playerSnapshot, Engine engine) {
        ...
        if (br2 != ay.ay_a()) {
            ay.ay_a().br_a(string).com_arenaofkings_packets_gameserver_data_player_shared_SharedAccountData_a().getActive_character_entity().az_a().b(PlayerAction.RUN_EAST);
        } else {
            Engine.a("PacketEASTPRESS was for me : " + string);
        }
    }
}
