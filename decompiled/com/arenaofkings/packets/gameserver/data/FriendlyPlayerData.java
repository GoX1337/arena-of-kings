...
public class FriendlyPlayerData {
    ...
    public FriendlyPlayerData() {
    }

    public FriendlyPlayerData(String string, int n2, String string2, int n3, int n4, int n5, List<ui> list) {
