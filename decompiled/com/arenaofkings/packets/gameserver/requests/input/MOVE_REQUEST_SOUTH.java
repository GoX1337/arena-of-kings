...
public class MOVE_REQUEST_SOUTH
extends PublicPacket {
    ...
    public void handle(Engine engine) {
        ...
        if (ay.ay_a() != ay.ay_a().br_a(this.character_name) && (br2 = ay.ay_a().br_a(this.character_name)) != null) {
            br2.com_arenaofkings_packets_gameserver_data_player_shared_SharedAccountData_a().getActive_character_entity().az_a().c(PlayerAction.RUN_SOUTH);
        }
    }
}
