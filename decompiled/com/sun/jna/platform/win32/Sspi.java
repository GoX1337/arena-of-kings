...
public interface Sspi {
    ...
    extends Structure {
        ...
        public synchronized int free() {
            if (this.sUserName != null) {
                int n2 = Secur32.INSTANCE.FreeContextBuffer(this.sUserName);
                this.sUserName = null;
                return n2;
            }
            return 0;
    ...
    extends Structure {
        ...
        public SecPkgInfo.ByReference[] com_sun_jna_platform_win32_Sspi$SecPkgInfo$ByReference_arr_toArray(int n2) {
            return (SecPkgInfo.ByReference[])this.pPkgInfo.com_sun_jna_Structure_arr_toArray(n2);
        }
    ...
    extends Structure {
        ...
        public SecBuffer(int n2, int n3) {
            this.cbBuffer = n3;
            this.pvBuffer = new Memory(n3);
            this.BufferType = n2;
        }

        public SecBuffer(int n2, byte[] byArray) {
            this.cbBuffer = byArray.length;
        ...
        implements Structure.ByReference {
            ...
            public ByReference(int n2, byte[] byArray) {
                super(n2, byArray);
            }
        }
    }
