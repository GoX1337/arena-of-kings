...
public interface WinRas {
    ...
    extends Structure {
        ...
        public RASDEVSPECIFICINFO(byte[] byArray) {
            this.pbDevSpecificInfo = new Memory(byArray.length);
            this.pbDevSpecificInfo.write(0L, byArray, 0, byArray.length);
            this.dwSize = byArray.length;
            this.allocateMemory();
        }

        public RASDEVSPECIFICINFO(String string) {
    ...
    extends Structure {
        ...
        public RASEAPINFO(byte[] byArray) {
            this.pbEapInfo = new Memory(byArray.length);
            this.pbEapInfo.write(0L, byArray, 0, byArray.length);
            this.dwSizeofEapInfo = byArray.length;
            this.allocateMemory();
        }

        public RASEAPINFO(String string) {
            this(Native.toByteArray(string));
        }
