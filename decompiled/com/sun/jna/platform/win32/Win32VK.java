...
public enum Win32VK {
    ...
    private Win32VK(int n3, int n4) {
        this.code = n3;
        this.introducedVersion = n4;
    }

    private Win32VK(int n3) {
        this(n3, 0);
    }

    public static Win32VK fromValue(int n2) {
        for (Win32VK win32VK : Win32VK.values()) {
            if (win32VK.code != n2) continue;
            return win32VK;
        }
        throw new IllegalArgumentException(String.format("No mapping for %02x", n2));
    }
}
