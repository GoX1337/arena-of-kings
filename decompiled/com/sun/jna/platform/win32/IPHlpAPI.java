...
extends Library {
    ...
    extends Structure {
        ...
        public void read() {
            ...
            if (this.dwNumEntries > 0) {
                this.table = (MIB_UDP6ROW_OWNER_PID[])new MIB_UDP6ROW_OWNER_PID().com_sun_jna_Structure_arr_toArray(this.dwNumEntries);
                super.read();
            } else {
    ...
    extends Structure {
        ...
        public void read() {
            this.dwNumEntries = this.getPointer().getInt(0L);
            if (this.dwNumEntries > 0) {
                this.table = (MIB_UDPROW_OWNER_PID[])new MIB_UDPROW_OWNER_PID().com_sun_jna_Structure_arr_toArray(this.dwNumEntries);
                super.read();
            } else {
    ...
    extends Structure {
        ...
        public void read() {
            this.dwNumEntries = this.getPointer().getInt(0L);
            if (this.dwNumEntries > 0) {
                this.table = (MIB_TCP6ROW_OWNER_PID[])new MIB_TCP6ROW_OWNER_PID().com_sun_jna_Structure_arr_toArray(this.dwNumEntries);
                super.read();
            } else {
    ...
    extends Structure {
        ...
        public void read() {
            this.dwNumEntries = this.getPointer().getInt(0L);
            if (this.dwNumEntries > 0) {
                this.table = (MIB_TCPROW_OWNER_PID[])new MIB_TCPROW_OWNER_PID().com_sun_jna_Structure_arr_toArray(this.dwNumEntries);
                super.read();
            } else {
