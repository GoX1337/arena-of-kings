...
public interface HighLevelMonitorConfigurationAPI {
    ...
    public static enum MC_COLOR_TEMPERATURE {
        ...
        extends com.sun.jna.ptr.ByReference {
            ...
            public ByReference(MC_COLOR_TEMPERATURE mC_COLOR_TEMPERATURE) {
                super(4);
                this.setValue(mC_COLOR_TEMPERATURE);
            }

            public void setValue(MC_COLOR_TEMPERATURE mC_COLOR_TEMPERATURE) {
                this.getPointer().setInt(0L, EnumUtils.toInteger(mC_COLOR_TEMPERATURE));
            }
    ...
    public static enum MC_DISPLAY_TECHNOLOGY_TYPE {
        ...
        extends com.sun.jna.ptr.ByReference {
            ...
            public ByReference(MC_DISPLAY_TECHNOLOGY_TYPE mC_DISPLAY_TECHNOLOGY_TYPE) {
                super(4);
                this.setValue(mC_DISPLAY_TECHNOLOGY_TYPE);
            }

            public void setValue(MC_DISPLAY_TECHNOLOGY_TYPE mC_DISPLAY_TECHNOLOGY_TYPE) {
                this.getPointer().setInt(0L, EnumUtils.toInteger(mC_DISPLAY_TECHNOLOGY_TYPE));
            }
    ...
    public static enum MC_SUPPORTED_COLOR_TEMPERATURE implements FlagEnum
    {
        ...
        private MC_SUPPORTED_COLOR_TEMPERATURE(int n3) {
            this.flag = n3;
        }
