...
public interface DBT {
    ...
    extends Structure {
        ...
        public DEV_BROADCAST_DEVICEINTERFACE(long l2) {
            this(new Pointer(l2));
        }
        ...
        public void read() {
            ...
            int n2 = this.getPointer().getInt(0L);
            int n3 = (n2 - this.fieldOffset("dbcc_name")) / Native.WCHAR_SIZE;
            this.dbcc_name = new char[n3];
            super.read();
        }
    ...
    extends Structure {
        ...
        public void read() {
            int n2 = this.getPointer().getInt(0L);
            this.dbcp_name = new byte[n2 - this.fieldOffset("dbcp_name")];
            super.read();
        }
    ...
    extends Structure {
        ...
        public DEV_BROADCAST_HDR(long l2) {
            this(new Pointer(l2));
        }
