...
public interface WinCrypt {
    ...
    extends BaseTSD.ULONG_PTR {
        ...
        public HCRYPTPROV_LEGACY(long l2) {
            super(l2);
        }
    }
    ...
    extends Structure {
        ...
        public CERT_CONTEXT[] getRgpMsgCert() {
            CERT_CONTEXT[] cERT_CONTEXTArray = new CERT_CONTEXT[this.cMsgCrl];
            for (int i2 = 0; i2 < cERT_CONTEXTArray.length; ++i2) {
                cERT_CONTEXTArray[i2] = Structure.newInstance(CERT_CONTEXT.class, this.rgpMsgCert.getPointer(i2 * Native.POINTER_SIZE));
                cERT_CONTEXTArray[i2].read();
            }
            return cERT_CONTEXTArray;
        }

        public CRL_CONTEXT[] getRgpMsgCrl() {
            CRL_CONTEXT[] cRL_CONTEXTArray = new CRL_CONTEXT[this.cMsgCrl];
            for (int i2 = 0; i2 < cRL_CONTEXTArray.length; ++i2) {
                cRL_CONTEXTArray[i2] = Structure.newInstance(CRL_CONTEXT.class, this.rgpMsgCrl.getPointer(i2 * Native.POINTER_SIZE));
                cRL_CONTEXTArray[i2].read();
            }
            return cRL_CONTEXTArray;
        }
        ...
        public CRYPT_ATTRIBUTE[] getRgAuthAttr() {
            ...
            return (CRYPT_ATTRIBUTE[])Structure.newInstance(CRYPT_ATTRIBUTE.class, this.rgAuthAttr).com_sun_jna_Structure_arr_toArray(this.cAuthAttr);
        }
        ...
        public CRYPT_ATTRIBUTE[] getRgUnauthAttr() {
            ...
            return (CRYPT_ATTRIBUTE[])Structure.newInstance(CRYPT_ATTRIBUTE.class, this.rgUnauthAttr).com_sun_jna_Structure_arr_toArray(this.cUnauthAttr);
        }
    ...
    extends Structure {
        ...
        public CRYPT_KEY_PROV_PARAM[] getRgProvParam() {
            CRYPT_KEY_PROV_PARAM[] cRYPT_KEY_PROV_PARAMArray = new CRYPT_KEY_PROV_PARAM[this.cProvParam];
            for (int i2 = 0; i2 < cRYPT_KEY_PROV_PARAMArray.length; ++i2) {
                cRYPT_KEY_PROV_PARAMArray[i2] = Structure.newInstance(CRYPT_KEY_PROV_PARAM.class, this.rgProvParam.getPointer(i2 * Native.POINTER_SIZE));
                cRYPT_KEY_PROV_PARAMArray[i2].read();
            }
            return cRYPT_KEY_PROV_PARAMArray;
        }
    ...
    extends Structure {
        ...
        public DATA_BLOB[] getRgValue() {
            return (DATA_BLOB[])this.rgValue.com_sun_jna_Structure_arr_toArray(this.cValue);
        }
    ...
    extends Structure {
        ...
        public CRL_ENTRY[] getRgCRLEntry() {
            ...
            CRL_ENTRY[] cRL_ENTRYArray = (CRL_ENTRY[])Structure.newInstance(CRL_ENTRY.class, this.rgCRLEntry).com_sun_jna_Structure_arr_toArray(this.cCRLEntry);
            cRL_ENTRYArray[0].read();
            return cRL_ENTRYArray;
        }
        ...
        public CERT_EXTENSION[] getRgExtension() {
            ...
            CERT_EXTENSION[] cERT_EXTENSIONArray = (CERT_EXTENSION[])Structure.newInstance(CERT_EXTENSION.class, this.rgExtension).com_sun_jna_Structure_arr_toArray(this.cExtension);
            cERT_EXTENSIONArray[0].read();
            return cERT_EXTENSIONArray;
        }
    ...
    extends Structure {
        ...
        public CERT_SIMPLE_CHAIN[] getRgpChain() {
            CERT_SIMPLE_CHAIN[] cERT_SIMPLE_CHAINArray = new CERT_SIMPLE_CHAIN[this.cChain];
            for (int i2 = 0; i2 < cERT_SIMPLE_CHAINArray.length; ++i2) {
                cERT_SIMPLE_CHAINArray[i2] = Structure.newInstance(CERT_SIMPLE_CHAIN.class, this.rgpChain.getPointer(i2 * Native.POINTER_SIZE));
                cERT_SIMPLE_CHAINArray[i2].read();
            }
            return cERT_SIMPLE_CHAINArray;
        }

        public CERT_CHAIN_CONTEXT[] getRgpLowerQualityChainContext() {
            CERT_CHAIN_CONTEXT[] cERT_CHAIN_CONTEXTArray = new CERT_CHAIN_CONTEXT[this.cLowerQualityChainContext];
            for (int i2 = 0; i2 < cERT_CHAIN_CONTEXTArray.length; ++i2) {
                cERT_CHAIN_CONTEXTArray[i2] = Structure.newInstance(CERT_CHAIN_CONTEXT.class, this.rgpLowerQualityChainContext.getPointer(i2 * Native.POINTER_SIZE));
                cERT_CHAIN_CONTEXTArray[i2].read();
            }
            return cERT_CHAIN_CONTEXTArray;
        }
    ...
    extends Structure {
        ...
        public CERT_CHAIN_ELEMENT[] getRgpElement() {
            CERT_CHAIN_ELEMENT[] cERT_CHAIN_ELEMENTArray = new CERT_CHAIN_ELEMENT[this.cElement];
            for (int i2 = 0; i2 < cERT_CHAIN_ELEMENTArray.length; ++i2) {
                cERT_CHAIN_ELEMENTArray[i2] = Structure.newInstance(CERT_CHAIN_ELEMENT.class, this.rgpElement.getPointer(i2 * Native.POINTER_SIZE));
                cERT_CHAIN_ELEMENTArray[i2].read();
            }
    ...
    extends Structure {
        ...
        public void setRgpszUsageIdentier(String[] stringArray) {
            if (stringArray == null || stringArray.length == 0) {
                this.cUsageIdentifier = 0;
                this.rgpszUsageIdentifier = null;
            } else {
                this.cUsageIdentifier = stringArray.length;
                this.rgpszUsageIdentifier = new StringArray(stringArray);
            }
        }
    ...
    extends Structure {
        ...
        public CTL_ENTRY[] getRgCTLEntry() {
            ...
            CTL_ENTRY[] cTL_ENTRYArray = (CTL_ENTRY[])Structure.newInstance(CTL_ENTRY.class, this.rgCTLEntry).com_sun_jna_Structure_arr_toArray(this.cCTLEntry);
            cTL_ENTRYArray[0].read();
            return cTL_ENTRYArray;
        }
    ...
    extends Structure {
        ...
        public CRYPT_ATTRIBUTE[] getRgAttribute() {
            ...
            CRYPT_ATTRIBUTE[] cRYPT_ATTRIBUTEArray = (CRYPT_ATTRIBUTE[])Structure.newInstance(CRYPT_ATTRIBUTE.class, this.rgAttribute).com_sun_jna_Structure_arr_toArray(this.cAttribute);
            cRYPT_ATTRIBUTEArray[0].read();
            return cRYPT_ATTRIBUTEArray;
        }
