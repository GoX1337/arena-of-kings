...
implements TlbConst {
    ...
    public TlbCmdlineArgs(String[] stringArray) {
        this.readCmdArgs(stringArray);
    }

    public int getIntParam(String string) {
        String string2 = this.getRequiredParam(string);
    ...
    public String getRequiredParam(String string) {
        String string2 = this.getParam(string);
        if (string2 == null) {
            throw new TlbParameterNotFoundException("Commandline parameter not found: " + string);
        }
        return string2;
    }

    private void readCmdArgs(String[] stringArray) {
        ...
        for (int i2 = 0; i2 < stringArray.length; i2 += 2) {
            ...
            if (string.startsWith("-") && !string2.startsWith("-")) {
                this.put(string.substring(1), string2);
                continue;
            }
            this.showCmdHelp();
            break;
