...
WinError {
    ...
    public static final class LocaleMacros {
        private static final int _MAKELCID(int n2, int n3) {
            return n3 << 16 | n2;
        }

        public static final WinDef.LCID MAKELCID(int n2, int n3) {
            return new WinDef.LCID((long)LocaleMacros._MAKELCID(n2, n3));
        }

        public static final WinDef.LCID MAKESORTLCID(int n2, int n3, int n4) {
            return new WinDef.LCID((long)(LocaleMacros._MAKELCID(n2, n3) | n4 << 20));
        }
        ...
        public static final int MAKELANGID(int n2, int n3) {
            return n3 << 10 | n2 & 0xFFFF;
        }

        public static final int PRIMARYLANGID(int n2) {
            return n2 & 0x3FF;
        }

        public static final int SUBLANGID(int n2) {
            return (n2 & 0xFFFF) >>> 10;
        }
    }
    ...
    extends SYSTEM_LOGICAL_PROCESSOR_INFORMATION_EX {
        ...
        public UNKNOWN_RELATIONSHIP(Pointer pointer) {
            super(pointer);
        }
    }
    ...
    extends Structure {
        ...
        public static SYSTEM_LOGICAL_PROCESSOR_INFORMATION_EX fromPointer(Pointer pointer) {
            SYSTEM_LOGICAL_PROCESSOR_INFORMATION_EX sYSTEM_LOGICAL_PROCESSOR_INFORMATION_EX;
            int n2 = pointer.getInt(0L);
            switch (n2) {
                case 0: 
                case 3: {
                    sYSTEM_LOGICAL_PROCESSOR_INFORMATION_EX = new PROCESSOR_RELATIONSHIP(pointer);
                    break;
                }
                case 1: {
                    sYSTEM_LOGICAL_PROCESSOR_INFORMATION_EX = new NUMA_NODE_RELATIONSHIP(pointer);
                    break;
                }
                case 2: {
                    sYSTEM_LOGICAL_PROCESSOR_INFORMATION_EX = new CACHE_RELATIONSHIP(pointer);
                    break;
                }
                case 4: {
                    sYSTEM_LOGICAL_PROCESSOR_INFORMATION_EX = new GROUP_RELATIONSHIP(pointer);
                    break;
                }
                default: {
                    sYSTEM_LOGICAL_PROCESSOR_INFORMATION_EX = new UNKNOWN_RELATIONSHIP(pointer);
                }
            }
            sYSTEM_LOGICAL_PROCESSOR_INFORMATION_EX.read();
    ...
    extends ACCESS_ACEStructure {
        ...
        public ACCESS_DENIED_ACE(int n2, byte by2, PSID pSID) {
            super(n2, (byte)1, by2, pSID);
        }
    }
    ...
    extends ACCESS_ACEStructure {
        ...
        public ACCESS_ALLOWED_ACE(int n2, byte by2, PSID pSID) {
            super(n2, (byte)0, by2, pSID);
        }
    }
    ...
    extends ACE_HEADER {
        ...
        public ACCESS_ACEStructure(int n2, byte by2, byte by3, PSID pSID) {
        ...
        public void write() {
            super.write();
            int n2 = super.fieldOffset("SidStart");
            int n3 = this.AceSize - super.fieldOffset("SidStart");
            if (this.psid != null) {
                byte[] byArray = this.psid.getBytes();
                assert (byArray.length <= n3);
                this.getPointer().write((long)n2, byArray, 0, n3);
            }
        }
        ...
        public void read() {
            ...
            int n2 = super.fieldOffset("SidStart");
            int n3 = this.AceSize - super.fieldOffset("SidStart");
            this.psid = n3 > 0 ? new PSID(this.getPointer().getByteArray(n2, n3)) : new PSID();
        }
    }
    ...
    extends Structure {
        ...
        public ACE_HEADER(byte by2, byte by3, short s2) {
            this.AceType = by2;
            this.AceFlags = by3;
            this.AceSize = s2;
            this.write();
    ...
    extends Structure {
        ...
        public SECURITY_DESCRIPTOR_RELATIVE(byte[] byArray) {
            super(new Memory(byArray.length));
            this.getPointer().write(0L, byArray, 0, byArray.length);
            this.setMembers();
        }

        public SECURITY_DESCRIPTOR_RELATIVE(int n2) {
            super(new Memory(n2));
        }
    ...
    extends ByReference {
        ...
        public void setValue(ACL aCL) {
            this.getPointer().setPointer(0L, aCL != null ? aCL.getPointer() : null);
        }
    ...
    extends Structure {
        ...
        public ACE_HEADER[] getACEs() {
            ACE_HEADER[] aCE_HEADERArray = new ACE_HEADER[this.AceCount];
            Pointer pointer = this.getPointer();
            int n2 = this.size();
            for (int i2 = 0; i2 < this.AceCount; ++i2) {
                Pointer pointer2 = pointer.share(n2);
                byte by2 = pointer2.getByte(0L);
                switch (by2) {
                    case 0: {
                        aCE_HEADERArray[i2] = new ACCESS_ALLOWED_ACE(pointer2);
                        break;
                    }
                    case 1: {
                        aCE_HEADERArray[i2] = new ACCESS_DENIED_ACE(pointer2);
                        break;
                    }
                    default: {
                        aCE_HEADERArray[i2] = new ACE_HEADER(pointer2);
                    }
                }
                n2 += aCE_HEADERArray[i2].AceSize;
            }
    ...
    extends Structure {
        ...
        public SECURITY_DESCRIPTOR(byte[] byArray) {
            this.data = byArray;
            this.useMemory(new Memory(byArray.length));
        }

        public SECURITY_DESCRIPTOR(int n2) {
            this.useMemory(new Memory(n2));
    ...
    extends PointerType {
        ...
        public Object fromNative(Object object, FromNativeContext fromNativeContext) {
            ...
            if (WinBase.INVALID_HANDLE_VALUE.equals(object2)) {
                return WinBase.INVALID_HANDLE_VALUE;
            }
            return object2;
        }
    ...
    implements Comparable<LARGE_INTEGER> {
        ...
        public int compareTo(LARGE_INTEGER lARGE_INTEGER) {
            return LARGE_INTEGER.compare(this, lARGE_INTEGER);
        }
        ...
        public static int compare(LARGE_INTEGER lARGE_INTEGER, long l2) {
            if (lARGE_INTEGER == null) {
                return 1;
            }
            return IntegerType.compare(lARGE_INTEGER.getValue(), l2);
        }
        ...
        extends Union {
            ...
            public UNION(long l2) {
                this.value = l2;
                this.lh = new LowHigh(l2);
            }
        ...
        extends Structure {
            ...
            public LowHigh(long l2) {
                this(new WinDef.DWORD(l2 & 0xFFFFFFFFL), new WinDef.DWORD(l2 >> 32 & 0xFFFFFFFFL));
            }
            ...
            public long longValue() {
                long l2 = this.LowPart.longValue();
                long l3 = this.HighPart.longValue();
                return l3 << 32 & 0xFFFFFFFF00000000L | l2 & 0xFFFFFFFFL;
            }
    ...
    extends Structure {
        ...
        public FILE_NOTIFY_INFORMATION(int n2) {
            if (n2 < this.size()) {
                throw new IllegalArgumentException("Size must greater than " + this.size() + ", requested " + n2);
            }
            this.allocateMemory(n2);
        }
    ...
    extends Structure {
        ...
        public TOKEN_PRIVILEGES(int n2) {
            this.PrivilegeCount = new WinDef.DWORD((long)n2);
            this.Privileges = new LUID_AND_ATTRIBUTES[n2];
        }
    ...
    extends Structure {
        ...
        public TOKEN_GROUPS(int n2) {
            super(new Memory(n2));
        }

        public SID_AND_ATTRIBUTES[] getGroups() {
            return (SID_AND_ATTRIBUTES[])this.Group0.com_sun_jna_Structure_arr_toArray(this.GroupCount);
        }
    }
    ...
    extends Structure {
        ...
        public TOKEN_PRIMARY_GROUP(int n2) {
            super(new Memory(n2));
        }
    }
    ...
    extends ByReference {
        ...
        public void setValue(PSID pSID) {
            this.getPointer().setPointer(0L, pSID != null ? pSID.getPointer() : null);
        }
    ...
    extends Structure {
        ...
        public byte[] getBytes() {
            int n2 = Advapi32.INSTANCE.GetLengthSid(this);
            return this.getPointer().getByteArray(0L, n2);
        }
