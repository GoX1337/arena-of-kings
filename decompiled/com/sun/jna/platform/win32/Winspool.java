...
extends StdCallLibrary {
    ...
    extends Structure {
        ...
        @Override
        public void read() {
            int n2 = (Integer)this.readField("Count");
            this.aData = new PRINTER_NOTIFY_INFO_DATA[n2];
            if (n2 == 0) {
                this.Count = n2;
    ...
    extends Structure {
        ...
        public void setFields(short[] sArray) {
            long l2 = 2L;
            Memory memory = new Memory((long)sArray.length * 2L);
            memory.write(0L, sArray, 0, sArray.length);
            this.pFields = memory;
    ...
    extends Structure {
        ...
        public PRINTER_INFO_2(int n2) {
            super(new Memory(n2));
        }

        public boolean hasAttribute(int n2) {
            return (this.Attributes & n2) == n2;
        }
    }
