...
WinDef {
    ...
    extends Structure {
        ...
        extends WinDef.DWORD {
            ...
            public void setfAbortOnError(boolean bl2) {
                int n2 = DCBControllBits.leftShiftMask(bl2 ? 1 : 0, (byte)14, 1, this.intValue());
                this.setValue(n2);
            }

            public void setfBinary(boolean bl2) {
                int n2 = DCBControllBits.leftShiftMask(bl2 ? 1 : 0, (byte)0, 1, this.intValue());
                this.setValue(n2);
            }

            public void setfDsrSensitivity(boolean bl2) {
                int n2 = DCBControllBits.leftShiftMask(bl2 ? 1 : 0, (byte)6, 1, this.intValue());
                this.setValue(n2);
            }

            public void setfDtrControl(int n2) {
                int n3 = DCBControllBits.leftShiftMask(n2, (byte)4, 3, this.intValue());
                this.setValue(n3);
            }

            public void setfErrorChar(boolean bl2) {
                int n2 = DCBControllBits.leftShiftMask(bl2 ? 1 : 0, (byte)10, 1, this.intValue());
                this.setValue(n2);
            }

            public void setfInX(boolean bl2) {
                int n2 = DCBControllBits.leftShiftMask(bl2 ? 1 : 0, (byte)9, 1, this.intValue());
                this.setValue(n2);
            }

            public void setfNull(boolean bl2) {
                int n2 = DCBControllBits.leftShiftMask(bl2 ? 1 : 0, (byte)11, 1, this.intValue());
                this.setValue(n2);
            }

            public void setfOutX(boolean bl2) {
                int n2 = DCBControllBits.leftShiftMask(bl2 ? 1 : 0, (byte)8, 1, this.intValue());
                this.setValue(n2);
            }

            public void setfOutxCtsFlow(boolean bl2) {
                int n2 = DCBControllBits.leftShiftMask(bl2 ? 1 : 0, (byte)2, 1, this.intValue());
                this.setValue(n2);
            }

            public void setfOutxDsrFlow(boolean bl2) {
                int n2 = DCBControllBits.leftShiftMask(bl2 ? 1 : 0, (byte)3, 1, this.intValue());
                this.setValue(n2);
            }

            public void setfParity(boolean bl2) {
                int n2 = DCBControllBits.leftShiftMask(bl2 ? 1 : 0, (byte)1, 1, this.intValue());
                this.setValue(n2);
            }

            public void setfRtsControl(int n2) {
                int n3 = DCBControllBits.leftShiftMask(n2, (byte)12, 3, this.intValue());
                this.setValue(n3);
            }

            public void setfTXContinueOnXoff(boolean bl2) {
                int n2 = DCBControllBits.leftShiftMask(bl2 ? 1 : 0, (byte)7, 1, this.intValue());
                this.setValue(n2);
            }

            private static int leftShiftMask(int n2, byte by2, int n3, int n4) {
                int n5 = n4;
                n5 &= ~(n3 << by2);
                return n5 |= (n2 & n3) << by2;
            }
    ...
    extends Structure {
        ...
        public FILETIME(Date date) {
            long l2 = FILETIME.dateToFileTime(date);
            this.dwHighDateTime = (int)(l2 >> 32 & 0xFFFFFFFFL);
            this.dwLowDateTime = (int)(l2 & 0xFFFFFFFFL);
        }
        ...
        public static Date filetimeToDate(int n2, int n3) {
    ...
    extends Structure {
        ...
        public WIN32_FIND_DATA(int n2, FILETIME fILETIME, FILETIME fILETIME2, FILETIME fILETIME3, int n3, int n4, int n5, int n6, char[] cArray, char[] cArray2) {
            this.dwFileAttributes = n2;
            this.ftCreationTime = fILETIME;
            this.ftLastAccessTime = fILETIME2;
            this.ftLastWriteTime = fILETIME3;
            this.nFileSizeHigh = n3;
            this.nFileSizeLow = n4;
            this.dwReserved0 = n5;
            this.cFileName = cArray;
            this.cAlternateFileName = cArray2;
            this.write();
        }
    ...
    extends Structure {
        ...
        public FILE_ID_INFO(long l2, FILE_ID_128 fILE_ID_128) {
            this.VolumeSerialNumber = l2;
        ...
        extends Structure {
            ...
            public FILE_ID_128(WinDef.BYTE[] bYTEArray) {
                this.Identifier = bYTEArray;
                this.write();
            }
        }
    ...
    extends Structure {
        ...
        public FILE_ATTRIBUTE_TAG_INFO(int n2, int n3) {
    ...
    extends Structure {
        ...
        public FILE_COMPRESSION_INFO(WinNT.LARGE_INTEGER lARGE_INTEGER, short s2, byte by2, byte by3, byte by4) {
            this.CompressedFileSize = lARGE_INTEGER;
            this.CompressionFormat = s2;
            this.CompressionUnitShift = by2;
            this.ChunkShift = by3;
            this.ClusterShift = by4;
    ...
    extends Structure {
        ...
        public FILE_DISPOSITION_INFO(boolean bl2) {
            this.DeleteFile = bl2;
            this.write();
        }
    ...
    extends Structure {
        ...
        public FILE_STANDARD_INFO(WinNT.LARGE_INTEGER lARGE_INTEGER, WinNT.LARGE_INTEGER lARGE_INTEGER2, int n2, boolean bl2, boolean bl3) {
            this.AllocationSize = lARGE_INTEGER;
            this.EndOfFile = lARGE_INTEGER2;
            this.NumberOfLinks = n2;
            this.DeletePending = bl2;
            this.Directory = bl3;
            this.write();
        }
    ...
    extends Structure {
        ...
        public FILE_BASIC_INFO(FILETIME fILETIME, FILETIME fILETIME2, FILETIME fILETIME3, FILETIME fILETIME4, int n2) {
        ...
        public FILE_BASIC_INFO(WinNT.LARGE_INTEGER lARGE_INTEGER, WinNT.LARGE_INTEGER lARGE_INTEGER2, WinNT.LARGE_INTEGER lARGE_INTEGER3, WinNT.LARGE_INTEGER lARGE_INTEGER4, int n2) {
