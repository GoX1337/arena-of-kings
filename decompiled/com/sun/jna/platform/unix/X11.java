...
extends Library {
    ...
    extends Structure {
        ...
        public XRectangle(short s2, short s3, short s4, short s5) {
            this.x = s2;
            this.y = s3;
            this.width = s4;
            this.height = s5;
    ...
    extends Structure {
        ...
        public XPoint(short s2, short s3) {
            this.x = s2;
            this.y = s3;
        }
    }
    ...
    extends Library {
        ...
        extends XID {
            ...
            public Object fromNative(Object object, FromNativeContext fromNativeContext) {
                if (this.isNone(object)) {
                    return None;
                }
                return new PictFormat(((Number)object).longValue());
            }
        }
    ...
    extends Drawable {
        ...
        public Object fromNative(Object object, FromNativeContext fromNativeContext) {
            ...
            return new Pixmap(((Number)object).longValue());
        }
    }
    ...
    extends ByReference {
        ...
        public Window getValue() {
            NativeLong nativeLong = this.getPointer().getNativeLong(0L);
            return nativeLong.longValue() == 0L ? Window.None : new Window(nativeLong.longValue());
        }
    }
    ...
    extends Drawable {
        ...
        public Object fromNative(Object object, FromNativeContext fromNativeContext) {
            ...
            return new Window(((Number)object).longValue());
        }
    }
    ...
    extends XID {
        ...
        public Object fromNative(Object object, FromNativeContext fromNativeContext) {
            ...
            return new Drawable(((Number)object).longValue());
        }
    }
    ...
    extends XID {
        ...
        public Object fromNative(Object object, FromNativeContext fromNativeContext) {
            ...
            return new KeySym(((Number)object).longValue());
        }
    }
    ...
    extends XID {
        ...
        public Object fromNative(Object object, FromNativeContext fromNativeContext) {
            ...
            return new Cursor(((Number)object).longValue());
        }
    }
    ...
    extends XID {
        ...
        public Object fromNative(Object object, FromNativeContext fromNativeContext) {
            ...
            return new Font(((Number)object).longValue());
        }
    }
    ...
    extends XID {
        ...
        public Object fromNative(Object object, FromNativeContext fromNativeContext) {
            ...
            return new Colormap(((Number)object).longValue());
        }
    }
    ...
    extends ByReference {
        ...
        public Atom getValue() {
            NativeLong nativeLong = this.getPointer().getNativeLong(0L);
            return (Atom)new Atom().fromNative(nativeLong, null);
        }
    }
    ...
    extends NativeLong {
        ...
        protected boolean isNone(Object object) {
        ...
        public Object fromNative(Object object, FromNativeContext fromNativeContext) {
            ...
            return new XID(((Number)object).longValue());
        }
    ...
    extends NativeLong {
        ...
        public Object fromNative(Object object, FromNativeContext fromNativeContext) {
            ...
            return new VisualID(((Number)object).longValue());
        }
    }
}
