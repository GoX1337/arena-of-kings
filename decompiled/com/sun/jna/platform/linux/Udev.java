...
extends Library {
    ...
    extends PointerType {
        ...
        public UdevDevice getParentWithSubsystemDevtype(String string, String string2) {
            return INSTANCE.udev_device_get_parent_with_subsystem_devtype(this, string, string2);
        }
        ...
        public String getSysattrValue(String string) {
            return INSTANCE.udev_device_get_sysattr_value(this, string);
        }

        public String getPropertyValue(String string) {
            return INSTANCE.udev_device_get_property_value(this, string);
        }
    }
    ...
    extends PointerType {
        ...
        public int addMatchSubsystem(String string) {
            return INSTANCE.udev_enumerate_add_match_subsystem(this, string);
        }
    ...
    extends PointerType {
        ...
        public UdevDevice deviceNewFromSyspath(String string) {
            return INSTANCE.udev_device_new_from_syspath(this, string);
        }
    }
}
