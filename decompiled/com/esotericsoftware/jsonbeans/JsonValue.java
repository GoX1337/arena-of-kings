...
implements Iterable<JsonValue> {
    ...
    private void json(JsonValue jsonValue, StringBuilder stringBuilder, OutputType outputType) {
    ...
    public String prettyPrint(OutputType outputType, int n2) {
    ...
    private void prettyPrint(JsonValue jsonValue, StringBuilder stringBuilder, int n2, PrettyPrintSettings prettyPrintSettings) {
        OutputType outputType = prettyPrintSettings.outputType;
        if (jsonValue.isObject()) {
            if (jsonValue.child == null) {
                stringBuilder.append("{}");
            } else {
                ...
                block0: while (true) {
                    ...
                    while (jsonValue2 != null) {
                        ...
                        if (!(bl2 && outputType == OutputType.minimal || jsonValue2.next == null)) {
                            stringBuilder.append(',');
                        }
            ...
            if (jsonValue.child == null) {
                ...
                block2: while (true) {
                    ...
                    while (jsonValue3 != null) {
                        ...
                        if (!(bl4 && outputType == OutputType.minimal || jsonValue3.next == null)) {
                            stringBuilder.append(',');
                        }
    ...
    public void prettyPrint(OutputType outputType, Writer writer) {
        PrettyPrintSettings prettyPrintSettings = new PrettyPrintSettings();
        prettyPrintSettings.outputType = outputType;
