...
extends ByteBufferOutput {
    ...
    public UnsafeByteBufferOutput(int n2) {
        super(n2);
        this.updateBufferAddress();
    }

    public UnsafeByteBufferOutput(int n2, int n3) {
        super(n2, n3);
        this.updateBufferAddress();
    }
    ...
    public UnsafeByteBufferOutput(OutputStream outputStream, int n2) {
        super(outputStream, n2);
        this.updateBufferAddress();
    }

    public UnsafeByteBufferOutput(long l2, int n2) {
    ...
    public void write(int n2) {
        ...
        UnsafeUtil.unsafe.putByte(this.bufferAddress + (long)this.position++, (byte)n2);
    ...
    public void writeByte(byte by2) {
        ...
        UnsafeUtil.unsafe.putByte(this.bufferAddress + (long)this.position++, by2);
        this.setBufferPosition(this.byteBuffer, this.position);
    }
    ...
    public void writeInt(int n2) {
        this.require(4);
        UnsafeUtil.unsafe.putInt(this.bufferAddress + (long)this.position, n2);
        this.position += 4;
        this.setBufferPosition(this.byteBuffer, this.position);
    }
    ...
    public void writeLong(long l2) {
        this.require(8);
        UnsafeUtil.unsafe.putLong(this.bufferAddress + (long)this.position, l2);
        this.position += 8;
        this.setBufferPosition(this.byteBuffer, this.position);
    }
    ...
    public void writeFloat(float f2) {
        this.require(4);
        UnsafeUtil.unsafe.putFloat(this.bufferAddress + (long)this.position, f2);
        this.position += 4;
        this.setBufferPosition(this.byteBuffer, this.position);
    }
    ...
    public void writeDouble(double d2) {
        this.require(8);
        UnsafeUtil.unsafe.putDouble(this.bufferAddress + (long)this.position, d2);
        this.position += 8;
        this.setBufferPosition(this.byteBuffer, this.position);
    }
    ...
    public void writeShort(int n2) {
        this.require(2);
        UnsafeUtil.unsafe.putShort(this.bufferAddress + (long)this.position, (short)n2);
        this.position += 2;
        this.setBufferPosition(this.byteBuffer, this.position);
    }
    ...
    public void writeChar(char c2) {
        this.require(2);
        UnsafeUtil.unsafe.putChar(this.bufferAddress + (long)this.position, c2);
        this.position += 2;
        this.setBufferPosition(this.byteBuffer, this.position);
    }
    ...
    public void writeBoolean(boolean bl2) {
        ...
        UnsafeUtil.unsafe.putByte(this.bufferAddress + (long)this.position++, bl2 ? (byte)1 : 0);
        this.setBufferPosition(this.byteBuffer, this.position);
    }
    ...
    public void writeBytes(Object object, long l2, int n2) {
        ...
        while (true) {
            UnsafeUtil.unsafe.copyMemory(object, l2, null, this.bufferAddress + (long)this.position, n3);
            this.position += n3;
            if ((n2 -= n3) == 0) break;
            l2 += (long)n3;
