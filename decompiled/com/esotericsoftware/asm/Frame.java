...
final class Frame {
    ...
    private static int b(ClassWriter classWriter, String string) {
        ...
        switch (string.charAt(n3)) {
            ...
            case 'L': {
                ...
                return 0x1700000 | classWriter.int_c(string2);
            }
        }
        int n4 = n3 + 1;
        ...
        switch (string.charAt(n4)) {
            ...
            default: {
                ...
                n2 = 0x1700000 | classWriter.int_c(string3);
            }
        }
        return n4 - n3 << 28 | n2;
    }
    ...
    private int a(ClassWriter classWriter, int n2) {
        int n3;
        if (n2 == 0x1000006) {
            n3 = 0x1700000 | classWriter.int_c(classWriter.I);
        } else if ((n2 & 0xFFF00000) == 0x1800000) {
            String string = classWriter.H[n2 & 0xFFFFF].g;
            n3 = 0x1700000 | classWriter.int_c(string);
        } else {
            return n2;
        }
    ...
    void a(ClassWriter classWriter, int n2, Type[] typeArray, int n3) {
        ...
        int n4 = 0;
        if ((n2 & 8) == 0) {
            this.c[n4++] = (n2 & 0x80000) == 0 ? 0x1700000 | classWriter.int_c(classWriter.I) : 0x1000006;
        }
        ...
        block0 : switch (n2) {
            ...
            case 18: {
                switch (item.b) {
                    ...
                    case 7: {
                        this.b(0x1700000 | classWriter.int_c("java/lang/Class"));
                        break block0;
                    }
                    case 8: {
                        this.b(0x1700000 | classWriter.int_c("java/lang/String"));
                        break block0;
                    }
                    case 16: {
                        this.b(0x1700000 | classWriter.int_c("java/lang/invoke/MethodType"));
                        break block0;
                    }
                }
                this.b(0x1700000 | classWriter.int_c("java/lang/invoke/MethodHandle"));
                break;
            }
            case 25: {
                this.b(this.a(n3));
            ...
            case 189: {
                ...
                this.b(0x11700000 | classWriter.int_c(string));
                break;
            }
            case 192: {
                String string = item.g;
                ...
                this.b(0x1700000 | classWriter.int_c(string));
                break;
            }
            default: {
                this.c(n3);
        ...
        if ((n5 & 0xFF00000) == 0x1700000 || (n5 & 0xF0000000) != 0) {
            ...
            if ((n2 & 0xFFF00000) == (n5 & 0xFFF00000)) {
                if ((n5 & 0xFF00000) == 0x1700000) {
                    ...
                    n4 = n6 | 0x1700000 | classWriter.int_c("java/lang/Object");
                }
                ...
                n4 = Math.min(n7, n8) | 0x1700000 | classWriter.int_c("java/lang/Object");
            } else {
                n4 = 0x1000000;
            }
        } else {
