...
extends ClassVisitor {
    ...
    Item a(Object object) {
        ...
        if (object instanceof Type) {
            ...
            if (n6 == 11) {
                return this.com_esotericsoftware_asm_Item_c(type.getDescriptor());
            }
    ...
    Item com_esotericsoftware_asm_Item_c(String string) {
    ...
    public int newMethodType(String string) {
        return this.com_esotericsoftware_asm_Item_c((String)string).a;
    }
    ...
    int a(int n2, int n3) {
        ...
        if (item == null) {
            ...
            this.h.c = this.int_c(this.getCommonSuperClass(string, string2));
