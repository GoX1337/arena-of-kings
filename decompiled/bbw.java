...
public @interface bbw {
    ...
    public int int_a() default -1;

    public String c() default "";

    public a bbw$a_a() default a.AUTO;

    public static final class a
    extends Enum<a> {
        public static final /* enum */ a var_bbw$a_a;
        public static final /* enum */ a b;
        public static final /* enum */ a c;
        public static final /* enum */ a d;
        private static final /* synthetic */ a[] var_bbw$a_arr_a;

        public static a[] values() {
            return (a[])var_bbw$a_arr_a.clone();
        }
        ...
        static {
            ...
            c = new a();
            d = new a();
            var_bbw$a_arr_a = new a[]{var_bbw$a_a, b, c, d};
        }
    }
}
