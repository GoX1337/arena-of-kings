...
extends ail {
    ...
    public boolean boolean_a(Engine engine) {
        ...
        if (ay.ay_a().gu_a().a(engine, 3, ay.ay_a().com_arenaofkings_packets_gameserver_data_player_me_MyAccountData_a().getActive_character_entity().bb_a().boolean_b())) {
            ((Sound)((agd)engine.axc_a()).axm_a().com_badlogic_gdx_utils_Disposable_a(ajw.iU)).play(0.155f);
            ui ui2 = ay.ay_a().gu_a().ui_a(3);
