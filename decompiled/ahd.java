...
public class ahd
extends agw {
    public ahd(TextureAtlas textureAtlas) {
        super(textureAtlas, "my_energy_vial_v2", "my_energy_bar_v2");
        this.b(775.0f, 7.0f);
    ...
    public void b(float f2, Engine engine) {
        ...
        if (this.a / this.b <= (double)0.2f) {
            engine.a((int)this.a + "", engine.var_axy_b.a(), Color.RED, engine.var_axy_b.a(), Color.BLACK, 960.0f, 20.0f, 1, 1);
        } else {
            engine.a((int)this.a + "", engine.var_axy_b.a(), Color.WHITE, engine.var_axy_b.a(), Color.BLACK, 960.0f, 20.0f, 1, 1);
        }
    }
}
