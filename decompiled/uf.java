...
extends ui {
    protected uf(a a2) {
        Engine.a("building fixed coordinate spell");
        this.a = a2.var_hf_a;
        this.a = a2.var_da_a;
        this.a = a2.var_azo_a;
        ...
        this.b = a2.b;
        this.a = a2.var_hd_a;
        Engine.a("built fixed coordinate spell");
    }
    ...
    public static class a {
        ...
        public a a() {
            this.var_hf_a.d(true);
            return this;
        }

        public a a(int ... nArray) {
            this.var_hf_a.c(true);
            if (nArray.length >= 1) {
                this.var_hf_a.b(nArray[0]);
            } else {
                this.var_hf_a.b(1);
            }
            return this;
