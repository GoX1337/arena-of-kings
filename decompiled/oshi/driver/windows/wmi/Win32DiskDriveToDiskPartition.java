...
public final class Win32DiskDriveToDiskPartition {
    ...
    public static WbemcliUtil.WmiResult<DriveToPartitionProperty> queryDriveToPartition(WmiQueryHandler wmiQueryHandler) {
        WbemcliUtil.WmiQuery<DriveToPartitionProperty> wmiQuery = new WbemcliUtil.WmiQuery<DriveToPartitionProperty>(WIN32_DISK_DRIVE_TO_DISK_PARTITION, DriveToPartitionProperty.class);
