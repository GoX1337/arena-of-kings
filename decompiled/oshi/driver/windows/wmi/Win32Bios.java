...
public final class Win32Bios {
    ...
    public static WbemcliUtil.WmiResult<BiosSerialProperty> querySerialNumber() {
        WbemcliUtil.WmiQuery<BiosSerialProperty> wmiQuery = new WbemcliUtil.WmiQuery<BiosSerialProperty>(WIN32_BIOS_WHERE_PRIMARY_BIOS_TRUE, BiosSerialProperty.class);
    ...
    public static WbemcliUtil.WmiResult<BiosProperty> queryBiosInfo() {
        WbemcliUtil.WmiQuery<BiosProperty> wmiQuery = new WbemcliUtil.WmiQuery<BiosProperty>(WIN32_BIOS_WHERE_PRIMARY_BIOS_TRUE, BiosProperty.class);
        return Objects.requireNonNull(WmiQueryHandler.createInstance()).queryWMI(wmiQuery);
    }
