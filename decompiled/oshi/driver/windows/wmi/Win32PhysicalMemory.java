...
public final class Win32PhysicalMemory {
    ...
    public static WbemcliUtil.WmiResult<PhysicalMemoryProperty> queryphysicalMemory() {
        WbemcliUtil.WmiQuery<PhysicalMemoryProperty> wmiQuery = new WbemcliUtil.WmiQuery<PhysicalMemoryProperty>(WIN32_PHYSICAL_MEMORY, PhysicalMemoryProperty.class);
    ...
    public static WbemcliUtil.WmiResult<PhysicalMemoryPropertyWin8> queryphysicalMemoryWin8() {
        WbemcliUtil.WmiQuery<PhysicalMemoryPropertyWin8> wmiQuery = new WbemcliUtil.WmiQuery<PhysicalMemoryPropertyWin8>(WIN32_PHYSICAL_MEMORY, PhysicalMemoryPropertyWin8.class);
        return Objects.requireNonNull(WmiQueryHandler.createInstance()).queryWMI(wmiQuery);
    }
