...
public final class Win32VideoController {
    ...
    public static WbemcliUtil.WmiResult<VideoControllerProperty> queryVideoController() {
        WbemcliUtil.WmiQuery<VideoControllerProperty> wmiQuery = new WbemcliUtil.WmiQuery<VideoControllerProperty>(WIN32_VIDEO_CONTROLLER, VideoControllerProperty.class);
