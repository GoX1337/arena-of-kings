...
public final class Win32Processor {
    ...
    public static WbemcliUtil.WmiResult<VoltProperty> queryVoltage() {
        WbemcliUtil.WmiQuery<VoltProperty> wmiQuery = new WbemcliUtil.WmiQuery<VoltProperty>(WIN32_PROCESSOR, VoltProperty.class);
    ...
    public static WbemcliUtil.WmiResult<ProcessorIdProperty> queryProcessorId() {
        WbemcliUtil.WmiQuery<ProcessorIdProperty> wmiQuery = new WbemcliUtil.WmiQuery<ProcessorIdProperty>(WIN32_PROCESSOR, ProcessorIdProperty.class);
        return Objects.requireNonNull(WmiQueryHandler.createInstance()).queryWMI(wmiQuery);
    }

    public static WbemcliUtil.WmiResult<BitnessProperty> queryBitness() {
        WbemcliUtil.WmiQuery<BitnessProperty> wmiQuery = new WbemcliUtil.WmiQuery<BitnessProperty>(WIN32_PROCESSOR, BitnessProperty.class);
        return Objects.requireNonNull(WmiQueryHandler.createInstance()).queryWMI(wmiQuery);
    }
