...
public interface OperatingSystem {
    ...
    default public List<OSProcess> getProcesses(Collection<Integer> collection) {
        return collection.stream().map(this::getProcess).filter(Objects::nonNull).filter(ProcessFiltering.VALID_PROCESS).collect(Collectors.toList());
    }
    ...
    default public List<OSDesktopWindow> getDesktopWindows(boolean bl2) {
        return Xwininfo.queryXWindows(bl2);
    }
    ...
    public static class OSVersionInfo {
        ...
        public OSVersionInfo(String string, String string2, String string3) {
            this.version = "10".equals(string) && string3.compareTo("22000") >= 0 ? "11" : string;
